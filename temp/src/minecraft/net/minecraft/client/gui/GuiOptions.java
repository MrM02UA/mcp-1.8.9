...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_73866_w_() {
      ...
      if(this.field_146297_k.field_71441_e != null) {
         ...
         GuiOptionButton lvt_2_3_ = new GuiOptionButton(GameSettings.Options.REALMS_NOTIFICATIONS.func_74381_c(), this.field_146294_l / 2 - 155 + lvt_1_1_ % 2 * 160, this.field_146295_m / 6 - 12 + 24 * (lvt_1_1_ >> 1), GameSettings.Options.REALMS_NOTIFICATIONS, this.field_146443_h.func_74297_c(GameSettings.Options.REALMS_NOTIFICATIONS));
      ...
      this.field_146292_n.add(new GuiButton(8675309, this.field_146294_l / 2 + 5, this.field_146295_m / 6 + 48 - 6, 150, 20, "Super Secret Settings...") {
         public void func_146113_a(SoundHandler p_146113_1_) {
            SoundEventAccessorComposite lvt_2_1_ = p_146113_1_.func_147686_a(new SoundCategory[]{SoundCategory.ANIMALS, SoundCategory.BLOCKS, SoundCategory.MOBS, SoundCategory.PLAYERS, SoundCategory.WEATHER});
            if(lvt_2_1_ != null) {
