         ...
         if(!lvt_3_1_.func_74767_n("resolved")) {
            ...
            if(func_77828_a(lvt_3_1_)) {
               ...
               for(int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_.func_74745_c(); ++lvt_5_1_) {
                  ...
                  try {
                     lvt_7_2_ = IChatComponent.Serializer.func_150699_a(lvt_6_1_);
                     lvt_7_2_ = ChatComponentProcessor.func_179985_a(p_179229_2_, lvt_7_2_, p_179229_2_);
                  } catch (Exception var9) {
                     lvt_7_2_ = new ChatComponentText(lvt_6_1_);
                  }

                  lvt_4_1_.func_150304_a(lvt_5_1_, new NBTTagString(IChatComponent.Serializer.func_150696_a(lvt_7_2_)));
               }
