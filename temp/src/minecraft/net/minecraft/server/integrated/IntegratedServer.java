...
public class IntegratedServer extends MinecraftServer {
   ...
   protected void func_71247_a(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_, String p_71247_6_) {
      ...
      ISaveHandler lvt_7_1_ = this.func_71254_M().func_75804_a(p_71247_1_, true);
      this.func_175584_a(this.func_71270_I(), lvt_7_1_);
      WorldInfo lvt_8_1_ = lvt_7_1_.func_75757_d();
      if(lvt_8_1_ == null) {
         lvt_8_1_ = new WorldInfo(this.field_71350_m, p_71247_2_);
      } else {
         lvt_8_1_.func_76062_a(p_71247_2_);
      }

      for(int lvt_9_1_ = 0; lvt_9_1_ < this.field_71305_c.length; ++lvt_9_1_) {
         int lvt_10_1_ = 0;
         if(lvt_9_1_ == 1) {
            lvt_10_1_ = -1;
         }
         ...
         if(lvt_9_1_ == 0) {
            if(this.func_71242_L()) {
               this.field_71305_c[lvt_9_1_] = (WorldServer)(new DemoWorldServer(this, lvt_7_1_, lvt_8_1_, lvt_10_1_, this.field_71304_b)).func_175643_b();
            } else {
               this.field_71305_c[lvt_9_1_] = (WorldServer)(new WorldServer(this, lvt_7_1_, lvt_8_1_, lvt_10_1_, this.field_71304_b)).func_175643_b();
            }

            this.field_71305_c[lvt_9_1_].func_72963_a(this.field_71350_m);
         } else {
            this.field_71305_c[lvt_9_1_] = (WorldServer)(new WorldServerMulti(this, lvt_7_1_, lvt_10_1_, this.field_71305_c[0], this.field_71304_b)).func_175643_b();
         }

         this.field_71305_c[lvt_9_1_].func_72954_a(new WorldManager(this, this.field_71305_c[lvt_9_1_]));
      }
   ...
   public void func_71217_p() {
      ...
      if(this.field_71348_o) {
         ...
         if(this.field_71349_l.field_71441_e != null) {
            WorldInfo lvt_2_1_ = this.field_71305_c[0].func_72912_H();
            WorldInfo lvt_3_1_ = this.field_71349_l.field_71441_e.func_72912_H();
            if(!lvt_2_1_.func_176123_z() && lvt_3_1_.func_176130_y() != lvt_2_1_.func_176130_y()) {
               field_147148_h.info("Changing difficulty to {}, from {}", new Object[]{lvt_3_1_.func_176130_y(), lvt_2_1_.func_176130_y()});
               this.func_147139_a(lvt_3_1_.func_176130_y());
            } else if(lvt_3_1_.func_176123_z() && !lvt_2_1_.func_176123_z()) {
               field_147148_h.info("Locking difficulty to {}", new Object[]{lvt_3_1_.func_176130_y()});

               for(WorldServer lvt_7_1_ : this.field_71305_c) {
                  if(lvt_7_1_ != null) {
                     lvt_7_1_.func_72912_H().func_180783_e(true);
                  }
               }
            }
         }
   ...
   public String func_71206_a(WorldSettings.GameType p_71206_1_, boolean p_71206_2_) {
      try {
         ...
         try {
            lvt_3_1_ = HttpUtil.func_76181_a();
         ...
         this.func_147137_ag().func_151265_a((InetAddress)null, lvt_3_1_);
         field_147148_h.info("Started on " + lvt_3_1_);
         this.field_71346_p = true;
         this.field_71345_q = new ThreadLanServerPing(this.func_71273_Y(), lvt_3_1_ + "");
   ...
   public void func_71263_m() {
      Futures.getUnchecked(this.func_152344_a(new Runnable() {
         public void run() {
            for(EntityPlayerMP lvt_3_1_ : Lists.newArrayList(IntegratedServer.this.func_71203_ab().func_181057_v())) {
               IntegratedServer.this.func_71203_ab().func_72367_e(lvt_3_1_);
            }
