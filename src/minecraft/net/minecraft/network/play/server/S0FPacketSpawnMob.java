...
public class S0FPacketSpawnMob implements Packet<INetHandlerPlayClient>
{
    ...
    public S0FPacketSpawnMob(EntityLivingBase entityIn)
    {
        ...
        double lvt_4_1_ = entityIn.motionX;
        double lvt_6_1_ = entityIn.motionY;
        double lvt_8_1_ = entityIn.motionZ;
        ...
        this.velocityX = (int)(lvt_4_1_ * 8000.0D);
        this.velocityY = (int)(lvt_6_1_ * 8000.0D);
        this.velocityZ = (int)(lvt_8_1_ * 8000.0D);
