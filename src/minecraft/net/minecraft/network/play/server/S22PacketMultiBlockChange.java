...
public class S22PacketMultiBlockChange implements Packet<INetHandlerPlayClient>
{
    ...
    public S22PacketMultiBlockChange(int p_i45181_1_, short[] crammedPositionsIn, Chunk chunkIn)
    {
        ...
        {
            this.changedBlocks[lvt_4_1_] = new S22PacketMultiBlockChange.BlockUpdateData(crammedPositionsIn[lvt_4_1_], chunkIn);
        }
    }
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        {
            this.changedBlocks[lvt_2_1_] = new S22PacketMultiBlockChange.BlockUpdateData(buf.readShort(), (IBlockState)Block.BLOCK_STATE_IDS.getByValue(buf.readVarIntFromBuffer()));
        }
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (S22PacketMultiBlockChange.BlockUpdateData lvt_5_1_ : this.changedBlocks)
        {
            buf.writeShort(lvt_5_1_.func_180089_b());
            buf.writeVarIntToBuffer(Block.BLOCK_STATE_IDS.get(lvt_5_1_.getBlockState()));
        }
    }
