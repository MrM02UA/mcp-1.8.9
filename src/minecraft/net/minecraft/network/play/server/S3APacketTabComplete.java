...
public class S3APacketTabComplete implements Packet<INetHandlerPlayClient>
{
    ...
    public void readPacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (int lvt_2_1_ = 0; lvt_2_1_ < this.matches.length; ++lvt_2_1_)
        {
            this.matches[lvt_2_1_] = buf.readStringFromBuffer(32767);
        }
    }
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        for (String lvt_5_1_ : this.matches)
        {
            buf.writeString(lvt_5_1_);
        }
    }
