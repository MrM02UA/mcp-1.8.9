...
public class PacketBuffer extends ByteBuf
{
    ...
    public String readStringFromBuffer(int maxLength)
    {
        ...
        if (lvt_2_1_ > maxLength * 4)
        {
            throw new DecoderException("The received encoded string buffer length is longer than maximum allowed (" + lvt_2_1_ + " > " + maxLength * 4 + ")");
        }
        else if (lvt_2_1_ < 0)
        {
        ...
        else
        {
            ...
            if (lvt_3_1_.length() > maxLength)
            {
                throw new DecoderException("The received string length is longer than maximum allowed (" + lvt_2_1_ + " > " + maxLength + ")");
            }
            else
            {
                return lvt_3_1_;
    ...
    {
        byte[] lvt_2_1_ = string.getBytes(Charsets.UTF_8);
