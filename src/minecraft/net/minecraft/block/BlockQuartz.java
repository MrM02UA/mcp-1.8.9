...
public class BlockQuartz extends Block
{
    ...
    {
        BlockQuartz.EnumType lvt_2_1_ = (BlockQuartz.EnumType)state.getValue(VARIANT);
        return lvt_2_1_ != BlockQuartz.EnumType.LINES_X && lvt_2_1_ != BlockQuartz.EnumType.LINES_Z ? lvt_2_1_.getMetadata() : BlockQuartz.EnumType.LINES_Y.getMetadata();
    }

    protected ItemStack createStackedBlock(IBlockState state)
    {
        BlockQuartz.EnumType lvt_2_1_ = (BlockQuartz.EnumType)state.getValue(VARIANT);
        return lvt_2_1_ != BlockQuartz.EnumType.LINES_X && lvt_2_1_ != BlockQuartz.EnumType.LINES_Z ? super.createStackedBlock(state) : new ItemStack(Item.getItemFromBlock(this), 1, BlockQuartz.EnumType.LINES_Y.getMetadata());
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static {
            for (BlockQuartz.EnumType lvt_3_1_ : values())
            {
