...
public class BlockDirt extends Block
{
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        if (state.getValue(VARIANT) == BlockDirt.DirtType.PODZOL)
        {
            ...
            state = state.withProperty(SNOWY, Boolean.valueOf(lvt_4_1_ == Blocks.snow || lvt_4_1_ == Blocks.snow_layer));
        }
    ...
    public int getDamageValue(World worldIn, BlockPos pos)
    {
        ...
        return lvt_3_1_.getBlock() != this ? 0 : ((BlockDirt.DirtType)lvt_3_1_.getValue(VARIANT)).getMetadata();
    }
    ...
    {
        BlockDirt.DirtType lvt_2_1_ = (BlockDirt.DirtType)state.getValue(VARIANT);
    ...
    public static enum DirtType implements IStringSerializable
    {
        ...
        static {
            for (BlockDirt.DirtType lvt_3_1_ : values())
            {
                METADATA_LOOKUP[lvt_3_1_.getMetadata()] = lvt_3_1_;
            }
        }
    }
}
