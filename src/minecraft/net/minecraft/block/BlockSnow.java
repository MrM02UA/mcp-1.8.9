...
public class BlockSnow extends Block
{
    ...
    {
        int lvt_4_1_ = ((Integer)state.getValue(LAYERS)).intValue() - 1;
        float lvt_5_1_ = 0.125F;
        return new AxisAlignedBB((double)pos.getX() + this.minX, (double)pos.getY() + this.minY, (double)pos.getZ() + this.minZ, (double)pos.getX() + this.maxX, (double)((float)pos.getY() + (float)lvt_4_1_ * lvt_5_1_), (double)pos.getZ() + this.maxZ);
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        this.getBoundsForLayers(((Integer)lvt_3_1_.getValue(LAYERS)).intValue());
    }
    ...
    {
        IBlockState lvt_3_1_ = worldIn.getBlockState(pos.down());
        Block lvt_4_1_ = lvt_3_1_.getBlock();
        return lvt_4_1_ != Blocks.ice && lvt_4_1_ != Blocks.packed_ice ? (lvt_4_1_.getMaterial() == Material.leaves ? true : (lvt_4_1_ == this && ((Integer)lvt_3_1_.getValue(LAYERS)).intValue() >= 7 ? true : lvt_4_1_.isOpaqueCube() && lvt_4_1_.blockMaterial.blocksMovement())) : false;
    }
