...
public class BlockTallGrass extends BlockBush implements IGrowable
{
    ...
    protected BlockTallGrass()
    {
        ...
        float lvt_1_1_ = 0.4F;
        this.setBlockBounds(0.5F - lvt_1_1_, 0.0F, 0.5F - lvt_1_1_, 0.5F + lvt_1_1_, 0.8F, 0.5F + lvt_1_1_);
    }
    ...
    public int getRenderColor(IBlockState state)
    {
        ...
        {
            BlockTallGrass.EnumType lvt_2_1_ = (BlockTallGrass.EnumType)state.getValue(TYPE);
            return lvt_2_1_ == BlockTallGrass.EnumType.DEAD_BUSH ? 16777215 : ColorizerGrass.getGrassColor(0.5D, 1.0D);
        }
    }
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        {
            list.add(new ItemStack(itemIn, 1, lvt_4_1_));
        }
    }
    ...
    public void grow(World worldIn, Random rand, BlockPos pos, IBlockState state)
    {
        ...
        {
            Blocks.double_plant.placeAt(worldIn, pos, lvt_5_1_, 2);
        }
    }
    ...
    public static enum EnumType implements IStringSerializable
    {
        ...
        static {
            for (BlockTallGrass.EnumType lvt_3_1_ : values())
            {
