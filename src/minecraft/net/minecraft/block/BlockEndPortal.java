...
public class BlockEndPortal extends BlockContainer
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        this.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, lvt_3_1_, 1.0F);
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        double lvt_7_1_ = (double)((float)pos.getY() + 0.8F);
        double lvt_9_1_ = (double)((float)pos.getZ() + rand.nextFloat());
        double lvt_11_1_ = 0.0D;
        double lvt_13_1_ = 0.0D;
        double lvt_15_1_ = 0.0D;
        worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, lvt_5_1_, lvt_7_1_, lvt_9_1_, lvt_11_1_, lvt_13_1_, lvt_15_1_, new int[0]);
    }
