...
public class BlockAnvil extends BlockFalling
{
    ...
    {
        EnumFacing lvt_9_1_ = placer.getHorizontalFacing().rotateY();
        return super.onBlockPlaced(worldIn, pos, facing, hitX, hitY, hitZ, meta, placer).withProperty(FACING, lvt_9_1_).withProperty(DAMAGE, Integer.valueOf(meta >> 2));
    }
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (lvt_3_1_.getAxis() == EnumFacing.Axis.X)
        {
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        lvt_2_1_ = lvt_2_1_ | ((Integer)state.getValue(DAMAGE)).intValue() << 2;
        return lvt_2_1_;
    }
