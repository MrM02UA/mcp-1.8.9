...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    public BlockDoublePlant.EnumPlantType getVariant(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        {
            lvt_3_1_ = this.getActualState(lvt_3_1_, worldIn, pos);
            return (BlockDoublePlant.EnumPlantType)lvt_3_1_.getValue(VARIANT);
        }
        else
        {
    ...
    public boolean isReplaceable(World worldIn, BlockPos pos)
    {
        ...
        {
            BlockDoublePlant.EnumPlantType lvt_4_1_ = (BlockDoublePlant.EnumPlantType)this.getActualState(lvt_3_1_, worldIn, pos).getValue(VARIANT);
    ...
    protected void checkAndDropBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            boolean lvt_4_1_ = state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER;
            BlockPos lvt_5_1_ = lvt_4_1_ ? pos : pos.up();
            BlockPos lvt_6_1_ = lvt_4_1_ ? pos.down() : pos;
            Block lvt_7_1_ = (Block)(lvt_4_1_ ? this : worldIn.getBlockState(lvt_5_1_).getBlock());
            Block lvt_8_1_ = (Block)(lvt_4_1_ ? worldIn.getBlockState(lvt_6_1_).getBlock() : this);

            if (lvt_7_1_ == this)
            {
                worldIn.setBlockState(lvt_5_1_, Blocks.air.getDefaultState(), 2);
            }

            if (lvt_8_1_ == this)
            {
                worldIn.setBlockState(lvt_6_1_, Blocks.air.getDefaultState(), 3);

                if (!lvt_4_1_)
                {
                    this.dropBlockAsItem(worldIn, lvt_6_1_, state, 0);
                }
            }
        }
    }
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        else
        {
            ...
            return lvt_4_1_.getBlock() == this && super.canBlockStay(worldIn, pos, lvt_4_1_);
        }
    }
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        ...
        {
            BlockDoublePlant.EnumPlantType lvt_4_1_ = (BlockDoublePlant.EnumPlantType)state.getValue(VARIANT);
            return lvt_4_1_ == BlockDoublePlant.EnumPlantType.FERN ? null : (lvt_4_1_ == BlockDoublePlant.EnumPlantType.GRASS ? (rand.nextInt(8) == 0 ? Items.wheat_seeds : null) : Item.getItemFromBlock(this));
        }
    }
    ...
    {
        BlockDoublePlant.EnumPlantType lvt_4_1_ = this.getVariant(worldIn, pos);
        return lvt_4_1_ != BlockDoublePlant.EnumPlantType.GRASS && lvt_4_1_ != BlockDoublePlant.EnumPlantType.FERN ? 16777215 : BiomeColorHelper.getGrassColorAtPos(worldIn, pos);
    }
        ...
        if (state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER)
        {
            if (worldIn.getBlockState(pos.down()).getBlock() == this)
            {
                if (!player.capabilities.isCreativeMode)
                {
                    ...
                    BlockDoublePlant.EnumPlantType lvt_6_1_ = (BlockDoublePlant.EnumPlantType)lvt_5_1_.getValue(VARIANT);
                    ...
                    else if (!worldIn.isRemote)
                    {
                        ...
                        {
                            this.onHarvest(worldIn, pos, lvt_5_1_, player);
    ...
    {
        BlockDoublePlant.EnumPlantType lvt_5_1_ = (BlockDoublePlant.EnumPlantType)state.getValue(VARIANT);
        ...
        else
        {
            ...
            int lvt_6_1_ = (lvt_5_1_ == BlockDoublePlant.EnumPlantType.GRASS ? BlockTallGrass.EnumType.GRASS : BlockTallGrass.EnumType.FERN).getMeta();
            spawnAsEntity(worldIn, pos, new ItemStack(Blocks.tallgrass, 2, lvt_6_1_));
            return true;
        }
    }
    ...
    {
        for (BlockDoublePlant.EnumPlantType lvt_7_1_ : BlockDoublePlant.EnumPlantType.values())
        {
            list.add(new ItemStack(itemIn, 1, lvt_7_1_.getMeta()));
        }
    }
    ...
    {
        BlockDoublePlant.EnumPlantType lvt_5_1_ = this.getVariant(worldIn, pos);
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        if (state.getValue(HALF) == BlockDoublePlant.EnumBlockHalf.UPPER)
        {
            ...
            {
                state = state.withProperty(VARIANT, lvt_4_1_.getValue(VARIANT));
            }
        }
    ...
    public static enum EnumPlantType implements IStringSerializable
    {
        ...
        static {
            for (BlockDoublePlant.EnumPlantType lvt_3_1_ : values())
            {
