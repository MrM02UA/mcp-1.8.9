...
public class BlockPressurePlate extends BlockBasePressurePlate
{
    ...
    {
        AxisAlignedBB lvt_3_1_ = this.getSensitiveAABB(pos);
        List <? extends Entity > lvt_4_1_;

        switch (this.sensitivity)
        {
            case EVERYTHING:
                lvt_4_1_ = worldIn.getEntitiesWithinAABBExcludingEntity((Entity)null, lvt_3_1_);
                break;

            case MOBS:
                lvt_4_1_ = worldIn.<Entity>getEntitiesWithinAABB(EntityLivingBase.class, lvt_3_1_);
                break;
