...
public class BlockNewLog extends BlockLog
{
    ...
    {
        IBlockState lvt_2_1_ = this.getDefaultState().withProperty(VARIANT, BlockPlanks.EnumType.byMetadata((meta & 3) + 4));
    ...
    {
        int lvt_2_1_ = 0;
        lvt_2_1_ = lvt_2_1_ | ((BlockPlanks.EnumType)state.getValue(VARIANT)).getMetadata() - 4;
