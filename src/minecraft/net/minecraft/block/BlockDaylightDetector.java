...
public class BlockDaylightDetector extends BlockContainer
{
    ...
    public void updatePower(World worldIn, BlockPos pos)
    {
        if (!worldIn.provider.getHasNoSky())
        {
            ...
            int lvt_4_1_ = worldIn.getLightFor(EnumSkyBlock.SKY, pos) - worldIn.getSkylightSubtracted();
            float lvt_5_1_ = worldIn.getCelestialAngleRadians(1.0F);
            float lvt_6_1_ = lvt_5_1_ < (float)Math.PI ? 0.0F : ((float)Math.PI * 2F);
            lvt_5_1_ = lvt_5_1_ + (lvt_6_1_ - lvt_5_1_) * 0.2F;
            lvt_4_1_ = Math.round((float)lvt_4_1_ * MathHelper.cos(lvt_5_1_));
            lvt_4_1_ = MathHelper.clamp_int(lvt_4_1_, 0, 15);
            ...
            if (((Integer)lvt_3_1_.getValue(POWER)).intValue() != lvt_4_1_)
            {
                worldIn.setBlockState(pos, lvt_3_1_.withProperty(POWER, Integer.valueOf(lvt_4_1_)), 3);
            }
        }
    }
