...
public class BlockHopper extends BlockContainer
{
    ...
    {
        EnumFacing lvt_9_1_ = facing.getOpposite();
        ...
        return this.getDefaultState().withProperty(FACING, lvt_9_1_).withProperty(ENABLED, Boolean.valueOf(true));
    }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityHopper)lvt_6_1_).setCustomName(stack.getDisplayName());
            }
        }
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TileEntityHopper)lvt_9_1_);
    ...
    {
        boolean lvt_4_1_ = !worldIn.isBlockPowered(pos);

        if (lvt_4_1_ != ((Boolean)state.getValue(ENABLED)).booleanValue())
        {
            worldIn.setBlockState(pos, state.withProperty(ENABLED, Boolean.valueOf(lvt_4_1_)), 4);
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityHopper)lvt_4_1_);
