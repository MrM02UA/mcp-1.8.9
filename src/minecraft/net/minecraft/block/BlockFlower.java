...
public abstract class BlockFlower extends BlockBush
{
    ...
    {
        for (BlockFlower.EnumFlowerType lvt_7_1_ : BlockFlower.EnumFlowerType.getTypes(this.getBlockType()))
        {
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        {
            BlockFlower.EnumFlowerType[] lvt_2_1_ = TYPES_FOR_BLOCK[blockType.ordinal()];

            if (meta < 0 || meta >= lvt_2_1_.length)
            {
                meta = 0;
            }

            return lvt_2_1_[meta];
        }
        ...
        static {
            for (final BlockFlower.EnumFlowerColor lvt_3_1_ : BlockFlower.EnumFlowerColor.values())
            {
                Collection<BlockFlower.EnumFlowerType> lvt_4_1_ = Collections2.filter(Lists.newArrayList(values()), new Predicate<BlockFlower.EnumFlowerType>()
                {
                    public boolean apply(BlockFlower.EnumFlowerType p_apply_1_)
                    {
                ...
                TYPES_FOR_BLOCK[lvt_3_1_.ordinal()] = (BlockFlower.EnumFlowerType[])lvt_4_1_.toArray(new BlockFlower.EnumFlowerType[lvt_4_1_.size()]);
            }
        }
    }
}
