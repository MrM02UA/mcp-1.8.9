...
public class BlockLadder extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess worldIn, BlockPos pos)
    {
        ...
        if (lvt_3_1_.getBlock() == this)
        {
            ...
            switch ((EnumFacing)lvt_3_1_.getValue(FACING))
            {
                case NORTH:
                    this.setBlockBounds(0.0F, 0.0F, 1.0F - lvt_4_1_, 1.0F, 1.0F, 1.0F);
                    break;

                case SOUTH:
                    this.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, lvt_4_1_);
                    break;

                case WEST:
                    this.setBlockBounds(1.0F - lvt_4_1_, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
                    break;

                case EAST:
                default:
                    this.setBlockBounds(0.0F, 0.0F, 0.0F, lvt_4_1_, 1.0F, 1.0F);
            }
        }
    }
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer)
    {
        ...
        else
        {
            ...
            {
                if (this.canBlockStay(worldIn, pos, lvt_10_1_))
                {
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        if (!this.canBlockStay(worldIn, pos, lvt_5_1_))
        {
