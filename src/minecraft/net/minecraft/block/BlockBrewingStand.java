...
public class BlockBrewingStand extends BlockContainer
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TileEntityBrewingStand)lvt_9_1_);
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityBrewingStand)lvt_6_1_).setName(stack.getDisplayName());
            }
        }
    }
    ...
    {
        double lvt_5_1_ = (double)((float)pos.getX() + 0.4F + rand.nextFloat() * 0.2F);
        double lvt_7_1_ = (double)((float)pos.getY() + 0.7F + rand.nextFloat() * 0.3F);
        double lvt_9_1_ = (double)((float)pos.getZ() + 0.4F + rand.nextFloat() * 0.2F);
        worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, lvt_5_1_, lvt_7_1_, lvt_9_1_, 0.0D, 0.0D, 0.0D, new int[0]);
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        {
            InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityBrewingStand)lvt_4_1_);
        }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        {
            lvt_2_1_ = lvt_2_1_.withProperty(HAS_BOTTLE[lvt_3_1_], Boolean.valueOf((meta & 1 << lvt_3_1_) > 0));
        }
    ...
    public int getMetaFromState(IBlockState state)
    {
        ...
        for (int lvt_3_1_ = 0; lvt_3_1_ < 3; ++lvt_3_1_)
        {
            if (((Boolean)state.getValue(HAS_BOTTLE[lvt_3_1_])).booleanValue())
            {
                lvt_2_1_ |= 1 << lvt_3_1_;
            }
        }
