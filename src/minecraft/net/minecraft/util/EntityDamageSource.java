...
public class EntityDamageSource extends DamageSource
{
    ...
    {
        ItemStack lvt_2_1_ = this.damageSourceEntity instanceof EntityLivingBase ? ((EntityLivingBase)this.damageSourceEntity).getHeldItem() : null;
        String lvt_3_1_ = "death.attack." + this.damageType;
        String lvt_4_1_ = lvt_3_1_ + ".item";
        return lvt_2_1_ != null && lvt_2_1_.hasDisplayName() && StatCollector.canTranslate(lvt_4_1_) ? new ChatComponentTranslation(lvt_4_1_, new Object[] {entityLivingBaseIn.getDisplayName(), this.damageSourceEntity.getDisplayName(), lvt_2_1_.getChatComponent()}): new ChatComponentTranslation(lvt_3_1_, new Object[] {entityLivingBaseIn.getDisplayName(), this.damageSourceEntity.getDisplayName()});
    }
