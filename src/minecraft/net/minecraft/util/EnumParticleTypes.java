...
public enum EnumParticleTypes
{
    ...
    static {
        ...
        for (EnumParticleTypes lvt_4_1_ : values())
        {
            PARTICLES.put(Integer.valueOf(lvt_4_1_.getParticleID()), lvt_4_1_);

            if (!lvt_4_1_.getParticleName().endsWith("_"))
            {
                lvt_0_1_.add(lvt_4_1_.getParticleName());
            }
        }

        PARTICLE_NAMES = (String[])lvt_0_1_.toArray(new String[lvt_0_1_.size()]);
    }
}
