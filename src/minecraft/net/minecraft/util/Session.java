...
public class Session
{
    ...
    public GameProfile getProfile()
    {
        try
        {
            UUID lvt_1_1_ = UUIDTypeAdapter.fromString(this.getPlayerID());
            return new GameProfile(lvt_1_1_, this.getUsername());
        }
    ...
    public static enum Type
    {
        ...
        static {
            ...
            {
                SESSION_TYPES.put(lvt_3_1_.sessionType, lvt_3_1_);
            }
        }
    }
}
