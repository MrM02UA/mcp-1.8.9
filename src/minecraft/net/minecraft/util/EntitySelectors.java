    ...
    public static class ArmoredMob implements Predicate<Entity>
    {
        ...
        public boolean apply(Entity p_apply_1_)
        {
            ...
            else
            {
                ...
                return lvt_2_1_.getEquipmentInSlot(EntityLiving.getArmorPosition(this.armor)) != null ? false : (lvt_2_1_ instanceof EntityLiving ? ((EntityLiving)lvt_2_1_).canPickUpLoot() : (lvt_2_1_ instanceof EntityArmorStand ? true : lvt_2_1_ instanceof EntityPlayer));
            }
        }
