...
public enum EnumFacing implements IStringSerializable
{
    ...
    public static EnumFacing getFacingFromVector(float p_176737_0_, float p_176737_1_, float p_176737_2_)
    {
        ...
        {
            float lvt_9_1_ = p_176737_0_ * (float)lvt_8_1_.directionVec.getX() + p_176737_1_ * (float)lvt_8_1_.directionVec.getY() + p_176737_2_ * (float)lvt_8_1_.directionVec.getZ();
    ...
    public static EnumFacing getFacingFromAxis(EnumFacing.AxisDirection p_181076_0_, EnumFacing.Axis p_181076_1_)
    {
        ...
        {
            if (lvt_5_1_.getAxisDirection() == p_181076_0_ && lvt_5_1_.getAxis() == p_181076_1_)
            {
                return lvt_5_1_;
            }
        }
    ...
    static {
        ...
        {
            VALUES[lvt_3_1_.index] = lvt_3_1_;

            if (lvt_3_1_.getAxis().isHorizontal())
            {
                HORIZONTALS[lvt_3_1_.horizontalIndex] = lvt_3_1_;
            }

            NAME_LOOKUP.put(lvt_3_1_.getName2().toLowerCase(), lvt_3_1_);
        }
    }
    ...
    public static enum Plane implements Predicate<EnumFacing>, Iterable<EnumFacing> {
        ...
        {
            EnumFacing[] lvt_2_1_ = this.facings();
            return lvt_2_1_[rand.nextInt(lvt_2_1_.length)];
        }
