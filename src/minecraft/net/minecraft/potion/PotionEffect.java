...
public class PotionEffect
{
    ...
    public String toString()
    {
        ...
        {
            lvt_1_1_ = this.getEffectName() + " x " + (this.getAmplifier() + 1) + ", Duration: " + this.getDuration();
        }
        else
        {
            lvt_1_1_ = this.getEffectName() + ", Duration: " + this.getDuration();
        }
        ...
        return Potion.potionTypes[this.potionID].isUsable() ? "(" + lvt_1_1_ + ")" : lvt_1_1_;
    }
    ...
    public boolean equals(Object p_equals_1_)
    {
        ...
        else
        {
            ...
            return this.potionID == lvt_2_1_.potionID && this.amplifier == lvt_2_1_.amplifier && this.duration == lvt_2_1_.duration && this.isSplashPotion == lvt_2_1_.isSplashPotion && this.isAmbient == lvt_2_1_.isAmbient;
        }
    }
    ...
    {
        int lvt_1_1_ = nbt.getByte("Id");

        if (lvt_1_1_ >= 0 && lvt_1_1_ < Potion.potionTypes.length && Potion.potionTypes[lvt_1_1_] != null)
        {
            int lvt_2_1_ = nbt.getByte("Amplifier");
            int lvt_3_1_ = nbt.getInteger("Duration");
            boolean lvt_4_1_ = nbt.getBoolean("Ambient");
            boolean lvt_5_1_ = true;

            if (nbt.hasKey("ShowParticles", 1))
            {
                lvt_5_1_ = nbt.getBoolean("ShowParticles");
            }
