...
public class Potion
{
    ...
    public void affectEntity(Entity p_180793_1_, Entity p_180793_2_, EntityLivingBase entityLivingBaseIn, int p_180793_4_, double p_180793_5_)
    {
        if ((this.id != heal.id || entityLivingBaseIn.isEntityUndead()) && (this.id != harm.id || !entityLivingBaseIn.isEntityUndead()))
        {
            if (this.id == harm.id && !entityLivingBaseIn.isEntityUndead() || this.id == heal.id && entityLivingBaseIn.isEntityUndead())
            {
                int lvt_7_2_ = (int)(p_180793_5_ * (double)(6 << p_180793_4_) + 0.5D);

                if (p_180793_1_ == null)
                {
                    entityLivingBaseIn.attackEntityFrom(DamageSource.magic, (float)lvt_7_2_);
                }
                else
                {
                    entityLivingBaseIn.attackEntityFrom(DamageSource.causeIndirectMagicDamage(p_180793_1_, p_180793_2_), (float)lvt_7_2_);
                }
            }
        }
        else
        {
            int lvt_7_1_ = (int)(p_180793_5_ * (double)(4 << p_180793_4_) + 0.5D);
            entityLivingBaseIn.heal((float)lvt_7_1_);
        }
    }
    ...
    public boolean isReady(int p_76397_1_, int p_76397_2_)
    {
        if (this.id == regeneration.id)
        {
            int lvt_3_1_ = 50 >> p_76397_2_;
            return lvt_3_1_ > 0 ? p_76397_1_ % lvt_3_1_ == 0 : true;
        }
        else if (this.id == poison.id)
        {
            int lvt_3_2_ = 25 >> p_76397_2_;
            return lvt_3_2_ > 0 ? p_76397_1_ % lvt_3_2_ == 0 : true;
        }
        else if (this.id == wither.id)
        {
            int lvt_3_3_ = 40 >> p_76397_2_;
            return lvt_3_3_ > 0 ? p_76397_1_ % lvt_3_3_ == 0 : true;
        }
        else
        {
    ...
    public static String getDurationString(PotionEffect effect)
    {
        ...
        {
            int lvt_1_1_ = effect.getDuration();
            return StringUtils.ticksToElapsedTime(lvt_1_1_);
        }
    }
    ...
    {
        AttributeModifier lvt_6_1_ = new AttributeModifier(UUID.fromString(p_111184_2_), this.getName(), p_111184_3_, p_111184_5_);
        this.attributeModifierMap.put(p_111184_1_, lvt_6_1_);
        return this;
    }
    ...
    {
        for (Entry<IAttribute, AttributeModifier> lvt_5_1_ : this.attributeModifierMap.entrySet())
        {
            IAttributeInstance lvt_6_1_ = p_111187_2_.getAttributeInstance((IAttribute)lvt_5_1_.getKey());

            if (lvt_6_1_ != null)
            {
                lvt_6_1_.removeModifier((AttributeModifier)lvt_5_1_.getValue());
            }
        }
    }
    ...
    public void applyAttributesModifiersToEntity(EntityLivingBase entityLivingBaseIn, BaseAttributeMap p_111185_2_, int amplifier)
    {
        for (Entry<IAttribute, AttributeModifier> lvt_5_1_ : this.attributeModifierMap.entrySet())
        {
            IAttributeInstance lvt_6_1_ = p_111185_2_.getAttributeInstance((IAttribute)lvt_5_1_.getKey());

            if (lvt_6_1_ != null)
            {
                AttributeModifier lvt_7_1_ = (AttributeModifier)lvt_5_1_.getValue();
                lvt_6_1_.removeModifier(lvt_7_1_);
                lvt_6_1_.applyModifier(new AttributeModifier(lvt_7_1_.getID(), this.getName() + " " + amplifier, this.getAttributeModifierAmount(amplifier, lvt_7_1_), lvt_7_1_.getOperation()));
            }
        }
    }
