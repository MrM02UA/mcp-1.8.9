...
public class ServerScoreboard extends Scoreboard
{
    ...
    public boolean addPlayerToTeam(String player, String newTeam)
    {
        if (super.addPlayerToTeam(player, newTeam))
        {
            ...
            this.scoreboardMCServer.getConfigurationManager().sendPacketToAllPlayers(new S3EPacketTeams(lvt_3_1_, Arrays.asList(new String[] {player}), 3));
            this.markSaveDataDirty();
            return true;
        }
        else
    ...
    public List<Packet> func_96550_d(ScoreObjective p_96550_1_)
    {
        ...
        for (Score lvt_4_1_ : this.getSortedScores(p_96550_1_))
        {
    ...
    public void func_96549_e(ScoreObjective p_96549_1_)
    {
        ...
        for (EntityPlayerMP lvt_4_1_ : this.scoreboardMCServer.getConfigurationManager().getPlayerList())
        {
            for (Packet lvt_6_1_ : lvt_2_1_)
            {
                lvt_4_1_.playerNetServerHandler.sendPacket(lvt_6_1_);
            }
        }
