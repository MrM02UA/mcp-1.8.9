...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        for (ItemFishFood.FishType lvt_4_1_ : ItemFishFood.FishType.values())
        {
            if (lvt_4_1_.canCook())
            {
                this.addSmeltingRecipe(new ItemStack(Items.fish, 1, lvt_4_1_.getMetadata()), new ItemStack(Items.cooked_fish, 1, lvt_4_1_.getMetadata()), 0.35F);
            }
        }
    ...
    {
        for (Entry<ItemStack, ItemStack> lvt_3_1_ : this.smeltingList.entrySet())
        {
            if (this.compareItemStacks(stack, (ItemStack)lvt_3_1_.getKey()))
            {
    ...
    {
        for (Entry<ItemStack, Float> lvt_3_1_ : this.experienceList.entrySet())
        {
            if (this.compareItemStacks(stack, (ItemStack)lvt_3_1_.getKey()))
            {
                return ((Float)lvt_3_1_.getValue()).floatValue();
            }
        }
