...
public class CraftingManager
{
    ...
    public ShapedRecipes addRecipe(ItemStack stack, Object... recipeComponents)
    {
        ...
        if (recipeComponents[lvt_4_1_] instanceof String[])
        {
            String[] lvt_7_1_ = (String[])((String[])recipeComponents[lvt_4_1_++]);
        ...
        {
            while (recipeComponents[lvt_4_1_] instanceof String)
            {
                String lvt_7_2_ = (String)recipeComponents[lvt_4_1_++];
                ++lvt_6_1_;
        ...
        Map<Character, ItemStack> lvt_7_3_;

        for (lvt_7_3_ = Maps.newHashMap(); lvt_4_1_ < recipeComponents.length; lvt_4_1_ += 2)
        {
            Character lvt_8_2_ = (Character)recipeComponents[lvt_4_1_];
            ItemStack lvt_9_2_ = null;

            if (recipeComponents[lvt_4_1_ + 1] instanceof Item)
            {
                lvt_9_2_ = new ItemStack((Item)recipeComponents[lvt_4_1_ + 1]);
            }
            else if (recipeComponents[lvt_4_1_ + 1] instanceof Block)
            {
                lvt_9_2_ = new ItemStack((Block)recipeComponents[lvt_4_1_ + 1], 1, 32767);
            }
            else if (recipeComponents[lvt_4_1_ + 1] instanceof ItemStack)
            {
                lvt_9_2_ = (ItemStack)recipeComponents[lvt_4_1_ + 1];
            }
        ...
        for (int lvt_9_3_ = 0; lvt_9_3_ < lvt_5_1_ * lvt_6_1_; ++lvt_9_3_)
        {
            ...
            if (lvt_7_3_.containsKey(Character.valueOf(lvt_10_1_)))
            {
                lvt_8_3_[lvt_9_3_] = ((ItemStack)lvt_7_3_.get(Character.valueOf(lvt_10_1_))).copy();
            }
            else
            {
        ...
        ShapedRecipes lvt_9_4_ = new ShapedRecipes(lvt_5_1_, lvt_6_1_, lvt_8_3_, stack);
        this.recipes.add(lvt_9_4_);
        return lvt_9_4_;
    }
    ...
    public void addShapelessRecipe(ItemStack stack, Object... recipeComponents)
    {
        ...
        for (Object lvt_7_1_ : recipeComponents)
        {
        ...
        this.recipes.add(new ShapelessRecipes(stack, lvt_3_1_));
    }
    ...
    public ItemStack findMatchingRecipe(InventoryCrafting p_82787_1_, World worldIn)
    {
        ...
        {
            if (lvt_4_1_.matches(p_82787_1_, worldIn))
            {
                return lvt_4_1_.getCraftingResult(p_82787_1_);
            }
        }
    ...
    public ItemStack[] func_180303_b(InventoryCrafting p_180303_1_, World worldIn)
    {
        for (IRecipe lvt_4_1_ : this.recipes)
        {
            if (lvt_4_1_.matches(p_180303_1_, worldIn))
            {
                return lvt_4_1_.getRemainingItems(p_180303_1_);
            }
        }

        ItemStack[] lvt_3_2_ = new ItemStack[p_180303_1_.getSizeInventory()];

        for (int lvt_4_2_ = 0; lvt_4_2_ < lvt_3_2_.length; ++lvt_4_2_)
        {
            lvt_3_2_[lvt_4_2_] = p_180303_1_.getStackInSlot(lvt_4_2_);
        }
