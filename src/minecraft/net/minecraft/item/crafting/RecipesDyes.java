...
public class RecipesDyes
{
    ...
    public void addRecipes(CraftingManager p_77607_1_)
    {
        ...
        {
            p_77607_1_.addShapelessRecipe(new ItemStack(Blocks.wool, 1, lvt_2_1_), new Object[] {new ItemStack(Items.dye, 1, 15 - lvt_2_1_), new ItemStack(Item.getItemFromBlock(Blocks.wool), 1, 0)});
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_hardened_clay, 8, 15 - lvt_2_1_), new Object[] {"###", "#X#", "###", '#', new ItemStack(Blocks.hardened_clay), 'X', new ItemStack(Items.dye, 1, lvt_2_1_)});
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass, 8, 15 - lvt_2_1_), new Object[] {"###", "#X#", "###", '#', new ItemStack(Blocks.glass), 'X', new ItemStack(Items.dye, 1, lvt_2_1_)});
            p_77607_1_.addRecipe(new ItemStack(Blocks.stained_glass_pane, 16, lvt_2_1_), new Object[] {"###", "###", '#', new ItemStack(Blocks.stained_glass, 1, lvt_2_1_)});
        }
        ...
        {
            p_77607_1_.addRecipe(new ItemStack(Blocks.carpet, 3, lvt_2_2_), new Object[] {"##", '#', new ItemStack(Blocks.wool, 1, lvt_2_2_)});
        }
    }
}
