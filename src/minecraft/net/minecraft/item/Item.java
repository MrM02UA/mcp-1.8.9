...
public class Item
{
    ...
    {
        Item lvt_1_1_ = (Item)itemRegistry.getObject(new ResourceLocation(id));
    ...
    {
        String lvt_2_1_ = this.getUnlocalizedName(stack);
        return lvt_2_1_ == null ? "" : StatCollector.translateToLocal(lvt_2_1_);
    }
    ...
    {
        float lvt_4_1_ = playerIn.rotationPitch;
        float lvt_5_1_ = playerIn.rotationYaw;
        double lvt_6_1_ = playerIn.posX;
        double lvt_8_1_ = playerIn.posY + (double)playerIn.getEyeHeight();
        double lvt_10_1_ = playerIn.posZ;
        Vec3 lvt_12_1_ = new Vec3(lvt_6_1_, lvt_8_1_, lvt_10_1_);
        float lvt_13_1_ = MathHelper.cos(-lvt_5_1_ * 0.017453292F - (float)Math.PI);
        float lvt_14_1_ = MathHelper.sin(-lvt_5_1_ * 0.017453292F - (float)Math.PI);
        ...
        Vec3 lvt_22_1_ = lvt_12_1_.addVector((double)lvt_17_1_ * lvt_20_1_, (double)lvt_16_1_ * lvt_20_1_, (double)lvt_19_1_ * lvt_20_1_);
        return worldIn.rayTraceBlocks(lvt_12_1_, lvt_22_1_, useLiquids, !useLiquids, false);
    }
    ...
    public static void registerItems()
    {
        ...
        Item lvt_0_1_ = (new ItemBucket(Blocks.air)).setUnlocalizedName("bucket").setMaxStackSize(16);
        registerItem(325, "bucket", lvt_0_1_);
        registerItem(326, "water_bucket", (new ItemBucket(Blocks.flowing_water)).setUnlocalizedName("bucketWater").setContainerItem(lvt_0_1_));
        registerItem(327, "lava_bucket", (new ItemBucket(Blocks.flowing_lava)).setUnlocalizedName("bucketLava").setContainerItem(lvt_0_1_));
        ...
        registerItem(335, "milk_bucket", (new ItemBucketMilk()).setUnlocalizedName("milk").setContainerItem(lvt_0_1_));
