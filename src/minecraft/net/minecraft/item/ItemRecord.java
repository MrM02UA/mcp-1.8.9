...
public class ItemRecord extends Item
{
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        if (lvt_9_1_.getBlock() == Blocks.jukebox && !((Boolean)lvt_9_1_.getValue(BlockJukebox.HAS_RECORD)).booleanValue())
        {
            if (worldIn.isRemote)
            {
                return true;
            ...
            {
                ((BlockJukebox)Blocks.jukebox).insertRecord(worldIn, pos, lvt_9_1_, stack);
