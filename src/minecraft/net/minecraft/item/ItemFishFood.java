...
public class ItemFishFood extends ItemFood
{
    ...
    {
        ItemFishFood.FishType lvt_2_1_ = ItemFishFood.FishType.byItemStack(stack);
        return this.cooked && lvt_2_1_.canCook() ? lvt_2_1_.getCookedHealAmount() : lvt_2_1_.getUncookedHealAmount();
    }

    public float getSaturationModifier(ItemStack stack)
    {
        ItemFishFood.FishType lvt_2_1_ = ItemFishFood.FishType.byItemStack(stack);
        return this.cooked && lvt_2_1_.canCook() ? lvt_2_1_.getCookedSaturationModifier() : lvt_2_1_.getUncookedSaturationModifier();
    }
    ...
    {
        ItemFishFood.FishType lvt_4_1_ = ItemFishFood.FishType.byItemStack(stack);
    ...
    {
        for (ItemFishFood.FishType lvt_7_1_ : ItemFishFood.FishType.values())
        {
            if (!this.cooked || lvt_7_1_.canCook())
            {
                subItems.add(new ItemStack(this, 1, lvt_7_1_.getMetadata()));
            }
        }
    }
    ...
    public static enum FishType
    {
        ...
        {
            ItemFishFood.FishType lvt_1_1_ = (ItemFishFood.FishType)META_LOOKUP.get(Integer.valueOf(meta));
        ...
        static {
            for (ItemFishFood.FishType lvt_3_1_ : values())
            {
                META_LOOKUP.put(Integer.valueOf(lvt_3_1_.getMetadata()), lvt_3_1_);
            }
        }
    }
}
