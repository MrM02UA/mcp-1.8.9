...
public class CommandDifficulty extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        ...
        {
            EnumDifficulty lvt_3_1_ = this.getDifficultyFromCommand(args[0]);
            MinecraftServer.getServer().setDifficultyForAllWorlds(lvt_3_1_);
            notifyOperators(sender, this, "commands.difficulty.success", new Object[] {new ChatComponentTranslation(lvt_3_1_.getDifficultyResourceKey(), new Object[0])});
        }
    }
