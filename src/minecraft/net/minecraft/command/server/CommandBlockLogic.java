...
public abstract class CommandBlockLogic implements ICommandSender
{
    ...
    public void trigger(World worldIn)
    {
        ...
        if (lvt_2_1_ != null && lvt_2_1_.isAnvilFileSet() && lvt_2_1_.isCommandBlockEnabled())
        {
            ...
            {
                CrashReport lvt_5_1_ = CrashReport.makeCrashReport(var7, "Executing command block");
                CrashReportCategory lvt_6_1_ = lvt_5_1_.makeCategory("Command to be executed");
                lvt_6_1_.addCrashSectionCallable("Command", new Callable<String>()
                {
                ...
                lvt_6_1_.addCrashSectionCallable("Name", new Callable<String>()
                {
                    public String call() throws Exception
                    {
    ...
    public boolean sendCommandFeedback()
    {
        ...
        return lvt_1_1_ == null || !lvt_1_1_.isAnvilFileSet() || lvt_1_1_.worldServers[0].getGameRules().getBoolean("commandBlockOutput");
    }
