...
public class InventoryCrafting implements IInventory
{
    ...
    {
        int lvt_4_1_ = width * height;
        this.stackList = new ItemStack[lvt_4_1_];
    ...
    public ItemStack removeStackFromSlot(int index)
    {
        ...
        {
            ItemStack lvt_2_1_ = this.stackList[index];
    ...
    public ItemStack decrStackSize(int index, int count)
    {
        if (this.stackList[index] != null)
        {
            ...
            {
                ItemStack lvt_3_1_ = this.stackList[index];
                this.stackList[index] = null;
            ...
            {
                ItemStack lvt_3_2_ = this.stackList[index].splitStack(count);
    ...
    public void clear()
    {
        for (int lvt_1_1_ = 0; lvt_1_1_ < this.stackList.length; ++lvt_1_1_)
        {
            this.stackList[lvt_1_1_] = null;
        }
    }
