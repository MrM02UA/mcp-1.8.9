...
public class TileEntityEnchantmentTable extends TileEntity implements ITickable, IInteractionObject
{
    ...
    public void update()
    {
        ...
        EntityPlayer lvt_1_1_ = this.worldObj.getClosestPlayer((double)((float)this.pos.getX() + 0.5F), (double)((float)this.pos.getY() + 0.5F), (double)((float)this.pos.getZ() + 0.5F), 3.0D);
        ...
        if (lvt_1_1_ != null)
        {
            ...
            this.field_145924_q = (float)MathHelper.atan2(lvt_4_1_, lvt_2_1_);
        ...
        for (lvt_2_2_ = this.field_145924_q - this.bookRotation; lvt_2_2_ >= (float)Math.PI; lvt_2_2_ -= ((float)Math.PI * 2F))
        {
            ;
        }
        ...
        float lvt_3_1_ = (this.field_145932_k - this.pageFlip) * 0.4F;
        float lvt_4_2_ = 0.2F;
        lvt_3_1_ = MathHelper.clamp_float(lvt_3_1_, -lvt_4_2_, lvt_4_2_);
