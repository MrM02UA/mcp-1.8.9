...
public abstract class EntityMinecartContainer extends EntityMinecart implements ILockableContainer
{
    ...
    public ItemStack decrStackSize(int index, int count)
    {
        if (this.minecartContainerItems[index] != null)
        {
            ...
            {
                ItemStack lvt_3_1_ = this.minecartContainerItems[index];
                this.minecartContainerItems[index] = null;
                return lvt_3_1_;
            }
            else
            {
                ItemStack lvt_3_2_ = this.minecartContainerItems[index].splitStack(count);
    ...
    public ItemStack removeStackFromSlot(int index)
    {
        if (this.minecartContainerItems[index] != null)
        {
            ItemStack lvt_2_1_ = this.minecartContainerItems[index];
            this.minecartContainerItems[index] = null;
            return lvt_2_1_;
        }
        else
    ...
    protected void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        for (int lvt_3_1_ = 0; lvt_3_1_ < this.minecartContainerItems.length; ++lvt_3_1_)
        {
            if (this.minecartContainerItems[lvt_3_1_] != null)
            {
                NBTTagCompound lvt_4_1_ = new NBTTagCompound();
                lvt_4_1_.setByte("Slot", (byte)lvt_3_1_);
                this.minecartContainerItems[lvt_3_1_].writeToNBT(lvt_4_1_);
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        NBTTagList lvt_2_1_ = tagCompund.getTagList("Items", 10);
        ...
        for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_.tagCount(); ++lvt_3_1_)
        {
            ...
            if (lvt_5_1_ >= 0 && lvt_5_1_ < this.minecartContainerItems.length)
            {
                this.minecartContainerItems[lvt_5_1_] = ItemStack.loadItemStackFromNBT(lvt_4_1_);
            }
        }
    }
    ...
    {
        int lvt_1_1_ = 15 - Container.calcRedstoneFromInventory(this);
    ...
    public void clear()
    {
        for (int lvt_1_1_ = 0; lvt_1_1_ < this.minecartContainerItems.length; ++lvt_1_1_)
        {
            this.minecartContainerItems[lvt_1_1_] = null;
        }
    }
}
