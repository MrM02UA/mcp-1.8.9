...
public class EntityPainting extends EntityHanging
{
    ...
    public EntityPainting(World worldIn, BlockPos pos, EnumFacing facing)
    {
        ...
        for (EntityPainting.EnumArt lvt_8_1_ : EntityPainting.EnumArt.values())
        {
            this.art = lvt_8_1_;
        ...
        if (!lvt_4_1_.isEmpty())
        {
            this.art = (EntityPainting.EnumArt)lvt_4_1_.get(this.rand.nextInt(lvt_4_1_.size()));
        }
    ...
    public EntityPainting(World worldIn, BlockPos pos, EnumFacing facing, String title)
    {
        ...
        for (EntityPainting.EnumArt lvt_8_1_ : EntityPainting.EnumArt.values())
        {
            if (lvt_8_1_.title.equals(title))
            {
                this.art = lvt_8_1_;
                break;
            }
    ...
    {
        String lvt_2_1_ = tagCompund.getString("Motive");

        for (EntityPainting.EnumArt lvt_6_1_ : EntityPainting.EnumArt.values())
        {
            if (lvt_6_1_.title.equals(lvt_2_1_))
            {
                this.art = lvt_6_1_;
            }
        }
    ...
    public void onBroken(Entity brokenEntity)
    {
        if (this.worldObj.getGameRules().getBoolean("doEntityDrops"))
        {
            ...
            {
                EntityPlayer lvt_2_1_ = (EntityPlayer)brokenEntity;
    ...
    {
        BlockPos lvt_9_1_ = this.hangingPosition.add(x - this.posX, y - this.posY, z - this.posZ);
        this.setPosition((double)lvt_9_1_.getX(), (double)lvt_9_1_.getY(), (double)lvt_9_1_.getZ());
    }

    public void setPositionAndRotation2(double x, double y, double z, float yaw, float pitch, int posRotationIncrements, boolean p_180426_10_)
    {
        BlockPos lvt_11_1_ = this.hangingPosition.add(x - this.posX, y - this.posY, z - this.posZ);
