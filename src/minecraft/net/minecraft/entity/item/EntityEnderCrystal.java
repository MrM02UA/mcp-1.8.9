...
public class EntityEnderCrystal extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if (this.worldObj.provider instanceof WorldProviderEnd && this.worldObj.getBlockState(new BlockPos(lvt_1_1_, lvt_2_1_, lvt_3_1_)).getBlock() != Blocks.fire)
        {
            this.worldObj.setBlockState(new BlockPos(lvt_1_1_, lvt_2_1_, lvt_3_1_), Blocks.fire.getDefaultState());
        }
    }
