...
public class EntityMinecartFurnace extends EntityMinecart
{
    ...
    protected void func_180460_a(BlockPos p_180460_1_, IBlockState p_180460_2_)
    {
        ...
        double lvt_3_1_ = this.pushX * this.pushX + this.pushZ * this.pushZ;

        if (lvt_3_1_ > 1.0E-4D && this.motionX * this.motionX + this.motionZ * this.motionZ > 0.001D)
        {
            lvt_3_1_ = (double)MathHelper.sqrt_double(lvt_3_1_);
            this.pushX /= lvt_3_1_;
            this.pushZ /= lvt_3_1_;
            ...
            {
                double lvt_5_1_ = lvt_3_1_ / this.getMaximumSpeed();
                this.pushX *= lvt_5_1_;
                this.pushZ *= lvt_5_1_;
            }
        }
    ...
    {
        double lvt_1_1_ = this.pushX * this.pushX + this.pushZ * this.pushZ;

        if (lvt_1_1_ > 1.0E-4D)
        {
            lvt_1_1_ = (double)MathHelper.sqrt_double(lvt_1_1_);
            this.pushX /= lvt_1_1_;
            this.pushZ /= lvt_1_1_;
            ...
            this.motionX += this.pushX * lvt_3_1_;
            this.motionZ += this.pushZ * lvt_3_1_;
        }
        else
        {
    ...
    public boolean interactFirst(EntityPlayer playerIn)
    {
        ...
        if (lvt_2_1_ != null && lvt_2_1_.getItem() == Items.coal)
        {
