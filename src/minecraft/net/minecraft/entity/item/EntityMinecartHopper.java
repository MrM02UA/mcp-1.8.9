...
public class EntityMinecartHopper extends EntityMinecartContainer implements IHopper
{
    ...
    {
        boolean lvt_5_1_ = !receivingPower;
    ...
    public boolean func_96112_aD()
    {
        ...
        {
            List<EntityItem> lvt_1_1_ = this.worldObj.<EntityItem>getEntitiesWithinAABB(EntityItem.class, this.getEntityBoundingBox().expand(0.25D, 0.0D, 0.25D), EntitySelectors.selectAnything);

            if (lvt_1_1_.size() > 0)
            {
                TileEntityHopper.putDropInInventoryAllSlots(this, (EntityItem)lvt_1_1_.get(0));
            }
