...
public class EntityXPOrb extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        {
            if (this.closestPlayer == null || this.closestPlayer.getDistanceSqToEntity(this) > lvt_1_1_ * lvt_1_1_)
            {
                this.closestPlayer = this.worldObj.getClosestPlayerToEntity(this, lvt_1_1_);
            }
        ...
        {
            double lvt_3_1_ = (this.closestPlayer.posX - this.posX) / lvt_1_1_;
            double lvt_5_1_ = (this.closestPlayer.posY + (double)this.closestPlayer.getEyeHeight() - this.posY) / lvt_1_1_;
            double lvt_7_1_ = (this.closestPlayer.posZ - this.posZ) / lvt_1_1_;
            ...
            if (lvt_11_1_ > 0.0D)
            {
                ...
                this.motionX += lvt_3_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
                this.motionY += lvt_5_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
                this.motionZ += lvt_7_1_ / lvt_9_1_ * lvt_11_1_ * 0.1D;
            }
        }
        ...
        if (this.onGround)
        {
            lvt_3_2_ = this.worldObj.getBlockState(new BlockPos(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.getEntityBoundingBox().minY) - 1, MathHelper.floor_double(this.posZ))).getBlock().slipperiness * 0.98F;
        }

        this.motionX *= (double)lvt_3_2_;
        this.motionY *= 0.9800000190734863D;
        this.motionZ *= (double)lvt_3_2_;
