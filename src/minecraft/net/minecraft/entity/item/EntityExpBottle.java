...
public class EntityExpBottle extends EntityThrowable
{
    ...
    protected void onImpact(MovingObjectPosition p_70184_1_)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            int lvt_2_1_ = 3 + this.worldObj.rand.nextInt(5) + this.worldObj.rand.nextInt(5);

            while (lvt_2_1_ > 0)
            {
                int lvt_3_1_ = EntityXPOrb.getXPSplit(lvt_2_1_);
                lvt_2_1_ -= lvt_3_1_;
                this.worldObj.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, lvt_3_1_));
            }
