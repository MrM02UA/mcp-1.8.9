...
public class EntityWolf extends EntityTameable
{
        ...
        else if ((this.isWet || this.isShaking) && this.isShaking)
        {
            ...
            if (this.timeWolfIsShaking > 0.4F)
            {
                ...
                for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_)
                {
                    ...
                    this.worldObj.spawnParticle(EnumParticleTypes.WATER_SPLASH, this.posX + (double)lvt_4_1_, (double)(lvt_1_1_ + 0.8F), this.posZ + (double)lvt_5_1_, this.motionX, this.motionY, this.motionZ, new int[0]);
                }
            }
        }
    }
    ...
    {
        float lvt_3_1_ = (this.prevTimeWolfIsShaking + (this.timeWolfIsShaking - this.prevTimeWolfIsShaking) * p_70923_1_ + p_70923_2_) / 1.8F;
    ...
    {
        boolean lvt_2_1_ = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), (float)((int)this.getEntityAttribute(SharedMonsterAttributes.attackDamage).getAttributeValue()));
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        if (this.isTamed())
        {
            if (lvt_2_1_ != null)
            {
                if (lvt_2_1_.getItem() instanceof ItemFood)
                {
                    ItemFood lvt_3_1_ = (ItemFood)lvt_2_1_.getItem();

                    if (lvt_3_1_.isWolfsFavoriteMeat() && this.dataWatcher.getWatchableObjectFloat(18) < 20.0F)
                    {
                        ...
                        this.heal((float)lvt_3_1_.getHealAmount(lvt_2_1_));
                ...
                else if (lvt_2_1_.getItem() == Items.dye)
                {
                    EnumDyeColor lvt_3_2_ = EnumDyeColor.byDyeDamage(lvt_2_1_.getMetadata());

                    if (lvt_3_2_ != this.getCollarColor())
                    {
                        this.setCollarColor(lvt_3_2_);
            ...
            if (this.isOwner(player) && !this.worldObj.isRemote && !this.isBreedingItem(lvt_2_1_))
            {
        ...
        else if (lvt_2_1_ != null && lvt_2_1_.getItem() == Items.bone && !this.isAngry())
        {
            if (!player.capabilities.isCreativeMode)
            {
                --lvt_2_1_.stackSize;
    ...
    public void setAngry(boolean angry)
    {
        ...
        {
            this.dataWatcher.updateObject(16, Byte.valueOf((byte)(lvt_2_1_ & -3)));
        }
    }
    ...
    {
        EntityWolf lvt_2_1_ = new EntityWolf(this.worldObj);
        String lvt_3_1_ = this.getOwnerId();
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityWolf lvt_2_1_ = (EntityWolf)otherAnimal;
            return !lvt_2_1_.isTamed() ? false : (lvt_2_1_.isSitting() ? false : this.isInLove() && lvt_2_1_.isInLove());
        }
    }
    ...
    public boolean shouldAttackEntity(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        if (!(p_142018_1_ instanceof EntityCreeper) && !(p_142018_1_ instanceof EntityGhast))
        {
            if (p_142018_1_ instanceof EntityWolf)
            {
                ...
                if (lvt_3_1_.isTamed() && lvt_3_1_.getOwner() == p_142018_2_)
                {
                    return false;
                }
            }
