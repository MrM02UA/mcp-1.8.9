...
public class EntityCow extends EntityAnimal
{
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier)
    {
        ...
        lvt_3_1_ = this.rand.nextInt(3) + 1 + this.rand.nextInt(1 + lootingModifier);
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        if (lvt_2_1_ != null && lvt_2_1_.getItem() == Items.bucket && !player.capabilities.isCreativeMode && !this.isChild())
        {
