...
public class EntityHorse extends EntityAnimal implements IInvBasic
{
    ...
    public String getName()
    {
        ...
        {
            int lvt_1_1_ = this.getHorseType();
    ...
    private void setHorseWatchableBoolean(int p_110208_1_, boolean p_110208_2_)
    {
        ...
        if (p_110208_2_)
        {
            this.dataWatcher.updateObject(16, Integer.valueOf(lvt_3_1_ | p_110208_1_));
        }
        else
        {
            this.dataWatcher.updateObject(16, Integer.valueOf(lvt_3_1_ & ~p_110208_1_));
    ...
    private int getHorseArmorIndex(ItemStack itemStackIn)
    {
        ...
        else
        {
            ...
            return lvt_2_1_ == Items.iron_horse_armor ? 1 : (lvt_2_1_ == Items.golden_horse_armor ? 2 : (lvt_2_1_ == Items.diamond_horse_armor ? 3 : 0));
        }
    }
    ...
    {
        int lvt_2_1_ = MathHelper.clamp_int(this.getTemper() + p_110198_1_, 0, this.getMaxTemper());
        this.setTemper(lvt_2_1_);
        return lvt_2_1_;
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        return this.riddenByEntity != null && this.riddenByEntity.equals(lvt_3_1_) ? false : super.attackEntityFrom(source, amount);
    }
    ...
    public boolean prepareChunkForSpawn()
    {
        ...
        int lvt_2_1_ = MathHelper.floor_double(this.posZ);
        this.worldObj.getBiomeGenForCoords(new BlockPos(lvt_1_1_, 0, lvt_2_1_));
        return true;
    }
    ...
    public void fall(float distance, float damageMultiplier)
    {
        ...
        int lvt_3_1_ = MathHelper.ceiling_float_int((distance * 0.5F - 3.0F) * damageMultiplier);
        ...
        if (lvt_3_1_ > 0)
        {
            ...
            {
                this.riddenByEntity.attackEntityFrom(DamageSource.fall, (float)lvt_3_1_);
            }

            Block lvt_4_1_ = this.worldObj.getBlockState(new BlockPos(this.posX, this.posY - 0.2D - (double)this.prevRotationYaw, this.posZ)).getBlock();

            if (lvt_4_1_.getMaterial() != Material.air && !this.isSilent())
            {
                Block.SoundType lvt_5_1_ = lvt_4_1_.stepSound;
                this.worldObj.playSoundAtEntity(this, lvt_5_1_.getStepSound(), lvt_5_1_.getVolume() * 0.5F, lvt_5_1_.getFrequency() * 0.75F);
            }
        }
    }
    ...
    {
        int lvt_1_1_ = this.getHorseType();
        return !this.isChested() || lvt_1_1_ != 1 && lvt_1_1_ != 2 ? 2 : 17;
    }

    private void initHorseChest()
    {
        AnimalChest lvt_1_1_ = this.horseChest;
        this.horseChest = new AnimalChest("HorseChest", this.getChestSize());
        this.horseChest.setCustomName(this.getName());

        if (lvt_1_1_ != null)
        {
            lvt_1_1_.removeInventoryChangeListener(this);
            int lvt_2_1_ = Math.min(lvt_1_1_.getSizeInventory(), this.horseChest.getSizeInventory());

            for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_)
            {
                ItemStack lvt_4_1_ = lvt_1_1_.getStackInSlot(lvt_3_1_);

                if (lvt_4_1_ != null)
                {
                    this.horseChest.setInventorySlotContents(lvt_3_1_, lvt_4_1_.copy());
                }
            }
        }
    ...
    {
        int lvt_2_1_ = this.getHorseArmorIndexSynced();
        boolean lvt_3_1_ = this.isHorseSaddled();
        this.updateHorseSlots();

        if (this.ticksExisted > 20)
        {
            if (lvt_2_1_ == 0 && lvt_2_1_ != this.getHorseArmorIndexSynced())
            {
                this.playSound("mob.horse.armor", 0.5F, 1.0F);
            }
            else if (lvt_2_1_ != this.getHorseArmorIndexSynced())
            {
                this.playSound("mob.horse.armor", 0.5F, 1.0F);
            }

            if (!lvt_3_1_ && this.isHorseSaddled())
            {
    ...
    protected EntityHorse getClosestHorse(Entity entityIn, double distance)
    {
        ...
        for (Entity lvt_9_1_ : this.worldObj.getEntitiesInAABBexcluding(entityIn, entityIn.getEntityBoundingBox().addCoord(distance, distance, distance), horseBreedingSelector))
        {
            double lvt_10_1_ = lvt_9_1_.getDistanceSq(entityIn.posX, entityIn.posY, entityIn.posZ);
    ...
    protected String getDeathSound()
    {
        this.openHorseMouth();
        int lvt_1_1_ = this.getHorseType();
        return lvt_1_1_ == 3 ? "mob.horse.zombie.death" : (lvt_1_1_ == 4 ? "mob.horse.skeleton.death" : (lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.death" : "mob.horse.donkey.death"));
    }

    protected Item getDropItem()
    {
        boolean lvt_1_1_ = this.rand.nextInt(4) == 0;
        int lvt_2_1_ = this.getHorseType();
        return lvt_2_1_ == 4 ? Items.bone : (lvt_2_1_ == 3 ? (lvt_1_1_ ? null : Items.rotten_flesh) : Items.leather);
    }
    ...
    protected String getHurtSound()
    {
        ...
        int lvt_1_1_ = this.getHorseType();
        return lvt_1_1_ == 3 ? "mob.horse.zombie.hit" : (lvt_1_1_ == 4 ? "mob.horse.skeleton.hit" : (lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.hit" : "mob.horse.donkey.hit"));
    }
    ...
    protected String getLivingSound()
    {
        ...
        int lvt_1_1_ = this.getHorseType();
        return lvt_1_1_ == 3 ? "mob.horse.zombie.idle" : (lvt_1_1_ == 4 ? "mob.horse.skeleton.idle" : (lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.idle" : "mob.horse.donkey.idle"));
    }
    ...
    protected String getAngrySoundName()
    {
        ...
        this.makeHorseRear();
        int lvt_1_1_ = this.getHorseType();
        return lvt_1_1_ != 3 && lvt_1_1_ != 4 ? (lvt_1_1_ != 1 && lvt_1_1_ != 2 ? "mob.horse.angry" : "mob.horse.donkey.angry") : null;
    }
    ...
    protected void playStepSound(BlockPos pos, Block blockIn)
    {
        ...
        {
            int lvt_4_1_ = this.getHorseType();

            if (this.riddenByEntity != null && lvt_4_1_ != 1 && lvt_4_1_ != 2)
            {
                ++this.gallopTime;

                if (this.gallopTime > 5 && this.gallopTime % 3 == 0)
                {
                    this.playSound("mob.horse.gallop", lvt_3_1_.getVolume() * 0.15F, lvt_3_1_.getFrequency());

                    if (lvt_4_1_ == 0 && this.rand.nextInt(10) == 0)
                    {
                        this.playSound("mob.horse.breathe", lvt_3_1_.getVolume() * 0.6F, lvt_3_1_.getFrequency());
                    }
                }
                else if (this.gallopTime <= 5)
                {
                    this.playSound("mob.horse.wood", lvt_3_1_.getVolume() * 0.15F, lvt_3_1_.getFrequency());
                }
            }
            else if (lvt_3_1_ == Block.soundTypeWood)
            {
                this.playSound("mob.horse.wood", lvt_3_1_.getVolume() * 0.15F, lvt_3_1_.getFrequency());
            }
            else
            {
                this.playSound("mob.horse.soft", lvt_3_1_.getVolume() * 0.15F, lvt_3_1_.getFrequency());
            }
        }
    }
    ...
    private void setHorseTexturePaths()
    {
        ...
        int lvt_1_1_ = this.getHorseType();
        int lvt_2_1_ = this.getHorseVariant();

        if (lvt_1_1_ == 0)
        {
            int lvt_3_1_ = lvt_2_1_ & 255;
            int lvt_4_1_ = (lvt_2_1_ & 65280) >> 8;

            if (lvt_3_1_ >= horseTextures.length)
            {
                this.field_175508_bO = false;
                return;
            }

            this.horseTexturesArray[0] = horseTextures[lvt_3_1_];
            this.texturePrefix = this.texturePrefix + HORSE_TEXTURES_ABBR[lvt_3_1_];

            if (lvt_4_1_ >= horseMarkingTextures.length)
            {
                this.field_175508_bO = false;
                return;
            }

            this.horseTexturesArray[1] = horseMarkingTextures[lvt_4_1_];
            this.texturePrefix = this.texturePrefix + HORSE_MARKING_TEXTURES_ABBR[lvt_4_1_];
        }
        else
        {
            this.horseTexturesArray[0] = "";
            this.texturePrefix = this.texturePrefix + "_" + lvt_1_1_ + "_";
        }

        int lvt_3_2_ = this.getHorseArmorIndexSynced();

        if (lvt_3_2_ >= horseArmorTextures.length)
        {
            this.field_175508_bO = false;
        }
        else
        {
            this.horseTexturesArray[2] = horseArmorTextures[lvt_3_2_];
            this.texturePrefix = this.texturePrefix + HORSE_ARMOR_TEXTURES_ABBR[lvt_3_2_];
        ...
        else
        {
            if (lvt_2_1_ != null)
            {
                ...
                if (this.canWearArmor())
                {
                    ...
                    if (lvt_2_1_.getItem() == Items.iron_horse_armor)
                    {
                        lvt_4_1_ = 1;
                    }
                    else if (lvt_2_1_.getItem() == Items.golden_horse_armor)
                    {
                        lvt_4_1_ = 2;
                    }
                    else if (lvt_2_1_.getItem() == Items.diamond_horse_armor)
                    {
                        lvt_4_1_ = 3;
                    }
                ...
                if (!lvt_3_1_ && !this.isUndead())
                {
                    float lvt_4_2_ = 0.0F;
                    int lvt_5_1_ = 0;
                    int lvt_6_1_ = 0;

                    if (lvt_2_1_.getItem() == Items.wheat)
                    {
                        lvt_4_2_ = 2.0F;
                        lvt_5_1_ = 20;
                        lvt_6_1_ = 3;
                    }
                    else if (lvt_2_1_.getItem() == Items.sugar)
                    {
                        lvt_4_2_ = 1.0F;
                        lvt_5_1_ = 30;
                        lvt_6_1_ = 3;
                    }
                    else if (Block.getBlockFromItem(lvt_2_1_.getItem()) == Blocks.hay_block)
                    {
                        lvt_4_2_ = 20.0F;
                        lvt_5_1_ = 180;
                    }
                    else if (lvt_2_1_.getItem() == Items.apple)
                    {
                        lvt_4_2_ = 3.0F;
                        lvt_5_1_ = 60;
                        lvt_6_1_ = 3;
                    }
                    else if (lvt_2_1_.getItem() == Items.golden_carrot)
                    {
                        lvt_4_2_ = 4.0F;
                        lvt_5_1_ = 60;
                        lvt_6_1_ = 5;
                    ...
                    else if (lvt_2_1_.getItem() == Items.golden_apple)
                    {
                        lvt_4_2_ = 10.0F;
                        lvt_5_1_ = 240;
                        lvt_6_1_ = 10;
                    ...
                    if (this.getHealth() < this.getMaxHealth() && lvt_4_2_ > 0.0F)
                    {
                        this.heal(lvt_4_2_);
                        lvt_3_1_ = true;
                    }

                    if (!this.isAdultHorse() && lvt_5_1_ > 0)
                    {
                        this.addGrowth(lvt_5_1_);
                        lvt_3_1_ = true;
                    }

                    if (lvt_6_1_ > 0 && (lvt_3_1_ || !this.isTame()) && lvt_6_1_ < this.getMaxTemper())
                    {
                        lvt_3_1_ = true;
                        this.increaseTemper(lvt_6_1_);
                    }
                ...
                if (!this.isTame() && !lvt_3_1_)
                {
                    if (lvt_2_1_ != null && lvt_2_1_.interactWithEntity(player, this))
                    {
                        return true;
                    }
                ...
                if (!lvt_3_1_ && this.canCarryChest() && !this.isChested() && lvt_2_1_.getItem() == Item.getItemFromBlock(Blocks.chest))
                {
                ...
                if (!lvt_3_1_ && this.func_110253_bW() && !this.isHorseSaddled() && lvt_2_1_.getItem() == Items.saddle)
                {
                    this.openGUI(player);
                    return true;
                }
                ...
                if (lvt_3_1_)
                {
                    if (!player.capabilities.isCreativeMode && --lvt_2_1_.stackSize == 0)
                    {
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityHorse lvt_1_1_ = this.getClosestHorse(this, 16.0D);

                if (lvt_1_1_ != null && this.getDistanceSqToEntity(lvt_1_1_) > 4.0D)
                {
                    this.navigator.getPathToEntityLiving(lvt_1_1_);
                }
            }
        }
    }
    ...
    {
        this.makeHorseRear();
        String lvt_1_1_ = this.getAngrySoundName();
    ...
    private void dropItemsInChest(Entity entityIn, AnimalChest animalChestIn)
    {
        ...
        {
            for (int lvt_3_1_ = 0; lvt_3_1_ < animalChestIn.getSizeInventory(); ++lvt_3_1_)
            {
                ItemStack lvt_4_1_ = animalChestIn.getStackInSlot(lvt_3_1_);
    ...
    public void moveEntityWithHeading(float strafe, float forward)
    {
        if (this.riddenByEntity != null && this.riddenByEntity instanceof EntityLivingBase && this.isHorseSaddled())
        {
            ...
            if (this.jumpPower > 0.0F && !this.isHorseJumping() && this.onGround)
            {
                ...
                if (forward > 0.0F)
                {
                    float lvt_3_1_ = MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F);
                    float lvt_4_1_ = MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F);
                    this.motionX += (double)(-0.4F * lvt_3_1_ * this.jumpPower);
                    this.motionZ += (double)(0.4F * lvt_4_1_ * this.jumpPower);
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        if (this.isChested())
        {
            ...
            tagCompound.setTag("Items", lvt_2_1_);
        }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        IAttributeInstance lvt_3_2_ = this.getAttributeMap().getAttributeInstanceByName("Speed");

        if (lvt_3_2_ != null)
        {
            this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(lvt_3_2_.getBaseValue() * 0.25D);
        }

        if (this.isChested())
        {
            NBTTagList lvt_4_1_ = tagCompund.getTagList("Items", 10);
            this.initHorseChest();

            for (int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_.tagCount(); ++lvt_5_1_)
            {
                NBTTagCompound lvt_6_1_ = lvt_4_1_.getCompoundTagAt(lvt_5_1_);
                int lvt_7_1_ = lvt_6_1_.getByte("Slot") & 255;

                if (lvt_7_1_ >= 2 && lvt_7_1_ < this.horseChest.getSizeInventory())
                {
                    this.horseChest.setInventorySlotContents(lvt_7_1_, ItemStack.loadItemStackFromNBT(lvt_6_1_));
                }
            }
        }
        ...
        {
            ItemStack lvt_4_2_ = ItemStack.loadItemStackFromNBT(tagCompund.getCompoundTag("ArmorItem"));

            if (lvt_4_2_ != null && isArmorItem(lvt_4_2_.getItem()))
            {
                this.horseChest.setInventorySlotContents(1, lvt_4_2_);
            }
        }

        if (tagCompund.hasKey("SaddleItem", 10))
        {
            ItemStack lvt_4_3_ = ItemStack.loadItemStackFromNBT(tagCompund.getCompoundTag("SaddleItem"));

            if (lvt_4_3_ != null && lvt_4_3_.getItem() == Items.saddle)
            {
                this.horseChest.setInventorySlotContents(0, lvt_4_3_);
            }
        }
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityHorse lvt_2_1_ = (EntityHorse)otherAnimal;

            if (this.canMate() && lvt_2_1_.canMate())
            {
                int lvt_3_1_ = this.getHorseType();
                int lvt_4_1_ = lvt_2_1_.getHorseType();
    ...
    {
        EntityHorse lvt_2_1_ = (EntityHorse)ageable;
        EntityHorse lvt_3_1_ = new EntityHorse(this.worldObj);
        int lvt_4_1_ = this.getHorseType();
        int lvt_5_1_ = lvt_2_1_.getHorseType();
        int lvt_6_1_ = 0;
        ...
        if (lvt_6_1_ == 0)
        {
            int lvt_8_1_ = this.rand.nextInt(9);
            int lvt_7_1_;

            if (lvt_8_1_ < 4)
            {
                lvt_7_1_ = this.getHorseVariant() & 255;
            }
            else if (lvt_8_1_ < 8)
            {
                lvt_7_1_ = lvt_2_1_.getHorseVariant() & 255;
            }
            else
            {
                lvt_7_1_ = this.rand.nextInt(7);
            }

            int lvt_9_1_ = this.rand.nextInt(5);

            if (lvt_9_1_ < 2)
            {
                lvt_7_1_ = lvt_7_1_ | this.getHorseVariant() & 65280;
            }
            else if (lvt_9_1_ < 4)
            {
                lvt_7_1_ = lvt_7_1_ | lvt_2_1_.getHorseVariant() & 65280;
            }
            else
            {
                lvt_7_1_ = lvt_7_1_ | this.rand.nextInt(5) << 8 & 65280;
            }

            lvt_3_1_.setHorseVariant(lvt_7_1_);
        }

        lvt_3_1_.setHorseType(lvt_6_1_);
        double lvt_7_4_ = this.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + ageable.getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue() + (double)this.getModifiedMaxHealth();
        lvt_3_1_.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(lvt_7_4_ / 3.0D);
        double lvt_9_2_ = this.getEntityAttribute(horseJumpStrength).getBaseValue() + ageable.getEntityAttribute(horseJumpStrength).getBaseValue() + this.getModifiedJumpStrength();
        lvt_3_1_.getEntityAttribute(horseJumpStrength).setBaseValue(lvt_9_2_ / 3.0D);
        double lvt_11_1_ = this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getBaseValue() + ageable.getEntityAttribute(SharedMonsterAttributes.movementSpeed).getBaseValue() + this.getModifiedMovementSpeed();
        lvt_3_1_.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(lvt_11_1_ / 3.0D);
        return lvt_3_1_;
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        {
            lvt_3_1_ = ((EntityHorse.GroupData)livingdata).horseType;
            lvt_4_1_ = ((EntityHorse.GroupData)livingdata).horseVariant & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            {
                int lvt_5_1_ = this.rand.nextInt(7);
                int lvt_6_1_ = this.rand.nextInt(5);
                lvt_3_1_ = 0;
                lvt_4_1_ = lvt_5_1_ | lvt_6_1_ << 8;
            }

            livingdata = new EntityHorse.GroupData(lvt_3_1_, lvt_4_1_);
        }

        this.setHorseType(lvt_3_1_);
        this.setHorseVariant(lvt_4_1_);
    ...
    public void updateRiderPosition()
    {
        ...
        {
            float lvt_1_1_ = MathHelper.sin(this.renderYawOffset * (float)Math.PI / 180.0F);
            float lvt_2_1_ = MathHelper.cos(this.renderYawOffset * (float)Math.PI / 180.0F);
            float lvt_3_1_ = 0.7F * this.prevRearingAmount;
            float lvt_4_1_ = 0.15F * this.prevRearingAmount;
            this.riddenByEntity.setPosition(this.posX + (double)(lvt_3_1_ * lvt_1_1_), this.posY + this.getMountedYOffset() + this.riddenByEntity.getYOffset() + (double)lvt_4_1_, this.posZ - (double)(lvt_3_1_ * lvt_2_1_));
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn)
    {
        ...
        int lvt_3_1_ = inventorySlot - 400;

        if (lvt_3_1_ >= 0 && lvt_3_1_ < 2 && lvt_3_1_ < this.horseChest.getSizeInventory())
        {
            if (lvt_3_1_ == 0 && itemStackIn != null && itemStackIn.getItem() != Items.saddle)
            {
                return false;
            }
            else if (lvt_3_1_ != 1 || (itemStackIn == null || isArmorItem(itemStackIn.getItem())) && this.canWearArmor())
            {
                this.horseChest.setInventorySlotContents(lvt_3_1_, itemStackIn);
                this.updateHorseSlots();
                return true;
            }
            else
        ...
        {
            int lvt_4_1_ = inventorySlot - 500 + 2;

            if (lvt_4_1_ >= 2 && lvt_4_1_ < this.horseChest.getSizeInventory())
            {
                this.horseChest.setInventorySlotContents(lvt_4_1_, itemStackIn);
                return true;
            }
            else
            {
