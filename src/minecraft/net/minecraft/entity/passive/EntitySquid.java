...
public class EntitySquid extends EntityWaterMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.inWater)
        {
            if (this.squidRotation < (float)Math.PI)
            {
                ...
                this.tentacleAngle = MathHelper.sin(lvt_1_1_ * lvt_1_1_ * (float)Math.PI) * (float)Math.PI * 0.25F;
            ...
            this.squidPitch += (-((float)MathHelper.atan2((double)lvt_1_2_, this.motionY)) * 180.0F / (float)Math.PI - this.squidPitch) * 0.1F;
        }
        else
        {
    ...
    static class AIMoveRandom extends EntityAIBase
    {
        ...
        {
            int lvt_1_1_ = this.squid.getAge();
            ...
            {
                float lvt_2_1_ = this.squid.getRNG().nextFloat() * (float)Math.PI * 2.0F;
                ...
                this.squid.func_175568_b(lvt_3_1_, lvt_4_1_, lvt_5_1_);
            }
        }
    }
}
