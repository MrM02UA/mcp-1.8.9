...
public class EntityOcelot extends EntityTameable
{
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        else if (this.aiTempt.isRunning() && lvt_2_1_ != null && lvt_2_1_.getItem() == Items.fish && player.getDistanceSqToEntity(this) < 9.0D)
        {
    ...
    {
        EntityOcelot lvt_2_1_ = new EntityOcelot(this.worldObj);

        if (this.isTamed())
        {
            lvt_2_1_.setOwnerId(this.getOwnerId());
            lvt_2_1_.setTamed(true);
            lvt_2_1_.setTameSkin(this.getTameSkin());
        }
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityOcelot lvt_2_1_ = (EntityOcelot)otherAnimal;
            return !lvt_2_1_.isTamed() ? false : this.isInLove() && lvt_2_1_.isInLove();
        }
    }
    ...
    public boolean isNotColliding()
    {
        if (this.worldObj.checkNoEntityCollision(this.getEntityBoundingBox(), this) && this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && !this.worldObj.isAnyLiquid(this.getEntityBoundingBox()))
        {
            ...
            Block lvt_2_1_ = this.worldObj.getBlockState(lvt_1_1_.down()).getBlock();

            if (lvt_2_1_ == Blocks.grass || lvt_2_1_.getMaterial() == Material.leaves)
            {
                return true;
            }
        }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        if (this.worldObj.rand.nextInt(7) == 0)
        {
            ...
            {
                EntityOcelot lvt_4_1_ = new EntityOcelot(this.worldObj);
