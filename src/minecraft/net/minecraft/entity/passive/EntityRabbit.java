...
public class EntityRabbit extends EntityAnimal
{
    ...
    public void updateAITasks()
    {
        ...
        if (this.onGround)
        {
            ...
            EntityRabbit.RabbitJumpHelper lvt_1_2_ = (EntityRabbit.RabbitJumpHelper)this.jumpHelper;

            if (!lvt_1_2_.getIsJumping())
            {
                if (this.moveHelper.isUpdating() && this.currentMoveTypeDuration == 0)
                {
                    PathEntity lvt_2_1_ = this.navigator.getPath();
                    Vec3 lvt_3_1_ = new Vec3(this.moveHelper.getX(), this.moveHelper.getY(), this.moveHelper.getZ());
    ...
    {
        EntityRabbit lvt_2_1_ = new EntityRabbit(this.worldObj);

        if (ageable instanceof EntityRabbit)
        {
            lvt_2_1_.setRabbitType(this.rand.nextBoolean() ? this.getRabbitType() : ((EntityRabbit)ageable).getRabbitType());
        }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        int lvt_3_1_ = this.rand.nextInt(6);
        boolean lvt_4_1_ = false;

        if (livingdata instanceof EntityRabbit.RabbitTypeData)
        {
            lvt_3_1_ = ((EntityRabbit.RabbitTypeData)livingdata).typeData;
            lvt_4_1_ = true;
        }
        else
        {
            livingdata = new EntityRabbit.RabbitTypeData(lvt_3_1_);
        }
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
    {
        ...
        public void updateTask()
        {
            ...
            {
                World lvt_1_1_ = this.rabbit.worldObj;
                ...
                if (this.field_179499_e && lvt_4_1_ instanceof BlockCarrot && ((Integer)lvt_3_1_.getValue(BlockCarrot.AGE)).intValue() == 7)
                {
        ...
        protected boolean shouldMoveTo(World worldIn, BlockPos pos)
        {
            ...
            if (lvt_3_1_ == Blocks.farmland)
            {
                ...
                if (lvt_3_1_ instanceof BlockCarrot && ((Integer)lvt_4_1_.getValue(BlockCarrot.AGE)).intValue() == 7 && this.field_179498_d && !this.field_179499_e)
                {
