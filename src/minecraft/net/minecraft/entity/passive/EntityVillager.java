...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc
{
    ...
    protected void updateAITasks()
    {
        if (--this.randomTickDivider <= 0)
        {
            ...
            this.worldObj.getVillageCollection().addToVillagerPositionList(lvt_1_1_);
            this.randomTickDivider = 70 + this.rand.nextInt(50);
            this.villageObj = this.worldObj.getVillageCollection().getNearestVillage(lvt_1_1_, 32);
            ...
            {
                BlockPos lvt_2_1_ = this.villageObj.getCenter();
                this.setHomePosAndDistance(lvt_2_1_, (int)((float)this.villageObj.getVillageRadius() * 1.0F));
        ...
        if (!this.isTrading() && this.timeUntilReset > 0)
        {
            ...
            if (this.timeUntilReset <= 0)
            {
                ...
                {
                    for (MerchantRecipe lvt_2_2_ : this.buyingList)
                    {
                        if (lvt_2_2_.isRecipeDisabled())
                        {
                            lvt_2_2_.increaseMaxTradeUses(this.rand.nextInt(6) + this.rand.nextInt(6) + 2);
                        }
                    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        boolean lvt_3_1_ = lvt_2_1_ != null && lvt_2_1_.getItem() == Items.spawn_egg;

        if (!lvt_3_1_ && this.isEntityAlive() && !this.isTrading() && !this.isChild())
        {
    ...
    public void writeEntityToNBT(NBTTagCompound tagCompound)
    {
        ...
        for (int lvt_3_1_ = 0; lvt_3_1_ < this.villagerInventory.getSizeInventory(); ++lvt_3_1_)
        {
            ItemStack lvt_4_1_ = this.villagerInventory.getStackInSlot(lvt_3_1_);

            if (lvt_4_1_ != null)
            {
                lvt_2_1_.appendTag(lvt_4_1_.writeToNBT(new NBTTagCompound()));
            }
        }

        tagCompound.setTag("Inventory", lvt_2_1_);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        {
            NBTTagCompound lvt_2_1_ = tagCompund.getCompoundTag("Offers");
            this.buyingList = new MerchantRecipeList(lvt_2_1_);
        }

        NBTTagList lvt_2_2_ = tagCompund.getTagList("Inventory", 10);

        for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_2_.tagCount(); ++lvt_3_1_)
        {
            ItemStack lvt_4_1_ = ItemStack.loadItemStackFromNBT(lvt_2_2_.getCompoundTagAt(lvt_3_1_));

            if (lvt_4_1_ != null)
            {
                this.villagerInventory.func_174894_a(lvt_4_1_);
            }
        }
    ...
    public void setRevengeTarget(EntityLivingBase livingBase)
    {
        ...
        if (this.villageObj != null && livingBase != null)
        {
            ...
            if (livingBase instanceof EntityPlayer)
            {
                ...
                this.villageObj.setReputationForPlayer(livingBase.getName(), lvt_2_1_);
    ...
    public void onDeath(DamageSource cause)
    {
        if (this.villageObj != null)
        {
            ...
            if (lvt_2_1_ != null)
            {
                ...
                {
                    this.villageObj.setReputationForPlayer(lvt_2_1_.getName(), -2);
                }
            ...
            {
                EntityPlayer lvt_3_1_ = this.worldObj.getClosestPlayerToEntity(this, 16.0D);
    ...
    public boolean getIsWillingToMate(boolean updateFirst)
    {
        if (!this.isWillingToMate && updateFirst && this.func_175553_cp())
        {
            ...
            for (int lvt_3_1_ = 0; lvt_3_1_ < this.villagerInventory.getSizeInventory(); ++lvt_3_1_)
            {
                ...
                if (lvt_4_1_ != null)
                {
                    if (lvt_4_1_.getItem() == Items.bread && lvt_4_1_.stackSize >= 3)
                    {
                        lvt_2_1_ = true;
                        this.villagerInventory.decrStackSize(lvt_3_1_, 3);
                    }
                    else if ((lvt_4_1_.getItem() == Items.potato || lvt_4_1_.getItem() == Items.carrot) && lvt_4_1_.stackSize >= 12)
                    {
                        lvt_2_1_ = true;
                        this.villagerInventory.decrStackSize(lvt_3_1_, 12);
                    }
                }
    ...
    public void useRecipe(MerchantRecipe recipe)
    {
        ...
        {
            this.worldObj.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY + 0.5D, this.posZ, lvt_2_1_));
        }
    }
    ...
    {
        EntityVillager.ITradeList[][][] lvt_1_1_ = DEFAULT_TRADE_LIST_MAP[this.getProfession()];
        ...
        {
            this.careerId = this.rand.nextInt(lvt_1_1_.length) + 1;
            this.careerLevel = 1;
        }
        ...
        int lvt_2_1_ = this.careerId - 1;
        int lvt_3_1_ = this.careerLevel - 1;
        ...
        if (lvt_3_1_ >= 0 && lvt_3_1_ < lvt_4_1_.length)
        {
            ...
            {
                lvt_9_1_.modifyMerchantRecipeList(this.buyingList, this.rand);
            }
        }
    }
    ...
    {
        String lvt_1_1_ = this.getCustomNameTag();

        if (lvt_1_1_ != null && lvt_1_1_.length() > 0)
        {
            ChatComponentText lvt_2_1_ = new ChatComponentText(lvt_1_1_);
            lvt_2_1_.getChatStyle().setChatHoverEvent(this.getHoverEvent());
            lvt_2_1_.getChatStyle().setInsertion(this.getUniqueID().toString());
            return lvt_2_1_;
        }
        else
        {
            ...
            if (lvt_2_2_ != null)
            {
                ...
                lvt_3_1_.getChatStyle().setChatHoverEvent(this.getHoverEvent());
                lvt_3_1_.getChatStyle().setInsertion(this.getUniqueID().toString());
                return lvt_3_1_;
            }
            else
            {
    ...
    private void spawnParticles(EnumParticleTypes particleType)
    {
        for (int lvt_2_1_ = 0; lvt_2_1_ < 5; ++lvt_2_1_)
        {
            ...
            this.worldObj.spawnParticle(particleType, this.posX + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, this.posY + 1.0D + (double)(this.rand.nextFloat() * this.height), this.posZ + (double)(this.rand.nextFloat() * this.width * 2.0F) - (double)this.width, lvt_3_1_, lvt_5_1_, lvt_7_1_, new int[0]);
        }
    }
    ...
    {
        EntityVillager lvt_2_1_ = new EntityVillager(this.worldObj);
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt)
    {
        ...
        {
            EntityWitch lvt_2_1_ = new EntityWitch(this.worldObj);
    ...
    protected void updateEquipmentIfNeeded(EntityItem itemEntity)
    {
        ...
        if (this.canVillagerPickupItem(lvt_3_1_))
        {
            ItemStack lvt_4_1_ = this.villagerInventory.func_174894_a(lvt_2_1_);
            ...
            {
                lvt_2_1_.stackSize = lvt_4_1_.stackSize;
            }
        }
    }
    ...
    {
        boolean lvt_1_1_ = this.getProfession() == 0;
        return lvt_1_1_ ? !this.hasEnoughItems(5) : !this.hasEnoughItems(1);
    }
    ...
    {
        boolean lvt_2_1_ = this.getProfession() == 0;
        ...
        for (int lvt_3_1_ = 0; lvt_3_1_ < this.villagerInventory.getSizeInventory(); ++lvt_3_1_)
        {
            ...
            if (lvt_4_1_ != null)
            {
                if (lvt_4_1_.getItem() == Items.bread && lvt_4_1_.stackSize >= 3 * multiplier || lvt_4_1_.getItem() == Items.potato && lvt_4_1_.stackSize >= 12 * multiplier || lvt_4_1_.getItem() == Items.carrot && lvt_4_1_.stackSize >= 12 * multiplier)
                {
                    return true;
                }

                if (lvt_2_1_ && lvt_4_1_.getItem() == Items.wheat && lvt_4_1_.stackSize >= 9 * multiplier)
                {
                    return true;
                }
            }
    ...
    {
        for (int lvt_1_1_ = 0; lvt_1_1_ < this.villagerInventory.getSizeInventory(); ++lvt_1_1_)
        {
            ItemStack lvt_2_1_ = this.villagerInventory.getStackInSlot(lvt_1_1_);

            if (lvt_2_1_ != null && (lvt_2_1_.getItem() == Items.wheat_seeds || lvt_2_1_.getItem() == Items.potato || lvt_2_1_.getItem() == Items.carrot))
            {
                return true;
            }
        }
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn)
    {
        ...
        {
            int lvt_3_1_ = inventorySlot - 300;

            if (lvt_3_1_ >= 0 && lvt_3_1_ < this.villagerInventory.getSizeInventory())
            {
                this.villagerInventory.setInventorySlotContents(lvt_3_1_, itemStackIn);
                return true;
            }
            else
            {
    ...
    static class EmeraldForItems implements EntityVillager.ITradeList
    {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random)
        {
            ...
            if (this.price != null)
            {
                lvt_3_1_ = this.price.getPrice(random);
            }

            recipeList.add(new MerchantRecipe(new ItemStack(this.sellItem, lvt_3_1_, 0), Items.emerald));
        }
    }
    ...
    static class ItemAndEmeraldToItem implements EntityVillager.ITradeList
    {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random)
        {
            ...
            {
                lvt_3_1_ = this.buyingPriceInfo.getPrice(random);
            }
            ...
            {
                lvt_4_1_ = this.field_179408_d.getPrice(random);
            }

            recipeList.add(new MerchantRecipe(new ItemStack(this.buyingItemStack.getItem(), lvt_3_1_, this.buyingItemStack.getMetadata()), new ItemStack(Items.emerald), new ItemStack(this.sellingItemstack.getItem(), lvt_4_1_, this.sellingItemstack.getMetadata())));
        }
    }
    ...
    static class ListEnchantedBookForEmeralds implements EntityVillager.ITradeList
    {
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random)
        {
            Enchantment lvt_3_1_ = Enchantment.enchantmentsBookList[random.nextInt(Enchantment.enchantmentsBookList.length)];
            int lvt_4_1_ = MathHelper.getRandomIntegerInRange(random, lvt_3_1_.getMinLevel(), lvt_3_1_.getMaxLevel());
            ItemStack lvt_5_1_ = Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(lvt_3_1_, lvt_4_1_));
            int lvt_6_1_ = 2 + random.nextInt(5 + lvt_4_1_ * 10) + 3 * lvt_4_1_;
            ...
            recipeList.add(new MerchantRecipe(new ItemStack(Items.book), new ItemStack(Items.emerald, lvt_6_1_), lvt_5_1_));
        }
    }
    ...
    static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList
    {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random)
        {
            ...
            {
                lvt_3_1_ = this.priceInfo.getPrice(random);
            }

            ItemStack lvt_4_1_ = new ItemStack(Items.emerald, lvt_3_1_, 0);
            ItemStack lvt_5_1_ = new ItemStack(this.enchantedItemStack.getItem(), 1, this.enchantedItemStack.getMetadata());
            lvt_5_1_ = EnchantmentHelper.addRandomEnchantment(random, lvt_5_1_, 5 + random.nextInt(15));
            recipeList.add(new MerchantRecipe(lvt_4_1_, lvt_5_1_));
        }
    }
    ...
    static class ListItemForEmeralds implements EntityVillager.ITradeList
    {
        ...
        public void modifyMerchantRecipeList(MerchantRecipeList recipeList, Random random)
        {
            ...
            if (lvt_3_1_ < 0)
            {
                lvt_4_1_ = new ItemStack(Items.emerald, 1, 0);
                lvt_5_1_ = new ItemStack(this.itemToBuy.getItem(), -lvt_3_1_, this.itemToBuy.getMetadata());
            }
            else
            {
                lvt_4_1_ = new ItemStack(Items.emerald, lvt_3_1_, 0);
                lvt_5_1_ = new ItemStack(this.itemToBuy.getItem(), 1, this.itemToBuy.getMetadata());
            }
