...
public class EntityPig extends EntityAnimal
{
    ...
    {
        ItemStack lvt_1_1_ = ((EntityPlayer)this.riddenByEntity).getHeldItem();
        return lvt_1_1_ != null && lvt_1_1_.getItem() == Items.carrot_on_a_stick;
    }
    ...
    {
        int lvt_3_1_ = this.rand.nextInt(3) + 1 + this.rand.nextInt(1 + lootingModifier);
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt)
    {
        ...
        {
            EntityPigZombie lvt_2_1_ = new EntityPigZombie(this.worldObj);
            lvt_2_1_.setCurrentItemOrArmor(0, new ItemStack(Items.golden_sword));
