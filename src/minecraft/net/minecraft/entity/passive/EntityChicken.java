...
public class EntityChicken extends EntityAnimal
{
    ...
    {
        int lvt_3_1_ = this.rand.nextInt(3) + this.rand.nextInt(1 + lootingModifier);
    ...
    public void updateRiderPosition()
    {
        ...
        float lvt_3_1_ = 0.1F;
        float lvt_4_1_ = 0.0F;
        this.riddenByEntity.setPosition(this.posX + (double)(lvt_3_1_ * lvt_1_1_), this.posY + (double)(this.height * 0.5F) + this.riddenByEntity.getYOffset() + (double)lvt_4_1_, this.posZ - (double)(lvt_3_1_ * lvt_2_1_));
