...
public class EntityAIVillagerMate extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                Entity lvt_1_1_ = this.worldObj.findNearestEntityWithinAABB(EntityVillager.class, this.villagerObj.getEntityBoundingBox().expand(8.0D, 3.0D, 8.0D), this.villagerObj);
                ...
                {
                    this.mate = (EntityVillager)lvt_1_1_;
    ...
    private boolean checkSufficientDoorsPresentForNewVillager()
    {
        ...
        {
            int lvt_1_1_ = (int)((double)((float)this.villageObj.getNumVillageDoors()) * 0.35D);
            return this.villageObj.getNumVillagers() < lvt_1_1_;
        }
    }

    private void giveBirth()
    {
        EntityVillager lvt_1_1_ = this.villagerObj.createChild(this.mate);
        this.mate.setGrowingAge(6000);
        this.villagerObj.setGrowingAge(6000);
        this.mate.setIsWillingToMate(false);
        this.villagerObj.setIsWillingToMate(false);
        lvt_1_1_.setGrowingAge(-24000);
        lvt_1_1_.setLocationAndAngles(this.villagerObj.posX, this.villagerObj.posY, this.villagerObj.posZ, 0.0F, 0.0F);
        this.worldObj.spawnEntityInWorld(lvt_1_1_);
        this.worldObj.setEntityState(lvt_1_1_, (byte)12);
    }
}
