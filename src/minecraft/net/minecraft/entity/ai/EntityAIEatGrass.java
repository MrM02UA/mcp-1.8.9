...
public class EntityAIEatGrass extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            return field_179505_b.apply(this.entityWorld.getBlockState(lvt_1_1_)) ? true : this.entityWorld.getBlockState(lvt_1_1_.down()).getBlock() == Blocks.grass;
        }
    }
    ...
    public void updateTask()
    {
        ...
        if (this.eatingGrassTimer == 4)
        {
            ...
            if (field_179505_b.apply(this.entityWorld.getBlockState(lvt_1_1_)))
            {
            ...
            else
            {
                ...
                if (this.entityWorld.getBlockState(lvt_2_1_).getBlock() == Blocks.grass)
                {
                    if (this.entityWorld.getGameRules().getBoolean("mobGriefing"))
                    {
                        this.entityWorld.playAuxSFX(2001, lvt_2_1_, Block.getIdFromBlock(Blocks.grass));
