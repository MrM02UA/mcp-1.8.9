...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean continueExecuting()
    {
        ...
        if (this.breakingTime <= 240)
        {
            ...
            if (!BlockDoor.isOpen(this.theEntity.worldObj, this.doorPosition) && lvt_1_1_ < 4.0D)
            {
                var3 = true;
                return var3;
            }
    ...
    public void updateTask()
    {
        ...
        {
            this.theEntity.worldObj.sendBlockBreakProgress(this.theEntity.getEntityId(), this.doorPosition, lvt_1_1_);
