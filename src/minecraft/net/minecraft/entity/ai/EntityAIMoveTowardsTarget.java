...
public class EntityAIMoveTowardsTarget extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3 lvt_1_1_ = RandomPositionGenerator.findRandomTargetBlockTowards(this.theEntity, 16, 7, new Vec3(this.targetEntity.posX, this.targetEntity.posY, this.targetEntity.posZ));
            ...
            {
                this.movePosX = lvt_1_1_.xCoord;
                this.movePosY = lvt_1_1_.yCoord;
                this.movePosZ = lvt_1_1_.zCoord;
                return true;
            }
        }
    }
