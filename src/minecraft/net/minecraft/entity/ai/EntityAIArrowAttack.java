...
public class EntityAIArrowAttack extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        if (lvt_1_1_ <= (double)this.maxAttackDistance && this.field_75318_f >= 20)
        {
        ...
        {
            if (lvt_1_1_ > (double)this.maxAttackDistance || !lvt_3_1_)
            {
                return;
            }

            float lvt_4_1_ = MathHelper.sqrt_double(lvt_1_1_) / this.field_96562_i;
            float lvt_5_1_ = MathHelper.clamp_float(lvt_4_1_, 0.1F, 1.0F);
            this.rangedAttackEntityHost.attackEntityWithRangedAttack(this.attackTarget, lvt_5_1_);
            this.rangedAttackTime = MathHelper.floor_float(lvt_4_1_ * (float)(this.maxRangedAttackTime - this.field_96561_g) + (float)this.field_96561_g);
        }
        else if (this.rangedAttackTime < 0)
        {
            float lvt_4_2_ = MathHelper.sqrt_double(lvt_1_1_) / this.field_96562_i;
            this.rangedAttackTime = MathHelper.floor_float(lvt_4_2_ * (float)(this.maxRangedAttackTime - this.field_96561_g) + (float)this.field_96561_g);
        }
    }
}
