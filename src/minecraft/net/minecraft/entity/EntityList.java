...
public class EntityList
{
    ...
    public static Entity createEntityByName(String entityName, World worldIn)
    {
        ...
        try
        {
            Class <? extends Entity > lvt_3_1_ = (Class)stringToClassMapping.get(entityName);

            if (lvt_3_1_ != null)
            {
                lvt_2_1_ = (Entity)lvt_3_1_.getConstructor(new Class[] {World.class}).newInstance(new Object[] {worldIn});
            }
        }
    ...
    public static Entity createEntityFromNBT(NBTTagCompound nbt, World worldIn)
    {
        ...
        try
        {
            Class <? extends Entity > lvt_3_1_ = (Class)stringToClassMapping.get(nbt.getString("id"));
    ...
    public static Entity createEntityByID(int entityID, World worldIn)
    {
        ...
        try
        {
            Class <? extends Entity > lvt_3_1_ = getClassFromID(entityID);
    ...
    {
        Integer lvt_1_1_ = (Integer)classToIDMapping.get(entityIn.getClass());
        return lvt_1_1_ == null ? 0 : lvt_1_1_.intValue();
    }
    ...
    {
        Integer lvt_1_1_ = (Integer)stringToIDMapping.get(entityName);
        return lvt_1_1_ == null ? 90 : lvt_1_1_.intValue();
    }
    ...
    {
        Set<String> lvt_0_1_ = stringToClassMapping.keySet();
        List<String> lvt_1_1_ = Lists.newArrayList();

        for (String lvt_3_1_ : lvt_0_1_)
        {
            Class <? extends Entity > lvt_4_1_ = (Class)stringToClassMapping.get(lvt_3_1_);
    ...
    {
        String lvt_2_1_ = getEntityString(entityIn);

        if (lvt_2_1_ == null && entityIn instanceof EntityPlayer)
        {
            lvt_2_1_ = "Player";
        }
        else if (lvt_2_1_ == null && entityIn instanceof EntityLightningBolt)
        {
            lvt_2_1_ = "LightningBolt";
        }

        return entityName.equals(lvt_2_1_);
    }
