...
public class EntitySlime extends EntityLiving implements IMob
{
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        int lvt_2_1_ = tagCompund.getInteger("Size");
    ...
    public void onUpdate()
    {
        ...
        {
            int lvt_1_1_ = this.getSlimeSize();

            for (int lvt_2_1_ = 0; lvt_2_1_ < lvt_1_1_ * 8; ++lvt_2_1_)
            {
                float lvt_3_1_ = this.rand.nextFloat() * (float)Math.PI * 2.0F;
                float lvt_4_1_ = this.rand.nextFloat() * 0.5F + 0.5F;
                float lvt_5_1_ = MathHelper.sin(lvt_3_1_) * (float)lvt_1_1_ * 0.5F * lvt_4_1_;
                float lvt_6_1_ = MathHelper.cos(lvt_3_1_) * (float)lvt_1_1_ * 0.5F * lvt_4_1_;
                World var10000 = this.worldObj;
                EnumParticleTypes var10001 = this.getParticleType();
                double var10002 = this.posX + (double)lvt_5_1_;
                double var10004 = this.posZ + (double)lvt_6_1_;
    ...
    public void onDataWatcherUpdate(int dataID)
    {
        if (dataID == 16)
        {
            int lvt_2_1_ = this.getSlimeSize();
            this.setSize(0.51000005F * (float)lvt_2_1_, 0.51000005F * (float)lvt_2_1_);
    ...
    public void setDead()
    {
        ...
        if (!this.worldObj.isRemote && lvt_1_1_ > 1 && this.getHealth() <= 0.0F)
        {
            int lvt_2_1_ = 2 + this.rand.nextInt(3);
            ...
            for (int lvt_3_1_ = 0; lvt_3_1_ < lvt_2_1_; ++lvt_3_1_)
            {
                ...
                EntitySlime lvt_6_1_ = this.createInstance();

                if (this.hasCustomName())
                {
                    lvt_6_1_.setCustomNameTag(this.getCustomNameTag());
                }
                ...
                lvt_6_1_.setSlimeSize(lvt_1_1_ / 2);
                lvt_6_1_.setLocationAndAngles(this.posX + (double)lvt_4_1_, this.posY + 0.5D, this.posZ + (double)lvt_5_1_, this.rand.nextFloat() * 360.0F, 0.0F);
                this.worldObj.spawnEntityInWorld(lvt_6_1_);
            }
        }
    ...
    protected void func_175451_e(EntityLivingBase p_175451_1_)
    {
        ...
        if (this.canEntityBeSeen(p_175451_1_) && this.getDistanceSqToEntity(p_175451_1_) < 0.6D * (double)lvt_2_1_ * 0.6D * (double)lvt_2_1_ && p_175451_1_.attackEntityFrom(DamageSource.causeMobDamage(this), (float)this.getAttackStrength()))
        {
    ...
    {
        BlockPos lvt_1_1_ = new BlockPos(MathHelper.floor_double(this.posX), 0, MathHelper.floor_double(this.posZ));
        Chunk lvt_2_1_ = this.worldObj.getChunkFromBlockCoords(lvt_1_1_);
        ...
        else
        {
            ...
            {
                BiomeGenBase lvt_3_1_ = this.worldObj.getBiomeGenForCoords(lvt_1_1_);

                if (lvt_3_1_ == BiomeGenBase.swampland && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand.nextFloat() < this.worldObj.getCurrentMoonPhaseFactor() && this.worldObj.getLightFromNeighbors(new BlockPos(this)) <= this.rand.nextInt(8))
                {
                    return super.getCanSpawnHere();
                }

                if (this.rand.nextInt(10) == 0 && lvt_2_1_.getRandomWithSeed(987234911L).nextInt(10) == 0 && this.posY < 40.0D)
                {
                    return super.getCanSpawnHere();
                }
            }
    ...
    {
        int lvt_3_1_ = this.rand.nextInt(3);

        if (lvt_3_1_ < 2 && this.rand.nextFloat() < 0.5F * difficulty.getClampedAdditionalDifficulty())
        {
            ++lvt_3_1_;
        }

        int lvt_4_1_ = 1 << lvt_3_1_;
        this.setSlimeSize(lvt_4_1_);
    ...
    static class AISlimeAttack extends EntityAIBase
    {
        ...
        {
            EntityLivingBase lvt_1_1_ = this.slime.getAttackTarget();
            return lvt_1_1_ == null ? false : (!lvt_1_1_.isEntityAlive() ? false : !(lvt_1_1_ instanceof EntityPlayer) || !((EntityPlayer)lvt_1_1_).capabilities.disableDamage);
        }
        ...
        {
            EntityLivingBase lvt_1_1_ = this.slime.getAttackTarget();
            return lvt_1_1_ == null ? false : (!lvt_1_1_.isEntityAlive() ? false : (lvt_1_1_ instanceof EntityPlayer && ((EntityPlayer)lvt_1_1_).capabilities.disableDamage ? false : --this.field_179465_b > 0));
        }
