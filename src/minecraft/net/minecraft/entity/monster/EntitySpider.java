...
public class EntitySpider extends EntityMob
{
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        {
            EntitySkeleton lvt_3_1_ = new EntitySkeleton(this.worldObj);
            lvt_3_1_.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, 0.0F);
            lvt_3_1_.onInitialSpawn(difficulty, (IEntityLivingData)null);
            this.worldObj.spawnEntityInWorld(lvt_3_1_);
            lvt_3_1_.mountEntity(this);
        }
        ...
        {
            int lvt_3_2_ = ((EntitySpider.GroupData)livingdata).potionEffectId;

            if (lvt_3_2_ > 0 && Potion.potionTypes[lvt_3_2_] != null)
            {
    ...
    static class AISpiderTarget<T extends EntityLivingBase> extends EntityAINearestAttackableTarget
    {
        ...
        public boolean shouldExecute()
        {
            ...
            return lvt_1_1_ >= 0.5F ? false : super.shouldExecute();
        }
    }
