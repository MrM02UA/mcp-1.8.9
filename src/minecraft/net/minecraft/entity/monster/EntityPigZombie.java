...
public class EntityPigZombie extends EntityZombie
{
    ...
    protected void updateAITasks()
    {
        ...
        {
            EntityPlayer lvt_2_1_ = this.worldObj.getPlayerEntityByUUID(this.angerTargetUUID);
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        String lvt_2_1_ = tagCompund.getString("HurtBy");

        if (lvt_2_1_.length() > 0)
        {
            this.angerTargetUUID = UUID.fromString(lvt_2_1_);
            EntityPlayer lvt_3_1_ = this.worldObj.getPlayerEntityByUUID(this.angerTargetUUID);
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier)
    {
        ...
        lvt_3_1_ = this.rand.nextInt(2 + lootingModifier);
