...
public class EntityLargeFireball extends EntityFireball
{
    ...
    protected void onImpact(MovingObjectPosition movingObject)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            boolean lvt_2_1_ = this.worldObj.getGameRules().getBoolean("mobGriefing");
            this.worldObj.newExplosion((Entity)null, this.posX, this.posY, this.posZ, (float)this.explosionPower, lvt_2_1_, lvt_2_1_);
            this.setDead();
        }
    }
