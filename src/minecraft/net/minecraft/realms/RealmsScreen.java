...
public class RealmsScreen
{
    ...
    {
        ResourceLocation lvt_2_1_ = AbstractClientPlayer.getLocationSkin(p_bindFace_1_);

        if (lvt_2_1_ == null)
        {
            lvt_2_1_ = DefaultPlayerSkin.getDefaultSkin(UUIDTypeAdapter.fromString(p_bindFace_0_));
        }

        AbstractClientPlayer.getDownloadImageSkin(lvt_2_1_, p_bindFace_1_);
        Minecraft.getMinecraft().getTextureManager().bindTexture(lvt_2_1_);
    }

    public static void bind(String p_bind_0_)
    {
        ResourceLocation lvt_1_1_ = new ResourceLocation(p_bind_0_);
        Minecraft.getMinecraft().getTextureManager().bindTexture(lvt_1_1_);
    }
