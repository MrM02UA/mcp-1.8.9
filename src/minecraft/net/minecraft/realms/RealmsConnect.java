        ...
        (new Thread("Realms-connect-task")
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    RealmsConnect.this.connection = NetworkManager.createNetworkManagerAndConnect(lvt_1_1_, p_connect_2_, Minecraft.getMinecraft().gameSettings.isUsingNativeTransport());
