...
public class Realms
{
    ...
    {
        Session lvt_0_1_ = Minecraft.getMinecraft().getSession();
    ...
    {
        ListenableFuture<Object> lvt_2_1_ = Minecraft.getMinecraft().getResourcePackRepository().downloadResourcePack(p_downloadResourcePack_0_, p_downloadResourcePack_1_);
        return lvt_2_1_;
    }
