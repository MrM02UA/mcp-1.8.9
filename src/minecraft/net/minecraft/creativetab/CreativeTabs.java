...
public abstract class CreativeTabs
{
    ...
    public boolean hasRelevantEnchantmentType(EnumEnchantmentType enchantmentType)
    {
        ...
        {
            for (EnumEnchantmentType lvt_5_1_ : this.enchantmentTypes)
            {
                if (lvt_5_1_ == enchantmentType)
                {
                    return true;
                }
            }
    ...
    public void displayAllReleventItems(List<ItemStack> p_78018_1_)
    {
        ...
        {
            if (lvt_3_1_ != null && lvt_3_1_.getCreativeTab() == this)
            {
                lvt_3_1_.getSubItems(lvt_3_1_, this, p_78018_1_);
            }
        }
    ...
    {
        for (Enchantment lvt_6_1_ : Enchantment.enchantmentsBookList)
        {
            if (lvt_6_1_ != null && lvt_6_1_.type != null)
            {
                boolean lvt_7_1_ = false;

                for (int lvt_8_1_ = 0; lvt_8_1_ < enchantmentType.length && !lvt_7_1_; ++lvt_8_1_)
                {
                    if (lvt_6_1_.type == enchantmentType[lvt_8_1_])
                    {
                        lvt_7_1_ = true;
                    }
                }
                ...
                if (lvt_7_1_)
                {
                    itemList.add(Items.enchanted_book.getEnchantedItemStack(new EnchantmentData(lvt_6_1_, lvt_6_1_.getMaxLevel())));
                }
            }
        }
    }
