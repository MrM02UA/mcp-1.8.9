...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> lvt_11_1_ = lvt_1_1_.accepts("username").withRequiredArg().defaultsTo("Player" + Minecraft.getSystemTime() % 1000L, new String[0]);
        ...
        if (!lvt_25_1_.equals(Proxy.NO_PROXY) && isNullOrEmpty(lvt_26_1_) && isNullOrEmpty(lvt_27_1_))
        {
