        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    lvt_1_1_ = InetAddress.getByName(ip);
                    GuiConnecting.this.networkManager = NetworkManager.createNetworkManagerAndConnect(lvt_1_1_, port, GuiConnecting.this.mc.gameSettings.isUsingNativeTransport());
                ...
                catch (Exception var6)
                {
                    ...
                    if (lvt_1_1_ != null)
                    {
                        String lvt_4_1_ = lvt_1_1_.toString() + ":" + port;
                        lvt_3_1_ = lvt_3_1_.replaceAll(lvt_4_1_, "");
                    }

                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {lvt_3_1_})));
                }
            }
        }).start();
    }
