...
public class ChunkProviderClient implements IChunkProvider
{
    ...
    {
        Chunk lvt_3_1_ = this.provideChunk(x, z);
        ...
        this.chunkListing.remove(lvt_3_1_);
    }
    ...
    {
        Chunk lvt_3_1_ = new Chunk(this.worldObj, chunkX, chunkZ);
        this.chunkMapping.add(ChunkCoordIntPair.chunkXZ2Int(chunkX, chunkZ), lvt_3_1_);
        this.chunkListing.add(lvt_3_1_);
        lvt_3_1_.setChunkLoaded(true);
        return lvt_3_1_;
    }
    ...
    {
        Chunk lvt_3_1_ = (Chunk)this.chunkMapping.getValueByKey(ChunkCoordIntPair.chunkXZ2Int(x, z));
        return lvt_3_1_ == null ? this.blankChunk : lvt_3_1_;
    }
    ...
    public boolean unloadQueuedChunks()
    {
        ...
        for (Chunk lvt_4_1_ : this.chunkListing)
        {
        ...
        {
            logger.info("Warning: Clientside chunk ticking took {} ms", new Object[] {Long.valueOf(System.currentTimeMillis() - lvt_1_1_)});
        }
