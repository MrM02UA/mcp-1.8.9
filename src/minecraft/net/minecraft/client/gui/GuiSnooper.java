...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        boolean lvt_3_2_ = this.mc.getIntegratedServer() != null && this.mc.getIntegratedServer().getPlayerUsageSnooper() != null;

        for (Entry<String, String> lvt_5_1_ : (new TreeMap(this.mc.getPlayerUsageSnooper().getCurrentStats())).entrySet())
        {
            this.field_146604_g.add((lvt_3_2_ ? "C " : "") + (String)lvt_5_1_.getKey());
            this.field_146609_h.add(this.fontRendererObj.trimStringToWidth((String)lvt_5_1_.getValue(), this.width - 220));
        }

        if (lvt_3_2_)
        {
            for (Entry<String, String> lvt_5_2_ : (new TreeMap(this.mc.getIntegratedServer().getPlayerUsageSnooper().getCurrentStats())).entrySet())
            {
                this.field_146604_g.add("S " + (String)lvt_5_2_.getKey());
                this.field_146609_h.add(this.fontRendererObj.trimStringToWidth((String)lvt_5_2_.getValue(), this.width - 220));
            }
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        {
            this.drawCenteredString(this.fontRendererObj, lvt_8_1_, this.width / 2, lvt_4_1_, 8421504);
