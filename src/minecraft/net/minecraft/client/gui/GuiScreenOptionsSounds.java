...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiScreenOptionsSounds.Button(SoundCategory.MASTER.getCategoryId(), this.width / 2 - 155 + lvt_1_1_ % 2 * 160, this.height / 6 - 12 + 24 * (lvt_1_1_ >> 1), SoundCategory.MASTER, true));
        lvt_1_1_ = lvt_1_1_ + 2;
        ...
        for (SoundCategory lvt_5_1_ : SoundCategory.values())
        {
            ...
            {
                this.buttonList.add(new GuiScreenOptionsSounds.Button(lvt_5_1_.getCategoryId(), this.width / 2 - 155 + lvt_1_1_ % 2 * 160, this.height / 6 - 12 + 24 * (lvt_1_1_ >> 1), lvt_5_1_, false));
                ++lvt_1_1_;
            }
        }
    ...
    {
        float lvt_2_1_ = this.game_settings_4.getSoundLevel(p_146504_1_);
