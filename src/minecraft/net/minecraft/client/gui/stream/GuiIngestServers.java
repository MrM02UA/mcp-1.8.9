...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        {
            IngestServer lvt_7_1_ = this.mc.getTwitchStream().func_152925_v()[entryID];
            ...
            IngestServerTester lvt_11_1_ = this.mc.getTwitchStream().func_152932_y();
            ...
            if (lvt_11_1_ != null)
            {
                ...
                else if (entryID < lvt_11_1_.func_153028_p())
                {
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, lvt_7_1_.serverName, p_180791_2_ + 2, p_180791_3_ + 5, 16777215);
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, lvt_8_1_, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT + 5 + 3, 3158064);
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, lvt_9_1_, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(lvt_9_1_), p_180791_3_ + 5, 8421504);

            if (lvt_10_1_ != null)
            {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, lvt_10_1_, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(lvt_10_1_), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
