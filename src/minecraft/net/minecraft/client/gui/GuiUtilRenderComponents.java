...
public class GuiUtilRenderComponents
{
    ...
    public static List<IChatComponent> splitText(IChatComponent p_178908_0_, int p_178908_1_, FontRenderer p_178908_2_, boolean p_178908_3_, boolean p_178908_4_)
    {
        ...
        for (int lvt_9_1_ = 0; lvt_9_1_ < ((List)lvt_8_1_).size(); ++lvt_9_1_)
        {
            ...
            String lvt_11_1_ = lvt_10_1_.getUnformattedTextForChat();
            ...
            if (lvt_11_1_.contains("\n"))
            {
                ...
                lvt_15_1_.setChatStyle(lvt_10_1_.getChatStyle().createShallowCopy());
                lvt_8_1_.add(lvt_9_1_ + 1, lvt_15_1_);
                lvt_12_1_ = true;
            }

            String lvt_13_2_ = func_178909_a(lvt_10_1_.getChatStyle().getFormattingCode() + lvt_11_1_, p_178908_4_);
            String lvt_14_2_ = lvt_13_2_.endsWith("\n") ? lvt_13_2_.substring(0, lvt_13_2_.length() - 1) : lvt_13_2_;
            int lvt_15_2_ = p_178908_2_.getStringWidth(lvt_14_2_);
            ChatComponentText lvt_16_1_ = new ChatComponentText(lvt_14_2_);
            lvt_16_1_.setChatStyle(lvt_10_1_.getChatStyle().createShallowCopy());

            if (lvt_5_1_ + lvt_15_2_ > p_178908_1_)
            {
                String lvt_17_1_ = p_178908_2_.trimStringToWidth(lvt_13_2_, p_178908_1_ - lvt_5_1_, false);
                ...
                if (lvt_18_1_ != null && lvt_18_1_.length() > 0)
                {
                    ...
                    if (lvt_19_1_ >= 0 && p_178908_2_.getStringWidth(lvt_13_2_.substring(0, lvt_19_1_)) > 0)
                    {
                    ...
                    lvt_20_1_.setChatStyle(lvt_10_1_.getChatStyle().createShallowCopy());
                    lvt_8_1_.add(lvt_9_1_ + 1, lvt_20_1_);
                }

                lvt_15_2_ = p_178908_2_.getStringWidth(lvt_17_1_);
            ...
            {
                lvt_5_1_ += lvt_15_2_;
                lvt_6_1_.appendSibling(lvt_16_1_);
            }
            else
            {
                lvt_12_1_ = true;
