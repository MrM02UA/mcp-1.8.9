...
public class GuiEditSign extends GuiScreen
{
    ...
    public void onGuiClosed()
    {
        ...
        NetHandlerPlayClient lvt_1_1_ = this.mc.getNetHandler();

        if (lvt_1_1_ != null)
        {
            lvt_1_1_.addToSendQueue(new C12PacketUpdateSign(this.tileSign.getPos(), this.tileSign.signText));
        }
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        if (keyCode == 14 && lvt_3_1_.length() > 0)
        {
            lvt_3_1_ = lvt_3_1_.substring(0, lvt_3_1_.length() - 1);
        }

        if (ChatAllowedCharacters.isAllowedCharacter(typedChar) && this.fontRendererObj.getStringWidth(lvt_3_1_ + typedChar) <= 90)
        {
            lvt_3_1_ = lvt_3_1_ + typedChar;
        }

        this.tileSign.signText[this.editLine] = new ChatComponentText(lvt_3_1_);
