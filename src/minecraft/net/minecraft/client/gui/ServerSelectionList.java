...
public class ServerSelectionList extends GuiListExtended
{
    ...
    public void func_148195_a(ServerList p_148195_1_)
    {
        ...
        for (int lvt_2_1_ = 0; lvt_2_1_ < p_148195_1_.countServers(); ++lvt_2_1_)
        {
            this.serverListInternet.add(new ServerListEntryNormal(this.owner, p_148195_1_.getServerData(lvt_2_1_)));
        }
    }
    ...
    public void func_148194_a(List<LanServerDetector.LanServer> p_148194_1_)
    {
        ...
        for (LanServerDetector.LanServer lvt_3_1_ : p_148194_1_)
        {
