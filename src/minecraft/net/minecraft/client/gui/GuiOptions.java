...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Super Secret Settings...")
        {
            ...
            {
                SoundEventAccessorComposite lvt_2_1_ = soundHandlerIn.getRandomSoundFromCategories(new SoundCategory[] {SoundCategory.ANIMALS, SoundCategory.BLOCKS, SoundCategory.MOBS, SoundCategory.PLAYERS, SoundCategory.WEATHER});

                if (lvt_2_1_ != null)
                {
                    soundHandlerIn.playSound(PositionedSoundRecord.create(lvt_2_1_.getSoundEventLocation(), 0.5F));
                }
            }
        });
