...
public class GuiRenameWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        WorldInfo lvt_2_1_ = lvt_1_1_.getWorldInfo(this.saveName);
        String lvt_3_1_ = lvt_2_1_.getWorldName();
        ...
        this.field_146583_f.setText(lvt_3_1_);
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 0)
            {
                ...
                lvt_2_1_.renameWorld(this.saveName, this.field_146583_f.getText().trim());
                this.mc.displayGuiScreen(this.parentScreen);
            }
        }
    }
