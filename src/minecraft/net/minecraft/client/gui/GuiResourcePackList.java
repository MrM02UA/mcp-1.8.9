...
public abstract class GuiResourcePackList extends GuiListExtended
{
    ...
    {
        String lvt_4_1_ = EnumChatFormatting.UNDERLINE + "" + EnumChatFormatting.BOLD + this.getListHeader();
        this.mc.fontRendererObj.drawString(lvt_4_1_, p_148129_1_ + this.width / 2 - this.mc.fontRendererObj.getStringWidth(lvt_4_1_) / 2, Math.min(this.top + 3, p_148129_2_), 16777215);
    }
