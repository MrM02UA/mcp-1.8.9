...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    private void func_178069_s()
    {
        for (GuiPageButtonList.GuiListEntry[] lvt_4_1_ : this.field_178078_x)
        {
            for (int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_.length; lvt_5_1_ += 2)
            {
                ...
                {
                    this.field_178073_v.addKey(lvt_6_1_.func_178935_b(), lvt_8_1_);
                ...
                {
                    this.field_178073_v.addKey(lvt_7_1_.func_178935_b(), lvt_9_1_);
    ...
    private void func_178055_t()
    {
        ...
        for (int lvt_1_1_ = 0; lvt_1_1_ < this.field_178078_x[this.field_178077_y].length; lvt_1_1_ += 2)
        {
            ...
            Gui lvt_4_1_ = (Gui)this.field_178073_v.lookup(lvt_2_1_.func_178935_b());
            Gui lvt_5_1_ = lvt_3_1_ != null ? (Gui)this.field_178073_v.lookup(lvt_3_1_.func_178935_b()) : null;
    ...
    private void func_178060_e(int p_178060_1_, int p_178060_2_)
    {
        for (GuiPageButtonList.GuiListEntry lvt_6_1_ : this.field_178078_x[p_178060_1_])
        {
            if (lvt_6_1_ != null)
            {
                this.func_178066_a((Gui)this.field_178073_v.lookup(lvt_6_1_.func_178935_b()), false);
            }
        }
        ...
        for (GuiPageButtonList.GuiListEntry lvt_6_2_ : this.field_178078_x[p_178060_2_])
        {
            if (lvt_6_2_ != null)
            {
                this.func_178066_a((Gui)this.field_178073_v.lookup(lvt_6_2_.func_178935_b()), true);
            }
        }
    }
    ...
    public void func_181155_a(boolean p_181155_1_)
    {
        for (GuiPageButtonList.GuiEntry lvt_3_1_ : this.field_178074_u)
        {
            ...
            {
                ((GuiButton)lvt_3_1_.field_178029_b).enabled = p_181155_1_;
            }

            if (lvt_3_1_.field_178030_c instanceof GuiButton)
            {
                ((GuiButton)lvt_3_1_.field_178030_c).enabled = p_181155_1_;
            }
        }
    }
    ...
    {
        boolean lvt_4_1_ = super.mouseClicked(mouseX, mouseY, mouseEvent);
        int lvt_5_1_ = this.getSlotIndexFromScreenCoords(mouseX, mouseY);

        if (lvt_5_1_ >= 0)
        {
            GuiPageButtonList.GuiEntry lvt_6_1_ = this.getListEntry(lvt_5_1_);
    ...
    private GuiSlider func_178067_a(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_)
    {
        ...
        lvt_4_1_.visible = p_178067_3_.func_178934_d();
        return lvt_4_1_;
    }
    ...
    private GuiListButton func_178065_a(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_)
    {
        ...
        lvt_4_1_.visible = p_178065_3_.func_178934_d();
        return lvt_4_1_;
    }

    private GuiTextField func_178068_a(int p_178068_1_, int p_178068_2_, GuiPageButtonList.EditBoxEntry p_178068_3_)
    {
        GuiTextField lvt_4_1_ = new GuiTextField(p_178068_3_.func_178935_b(), this.mc.fontRendererObj, p_178068_1_, p_178068_2_, 150, 20);
        lvt_4_1_.setText(p_178068_3_.func_178936_c());
        lvt_4_1_.func_175207_a(this.field_178076_z);
        lvt_4_1_.setVisible(p_178068_3_.func_178934_d());
        lvt_4_1_.setValidator(p_178068_3_.func_178950_a());
        return lvt_4_1_;
    }
    ...
    private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_)
    {
        ...
        if (p_178063_4_)
        {
            lvt_5_1_ = new GuiLabel(this.mc.fontRendererObj, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.width - p_178063_1_ * 2, 20, -1);
        }
        else
        {
            lvt_5_1_ = new GuiLabel(this.mc.fontRendererObj, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
        }

        lvt_5_1_.visible = p_178063_3_.func_178934_d();
        lvt_5_1_.func_175202_a(p_178063_3_.func_178936_c());
        lvt_5_1_.setCentered();
        return lvt_5_1_;
    }
        ...
        if (this.field_178075_A instanceof GuiTextField)
        {
            ...
            if (!GuiScreen.isKeyComboCtrlV(p_178062_2_))
            {
                if (p_178062_2_ == 15)
                {
                    ...
                    {
                        this.amountScrolled = (float)lvt_6_2_;
                    }
                }
                else
                {
                    lvt_3_1_.textboxKeyTyped(p_178062_1_, p_178062_2_);
                }
            }
            else
            {
                ...
                {
                    ((GuiTextField)this.field_178072_w.get(lvt_7_1_)).setText(lvt_11_1_);
    ...
    public static class GuiEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        {
            boolean lvt_5_1_ = p_178023_1_.mousePressed(this.field_178031_a, p_178023_2_, p_178023_3_);
