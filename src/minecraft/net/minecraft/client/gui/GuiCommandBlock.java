...
public class GuiCommandBlock extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 0)
            {
                ...
                lvt_2_1_.writeByte(this.localCommandBlock.func_145751_f());
                this.localCommandBlock.func_145757_a(lvt_2_1_);
                lvt_2_1_.writeString(this.commandTextField.getText());
                lvt_2_1_.writeBoolean(this.localCommandBlock.shouldTrackOutput());
                this.mc.getNetHandler().addToSendQueue(new C17PacketCustomPayload("MC|AdvCdm", lvt_2_1_));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        int lvt_4_1_ = 75;
        int lvt_5_1_ = 0;
        this.drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer", new Object[0]), this.width / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer", new Object[0]), this.width / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allPlayers", new Object[0]), this.width / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, I18n.format("advMode.allEntities", new Object[0]), this.width / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        this.drawString(this.fontRendererObj, "", this.width / 2 - 150, lvt_4_1_ + lvt_5_1_++ * this.fontRendererObj.FONT_HEIGHT, 10526880);

        if (this.previousOutputTextField.getText().length() > 0)
        {
            lvt_4_1_ = lvt_4_1_ + lvt_5_1_ * this.fontRendererObj.FONT_HEIGHT + 16;
            this.drawString(this.fontRendererObj, I18n.format("advMode.previousOutput", new Object[0]), this.width / 2 - 150, lvt_4_1_, 10526880);
