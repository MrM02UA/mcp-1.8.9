...
public class GuiFlatPresets extends GuiScreen
{
    ...
    public void func_146426_g()
    {
        ...
        this.field_146434_t.enabled = lvt_1_1_;
    }
    ...
    private static void func_175354_a(String p_175354_0_, Item p_175354_1_, int p_175354_2_, BiomeGenBase p_175354_3_, List<String> p_175354_4_, FlatLayerInfo... p_175354_5_)
    {
        ...
        {
            lvt_6_1_.getFlatLayers().add(p_175354_5_[lvt_7_1_]);
        }

        lvt_6_1_.setBiome(p_175354_3_.biomeID);
        ...
        FLAT_WORLD_PRESETS.add(new GuiFlatPresets.LayerItem(p_175354_1_, p_175354_2_, p_175354_0_, lvt_6_1_.toString()));
    }
    ...
    class ListSlot extends GuiSlot
    {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_)
        {
            ...
            lvt_10_1_.pos((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            lvt_10_1_.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 18), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 18) * 0.0078125F)).endVertex();
            lvt_10_1_.pos((double)(p_148171_1_ + 18), (double)(p_148171_2_ + 0), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 18) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).endVertex();
            lvt_10_1_.pos((double)(p_148171_1_ + 0), (double)(p_148171_2_ + 0), (double)GuiFlatPresets.this.zLevel).tex((double)((float)(p_148171_3_ + 0) * 0.0078125F), (double)((float)(p_148171_4_ + 0) * 0.0078125F)).endVertex();
            lvt_9_1_.draw();
        }
        ...
        {
            GuiFlatPresets.LayerItem lvt_7_1_ = (GuiFlatPresets.LayerItem)GuiFlatPresets.FLAT_WORLD_PRESETS.get(entryID);
            this.func_178054_a(p_180791_2_, p_180791_3_, lvt_7_1_.field_148234_a, lvt_7_1_.field_179037_b);
            GuiFlatPresets.this.fontRendererObj.drawString(lvt_7_1_.field_148232_b, p_180791_2_ + 18 + 5, p_180791_3_ + 6, 16777215);
        }
    }
}
