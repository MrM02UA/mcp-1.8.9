...
public class GuiShareToLan extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        else if (button.id == 101)
        {
            ...
            String lvt_2_1_ = this.mc.getIntegratedServer().shareToLAN(WorldSettings.GameType.getByName(this.field_146599_h), this.field_146600_i);
            IChatComponent lvt_3_1_;

            if (lvt_2_1_ != null)
            {
                lvt_3_1_ = new ChatComponentTranslation("commands.publish.started", new Object[] {lvt_2_1_});
            }
            else
            {
                lvt_3_1_ = new ChatComponentText("commands.publish.failed");
            }
