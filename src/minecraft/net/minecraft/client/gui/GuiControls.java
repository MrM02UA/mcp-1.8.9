...
public class GuiControls extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (GameSettings.Options lvt_5_1_ : optionsArr)
        {
            if (lvt_5_1_.getEnumFloat())
            {
                this.buttonList.add(new GuiOptionSlider(lvt_5_1_.returnEnumOrdinal(), this.width / 2 - 155 + lvt_1_1_ % 2 * 160, 18 + 24 * (lvt_1_1_ >> 1), lvt_5_1_));
            }
            else
            {
                this.buttonList.add(new GuiOptionButton(lvt_5_1_.returnEnumOrdinal(), this.width / 2 - 155 + lvt_1_1_ % 2 * 160, 18 + 24 * (lvt_1_1_ >> 1), lvt_5_1_, this.options.getKeyBinding(lvt_5_1_)));
            }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        {
            for (KeyBinding lvt_5_1_ : this.mc.gameSettings.keyBindings)
            {
                lvt_5_1_.setKeyCode(lvt_5_1_.getKeyCodeDefault());
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (KeyBinding lvt_8_1_ : this.options.keyBindings)
        {
            if (lvt_8_1_.getKeyCode() != lvt_8_1_.getKeyCodeDefault())
            {
                lvt_4_1_ = false;
                break;
            }
        ...
        this.buttonReset.enabled = !lvt_4_1_;
