...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private Predicate<String> field_175332_D = new Predicate<String>()
    {
        public boolean apply(String p_apply_1_)
        {
            ...
            return p_apply_1_.length() == 0 || lvt_2_1_ != null && Floats.isFinite(lvt_2_1_.floatValue()) && lvt_2_1_.floatValue() >= 0.0F;
        }
    ...
    public void initGui()
    {
        ...
        if (this.field_175349_r != null)
        {
            ...
            lvt_2_1_ = this.field_175349_r.getAmountScrolled();
        }
        ...
        if (lvt_1_1_ != 0)
        {
            ...
            this.field_175349_r.scrollBy(lvt_2_1_);
            this.func_175328_i();
        }
    }
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_)
    {
        ...
        {
            case 132:
                lvt_4_1_ = this.field_175336_F.mainNoiseScaleX = MathHelper.clamp_float(lvt_3_1_, 1.0F, 5000.0F);
                break;

            case 133:
                lvt_4_1_ = this.field_175336_F.mainNoiseScaleY = MathHelper.clamp_float(lvt_3_1_, 1.0F, 5000.0F);
                break;

            case 134:
                lvt_4_1_ = this.field_175336_F.mainNoiseScaleZ = MathHelper.clamp_float(lvt_3_1_, 1.0F, 5000.0F);
                break;

            case 135:
                lvt_4_1_ = this.field_175336_F.depthNoiseScaleX = MathHelper.clamp_float(lvt_3_1_, 1.0F, 2000.0F);
                break;

            case 136:
                lvt_4_1_ = this.field_175336_F.depthNoiseScaleZ = MathHelper.clamp_float(lvt_3_1_, 1.0F, 2000.0F);
                break;

            case 137:
                lvt_4_1_ = this.field_175336_F.depthNoiseScaleExponent = MathHelper.clamp_float(lvt_3_1_, 0.01F, 20.0F);
                break;

            case 138:
                lvt_4_1_ = this.field_175336_F.baseSize = MathHelper.clamp_float(lvt_3_1_, 1.0F, 25.0F);
                break;

            case 139:
                lvt_4_1_ = this.field_175336_F.coordinateScale = MathHelper.clamp_float(lvt_3_1_, 1.0F, 6000.0F);
                break;

            case 140:
                lvt_4_1_ = this.field_175336_F.heightScale = MathHelper.clamp_float(lvt_3_1_, 1.0F, 6000.0F);
                break;

            case 141:
                lvt_4_1_ = this.field_175336_F.stretchY = MathHelper.clamp_float(lvt_3_1_, 0.01F, 50.0F);
                break;

            case 142:
                lvt_4_1_ = this.field_175336_F.upperLimitScale = MathHelper.clamp_float(lvt_3_1_, 1.0F, 5000.0F);
                break;

            case 143:
                lvt_4_1_ = this.field_175336_F.lowerLimitScale = MathHelper.clamp_float(lvt_3_1_, 1.0F, 5000.0F);
                break;

            case 144:
                lvt_4_1_ = this.field_175336_F.biomeDepthWeight = MathHelper.clamp_float(lvt_3_1_, 1.0F, 20.0F);
                break;

            case 145:
                lvt_4_1_ = this.field_175336_F.biomeDepthOffset = MathHelper.clamp_float(lvt_3_1_, 0.0F, 20.0F);
                break;

            case 146:
                lvt_4_1_ = this.field_175336_F.biomeScaleWeight = MathHelper.clamp_float(lvt_3_1_, 1.0F, 20.0F);
                break;

            case 147:
                lvt_4_1_ = this.field_175336_F.biomeScaleOffset = MathHelper.clamp_float(lvt_3_1_, 0.0F, 20.0F);
        }

        if (lvt_4_1_ != lvt_3_1_ && lvt_3_1_ != 0.0F)
        {
            ((GuiTextField)this.field_175349_r.func_178061_c(p_175319_1_)).setText(this.func_175330_b(p_175319_1_, lvt_4_1_));
        }
    ...
    private String func_175330_b(int p_175330_1_, float p_175330_2_)
    {
        switch (p_175330_1_)
        {
            ...
            case 162:
                ...
                {
                    BiomeGenBase lvt_3_1_ = BiomeGenBase.getBiomeGenArray()[(int)p_175330_2_ + 2];
                    return lvt_3_1_ != null ? lvt_3_1_.biomeName : "?";
                }
                else
                {
                    BiomeGenBase lvt_3_2_ = BiomeGenBase.getBiomeGenArray()[(int)p_175330_2_];
                    return lvt_3_2_ != null ? lvt_3_2_.biomeName : "?";
                }
        }
    }
    ...
    public void onTick(int id, float value)
    {
        ...
        if (id >= 100 && id < 116)
        {
            Gui lvt_3_1_ = this.field_175349_r.func_178061_c(id - 100 + 132);

            if (lvt_3_1_ != null)
            {
                ((GuiTextField)lvt_3_1_).setText(this.func_175330_b(id, value));
            }
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 301:
                    for (int lvt_2_1_ = 0; lvt_2_1_ < this.field_175349_r.getSize(); ++lvt_2_1_)
                    {
                        GuiPageButtonList.GuiEntry lvt_3_1_ = this.field_175349_r.getListEntry(lvt_2_1_);
                        ...
                        if (lvt_4_1_ instanceof GuiButton)
                        {
                            ...
                            {
                                float lvt_6_1_ = ((GuiSlider)lvt_5_1_).func_175217_d() * (0.75F + this.random.nextFloat() * 0.5F) + (this.random.nextFloat() * 0.1F - 0.05F);
                                ((GuiSlider)lvt_5_1_).func_175219_a(MathHelper.clamp_float(lvt_6_1_, 0.0F, 1.0F));
                            }
                            else if (lvt_5_1_ instanceof GuiListButton)
                            {
                                ((GuiListButton)lvt_5_1_).func_175212_b(this.random.nextBoolean());
                            }
                        }
                        ...
                        if (lvt_5_2_ instanceof GuiButton)
                        {
                            ...
                            {
                                float lvt_7_1_ = ((GuiSlider)lvt_6_2_).func_175217_d() * (0.75F + this.random.nextFloat() * 0.5F) + (this.random.nextFloat() * 0.1F - 0.05F);
                                ((GuiSlider)lvt_6_2_).func_175219_a(MathHelper.clamp_float(lvt_7_1_, 0.0F, 1.0F));
                            }
                            else if (lvt_6_2_ instanceof GuiListButton)
                            {
                                ((GuiListButton)lvt_6_2_).func_175212_b(this.random.nextBoolean());
                            }
                        }
                    }
    ...
    private void func_175327_a(float p_175327_1_)
    {
        ...
        if (lvt_2_1_ instanceof GuiTextField)
        {
            ...
            Float lvt_5_1_ = Floats.tryParse(lvt_4_1_.getText());

            if (lvt_5_1_ != null)
            {
                lvt_5_1_ = Float.valueOf(lvt_5_1_.floatValue() + lvt_3_1_);
                int lvt_6_1_ = lvt_4_1_.getId();
                String lvt_7_1_ = this.func_175330_b(lvt_4_1_.getId(), lvt_5_1_.floatValue());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.field_175339_B != 0)
        {
            ...
            lvt_7_1_.pos((double)(this.width / 2 - 90), 185.0D, 0.0D).tex(0.0D, 2.65625D).color(64, 64, 64, 64).endVertex();
            lvt_7_1_.pos((double)(this.width / 2 + 90), 185.0D, 0.0D).tex(5.625D, 2.65625D).color(64, 64, 64, 64).endVertex();
            lvt_7_1_.pos((double)(this.width / 2 + 90), 100.0D, 0.0D).tex(5.625D, 0.0D).color(64, 64, 64, 64).endVertex();
            lvt_7_1_.pos((double)(this.width / 2 - 90), 100.0D, 0.0D).tex(0.0D, 0.0D).color(64, 64, 64, 64).endVertex();
            lvt_6_1_.draw();
