...
public class GuiOptionsRowList extends GuiListExtended
{
    ...
    public GuiOptionsRowList(Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options... p_i45015_7_)
    {
        ...
        for (int lvt_8_1_ = 0; lvt_8_1_ < p_i45015_7_.length; lvt_8_1_ += 2)
        {
            ...
            GuiButton lvt_11_1_ = this.func_148182_a(mcIn, p_i45015_2_ / 2 - 155, 0, lvt_9_1_);
            GuiButton lvt_12_1_ = this.func_148182_a(mcIn, p_i45015_2_ / 2 - 155 + 160, 0, lvt_10_1_);
    ...
    private GuiButton func_148182_a(Minecraft mcIn, int p_148182_2_, int p_148182_3_, GameSettings.Options p_148182_4_)
    {
        ...
        {
            int lvt_5_1_ = p_148182_4_.returnEnumOrdinal();
            return (GuiButton)(p_148182_4_.getEnumFloat() ? new GuiOptionSlider(lvt_5_1_, p_148182_2_, p_148182_3_, p_148182_4_) : new GuiOptionButton(lvt_5_1_, p_148182_2_, p_148182_3_, p_148182_4_, mcIn.gameSettings.getKeyBinding(p_148182_4_)));
        }
    }
