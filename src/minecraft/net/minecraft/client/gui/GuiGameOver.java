...
public class GuiGameOver extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        boolean lvt_4_1_ = this.mc.theWorld.getWorldInfo().isHardcoreModeEnabled();
        String lvt_5_1_ = lvt_4_1_ ? I18n.format("deathScreen.title.hardcore", new Object[0]) : I18n.format("deathScreen.title", new Object[0]);
        this.drawCenteredString(this.fontRendererObj, lvt_5_1_, this.width / 2 / 2, 30, 16777215);
