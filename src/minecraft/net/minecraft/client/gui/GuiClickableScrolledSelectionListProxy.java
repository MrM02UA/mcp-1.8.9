...
public class GuiClickableScrolledSelectionListProxy extends GuiSlot
{
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn)
    {
        ...
        {
            int lvt_7_1_ = p_148120_2_ + lvt_6_1_ * this.slotHeight + this.headerPadding;
            int lvt_8_1_ = this.slotHeight - 4;

            if (lvt_7_1_ > this.bottom || lvt_7_1_ + lvt_8_1_ < this.top)
            {
                this.func_178040_a(lvt_6_1_, p_148120_1_, lvt_7_1_);
            }

            if (this.showSelectionBox && this.isSelected(lvt_6_1_))
            {
                this.func_178043_a(this.width, lvt_7_1_, lvt_8_1_, Tezzelator.instance);
            }

            this.drawSlot(lvt_6_1_, p_148120_1_, lvt_7_1_, lvt_8_1_, mouseXIn, mouseYIn);
        }
    }
}
