...
public class GlStateManager
{
    ...
    {
        GlStateManager.TexGenCoord lvt_2_1_ = texGenCoord(texGen);

        if (param != lvt_2_1_.param)
        {
            lvt_2_1_.param = param;
            GL11.glTexGeni(lvt_2_1_.coord, GL11.GL_TEXTURE_GEN_MODE, param);
        }
    }
    ...
    public static void deleteTexture(int texture)
    {
        ...
        for (GlStateManager.TextureState lvt_4_1_ : textureState)
        {
    ...
    static
    {
        ...
        {
            lightState[lvt_0_1_] = new GlStateManager.BooleanState(16384 + lvt_0_1_);
        }

        for (int lvt_0_2_ = 0; lvt_0_2_ < 8; ++lvt_0_2_)
        {
            textureState[lvt_0_2_] = new GlStateManager.TextureState();
        }
    }
