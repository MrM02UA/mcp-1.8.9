...
public class RenderTNTPrimed extends Render<EntityTNTPrimed>
{
    ...
    public void doRender(EntityTNTPrimed entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        {
            float lvt_11_1_ = 1.0F - ((float)entity.fuse - partialTicks + 1.0F) / 10.0F;
            lvt_11_1_ = MathHelper.clamp_float(lvt_11_1_, 0.0F, 1.0F);
            lvt_11_1_ = lvt_11_1_ * lvt_11_1_;
            lvt_11_1_ = lvt_11_1_ * lvt_11_1_;
            float lvt_12_1_ = 1.0F + lvt_11_1_ * 0.3F;
            GlStateManager.scale(lvt_12_1_, lvt_12_1_, lvt_12_1_);
        }

        float lvt_11_2_ = (1.0F - ((float)entity.fuse - partialTicks + 1.0F) / 100.0F) * 0.8F;
        this.bindEntityTexture(entity);
        GlStateManager.translate(-0.5F, -0.5F, 0.5F);
        lvt_10_1_.renderBlockBrightness(Blocks.tnt.getDefaultState(), entity.getBrightness(partialTicks));
        ...
        if (entity.fuse / 5 % 2 == 0)
        {
            ...
            lvt_10_1_.renderBlockBrightness(Blocks.tnt.getDefaultState(), 1.0F);
