...
public class RenderWolf extends RenderLiving<EntityWolf>
{
    ...
    public void doRender(EntityWolf entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (entity.isWolfWet())
        {
            float lvt_10_1_ = entity.getBrightness(partialTicks) * entity.getShadingWhileWet(partialTicks);
    ...
    {
        this.doRender((EntityWolf)entity, x, y, z, entityYaw, partialTicks);
    }
    ...
    {
        return this.handleRotationFloat((EntityWolf)livingBase, partialTicks);
    }
