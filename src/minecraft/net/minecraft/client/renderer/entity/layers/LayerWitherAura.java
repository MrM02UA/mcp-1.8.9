...
public class LayerWitherAura implements LayerRenderer<EntityWither>
{
    ...
    public void doRenderLayer(EntityWither entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
        if (entitylivingbaseIn.isArmored())
        {
            ...
            float lvt_9_1_ = (float)entitylivingbaseIn.ticksExisted + partialTicks;
            float lvt_10_1_ = MathHelper.cos(lvt_9_1_ * 0.02F) * 3.0F;
            float lvt_11_1_ = lvt_9_1_ * 0.01F;
            GlStateManager.translate(lvt_10_1_, lvt_11_1_, 0.0F);
            GlStateManager.matrixMode(5888);
            GlStateManager.enableBlend();
            float lvt_12_1_ = 0.5F;
            GlStateManager.color(lvt_12_1_, lvt_12_1_, lvt_12_1_, 1.0F);
    ...
    {
        this.doRenderLayer((EntityWither)entitylivingbaseIn, p_177141_2_, p_177141_3_, partialTicks, p_177141_5_, p_177141_6_, p_177141_7_, scale);
    }
}
