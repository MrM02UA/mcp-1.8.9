...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderModel(IBakedModel model, int color, ItemStack stack)
    {
        ...
        lvt_5_1_.begin(7, DefaultVertexFormats.ITEM);

        for (EnumFacing lvt_9_1_ : EnumFacing.values())
        {
            this.renderQuads(lvt_5_1_, model.getFaceQuads(lvt_9_1_), color, stack);
        }

        this.renderQuads(lvt_5_1_, model.getGeneralQuads(), color, stack);
        lvt_4_1_.draw();
    }
    ...
    private void renderEffect(IBakedModel model)
    {
        ...
        float lvt_2_1_ = (float)(Minecraft.getSystemTime() % 3000L) / 3000.0F / 8.0F;
        GlStateManager.translate(lvt_2_1_, 0.0F, 0.0F);
        GlStateManager.rotate(-50.0F, 0.0F, 0.0F, 1.0F);
        this.renderModel(model, -8372020);
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.scale(8.0F, 8.0F, 8.0F);
        float lvt_3_1_ = (float)(Minecraft.getSystemTime() % 4873L) / 4873.0F / 8.0F;
        GlStateManager.translate(-lvt_3_1_, 0.0F, 0.0F);
    ...
    {
        Vec3i lvt_3_1_ = quad.getFace().getDirectionVec();
        renderer.putNormal((float)lvt_3_1_.getX(), (float)lvt_3_1_.getY(), (float)lvt_3_1_.getZ());
    }
    ...
    {
        boolean lvt_5_1_ = color == -1 && stack != null;
        int lvt_6_1_ = 0;

        for (int lvt_7_1_ = quads.size(); lvt_6_1_ < lvt_7_1_; ++lvt_6_1_)
        {
            BakedQuad lvt_8_1_ = (BakedQuad)quads.get(lvt_6_1_);
            int lvt_9_1_ = color;

            if (lvt_5_1_ && lvt_8_1_.hasTintIndex())
            {
                lvt_9_1_ = stack.getItem().getColorFromItemStack(stack, lvt_8_1_.getTintIndex());

                if (EntityRenderer.anaglyphEnable)
                {
                    lvt_9_1_ = TextureUtil.anaglyphColor(lvt_9_1_);
                }

                lvt_9_1_ = lvt_9_1_ | -16777216;
            }

            this.renderQuad(renderer, lvt_8_1_, lvt_9_1_);
        }
    }

    public boolean shouldRenderItemIn3D(ItemStack stack)
    {
        IBakedModel lvt_2_1_ = this.itemModelMesher.getItemModel(stack);
        return lvt_2_1_ == null ? false : lvt_2_1_.isGui3d();
    }

    private void preTransform(ItemStack stack)
    {
        IBakedModel lvt_2_1_ = this.itemModelMesher.getItemModel(stack);
        Item lvt_3_1_ = stack.getItem();

        if (lvt_3_1_ != null)
        {
            boolean lvt_4_1_ = lvt_2_1_.isGui3d();
    ...
    public void renderItem(ItemStack stack, ItemCameraTransforms.TransformType cameraTransformType)
    {
        if (stack != null)
        {
            IBakedModel lvt_3_1_ = this.itemModelMesher.getItemModel(stack);
            this.renderItemModelTransform(stack, lvt_3_1_, cameraTransformType);
        }
    }
    ...
    public void renderItemModelForEntity(ItemStack stack, EntityLivingBase entityToRenderFor, ItemCameraTransforms.TransformType cameraTransformType)
    {
        ...
        {
            IBakedModel lvt_4_1_ = this.itemModelMesher.getItemModel(stack);

            if (entityToRenderFor instanceof EntityPlayer)
            {
                EntityPlayer lvt_5_1_ = (EntityPlayer)entityToRenderFor;
                Item lvt_6_1_ = stack.getItem();
                ModelResourceLocation lvt_7_1_ = null;

                if (lvt_6_1_ == Items.fishing_rod && lvt_5_1_.fishEntity != null)
                {
                    lvt_7_1_ = new ModelResourceLocation("fishing_rod_cast", "inventory");
                }
                else if (lvt_6_1_ == Items.bow && lvt_5_1_.getItemInUse() != null)
                {
                    int lvt_8_1_ = stack.getMaxItemUseDuration() - lvt_5_1_.getItemInUseCount();

                    if (lvt_8_1_ >= 18)
                    {
                        lvt_7_1_ = new ModelResourceLocation("bow_pulling_2", "inventory");
                    }
                    else if (lvt_8_1_ > 13)
                    {
                        lvt_7_1_ = new ModelResourceLocation("bow_pulling_1", "inventory");
                    }
                    else if (lvt_8_1_ > 0)
                    {
                        lvt_7_1_ = new ModelResourceLocation("bow_pulling_0", "inventory");
                    }
                }

                if (lvt_7_1_ != null)
                {
                    lvt_4_1_ = this.itemModelMesher.getModelManager().getModel(lvt_7_1_);
                }
            }

            this.renderItemModelTransform(stack, lvt_4_1_, cameraTransformType);
        }
    }
    ...
    protected void renderItemModelTransform(ItemStack stack, IBakedModel model, ItemCameraTransforms.TransformType cameraTransformType)
    {
        ...
        GlStateManager.pushMatrix();
        ItemCameraTransforms lvt_4_1_ = model.getItemCameraTransforms();
        lvt_4_1_.applyTransform(cameraTransformType);

        if (this.isThereOneNegativeScale(lvt_4_1_.getTransform(cameraTransformType)))
        {
    ...
    public void renderItemIntoGUI(ItemStack stack, int x, int y)
    {
        ...
        GlStateManager.blendFunc(770, 771);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        this.setupGuiTransform(x, y, lvt_4_1_.isGui3d());
        lvt_4_1_.getItemCameraTransforms().applyTransform(ItemCameraTransforms.TransformType.GUI);
        this.renderItem(stack, lvt_4_1_);
    ...
    public void renderItemAndEffectIntoGUI(final ItemStack stack, int xPosition, int yPosition)
    {
        if (stack != null && stack.getItem() != null)
        {
            ...
            {
                CrashReport lvt_5_1_ = CrashReport.makeCrashReport(var7, "Rendering item");
                CrashReportCategory lvt_6_1_ = lvt_5_1_.makeCategory("Item being rendered");
                lvt_6_1_.addCrashSectionCallable("Item Type", new Callable<String>()
                {
                ...
                lvt_6_1_.addCrashSectionCallable("Item Aux", new Callable<String>()
                {
                    public String call() throws Exception
                    {
                ...
                lvt_6_1_.addCrashSectionCallable("Item NBT", new Callable<String>()
                {
                    public String call() throws Exception
                    {
                ...
                lvt_6_1_.addCrashSectionCallable("Item Foil", new Callable<String>()
                {
                    public String call() throws Exception
                    {
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
            ...
            {
                String lvt_6_1_ = text == null ? String.valueOf(stack.stackSize) : text;

                if (text == null && stack.stackSize < 1)
                {
                    lvt_6_1_ = EnumChatFormatting.RED + String.valueOf(stack.stackSize);
                }

                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(lvt_6_1_, (float)(xPosition + 19 - 2 - fr.getStringWidth(lvt_6_1_)), (float)(yPosition + 6 + 3), 16777215);
                GlStateManager.enableLighting();
            ...
            {
                int lvt_6_2_ = (int)Math.round(13.0D - (double)stack.getItemDamage() * 13.0D / (double)stack.getMaxDamage());
                int lvt_7_1_ = (int)Math.round(255.0D - (double)stack.getItemDamage() * 255.0D / (double)stack.getMaxDamage());
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
                ...
                this.draw(lvt_9_1_, xPosition + 2, yPosition + 13, 13, 2, 0, 0, 0, 255);
                this.draw(lvt_9_1_, xPosition + 2, yPosition + 13, 12, 1, (255 - lvt_7_1_) / 4, 64, 0, 255);
                this.draw(lvt_9_1_, xPosition + 2, yPosition + 13, lvt_6_2_, 1, 255 - lvt_7_1_, lvt_7_1_, 0, 255);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
