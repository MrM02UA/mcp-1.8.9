...
public class RenderZombie extends RenderBiped<EntityZombie>
{
    ...
    public RenderZombie(RenderManager renderManagerIn)
    {
        ...
        LayerRenderer lvt_2_1_ = (LayerRenderer)this.layerRenderers.get(0);
    ...
    {
        this.doRender((EntityZombie)entity, x, y, z, entityYaw, partialTicks);
    }
