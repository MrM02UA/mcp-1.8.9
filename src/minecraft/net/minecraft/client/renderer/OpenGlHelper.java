...
public class OpenGlHelper
{
    ...
    {
        ContextCapabilities lvt_0_1_ = GLContext.getCapabilities();
        ...
        String lvt_1_1_ = GL11.glGetString(GL11.GL_VENDOR).toLowerCase();
        ...
        try
        {
            Processor[] lvt_2_1_ = (new SystemInfo()).getHardware().getProcessors();
            cpu = String.format("%dx %s", new Object[] {Integer.valueOf(lvt_2_1_.length), lvt_2_1_[0]}).replaceAll("\\s+", " ");
        }
