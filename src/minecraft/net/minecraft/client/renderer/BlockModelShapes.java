...
public class BlockModelShapes
{
    ...
    {
        IBakedModel lvt_2_1_ = (IBakedModel)this.bakedModelStore.get(state);
    ...
    public void reloadModels()
    {
        ...
        for (Entry<IBlockState, ModelResourceLocation> lvt_2_1_ : this.blockStateMapper.putAllStateModelLocations().entrySet())
        {
            this.bakedModelStore.put(lvt_2_1_.getKey(), this.modelManager.getModel((ModelResourceLocation)lvt_2_1_.getValue()));
        }
    }
    ...
    private void registerAllBlocks()
    {
        ...
        this.registerBlockWithStateMapper(Blocks.quartz_block, new StateMapperBase()
        {
            ...
            {
                BlockQuartz.EnumType lvt_2_1_ = (BlockQuartz.EnumType)state.getValue(BlockQuartz.VARIANT);
        ...
        this.registerBlockWithStateMapper(Blocks.pumpkin_stem, new StateMapperBase()
        {
            protected ModelResourceLocation getModelResourceLocation(IBlockState state)
            {
                ...
                return new ModelResourceLocation((ResourceLocation)Block.blockRegistry.getNameForObject(state.getBlock()), this.getPropertyString(lvt_2_1_));
            }
        });
        ...
        this.registerBlockWithStateMapper(Blocks.dirt, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> lvt_2_1_ = Maps.newLinkedHashMap(state.getProperties());
                String lvt_3_1_ = BlockDirt.VARIANT.getName((Comparable)lvt_2_1_.remove(BlockDirt.VARIANT));
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> lvt_2_1_ = Maps.newLinkedHashMap(state.getProperties());
                String lvt_3_1_ = BlockStoneSlab.VARIANT.getName((Comparable)lvt_2_1_.remove(BlockStoneSlab.VARIANT));
                lvt_2_1_.remove(BlockStoneSlab.SEAMLESS);
                String lvt_4_1_ = ((Boolean)state.getValue(BlockStoneSlab.SEAMLESS)).booleanValue() ? "all" : "normal";
        ...
        this.registerBlockWithStateMapper(Blocks.double_stone_slab2, new StateMapperBase()
        {
            ...
            {
                Map<IProperty, Comparable> lvt_2_1_ = Maps.newLinkedHashMap(state.getProperties());
                String lvt_3_1_ = BlockStoneSlabNew.VARIANT.getName((Comparable)lvt_2_1_.remove(BlockStoneSlabNew.VARIANT));
                lvt_2_1_.remove(BlockStoneSlab.SEAMLESS);
                String lvt_4_1_ = ((Boolean)state.getValue(BlockStoneSlabNew.SEAMLESS)).booleanValue() ? "all" : "normal";
                return new ModelResourceLocation(lvt_3_1_ + "_double_slab", lvt_4_1_);
            }
        });
    }
