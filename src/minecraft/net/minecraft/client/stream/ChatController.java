...
public class ChatController
{
        ...
        public void chatShutdownCallback(ErrorCode p_chatShutdownCallback_1_)
        {
            if (ErrorCode.succeeded(p_chatShutdownCallback_1_))
            {
                ...
                if (ErrorCode.failed(lvt_2_1_))
                {
                    ...
                    ChatController.this.func_152995_h(String.format("Error shutting down the Twitch sdk: %s", new Object[] {lvt_3_1_}));
                }
    ...
    public boolean func_175984_n()
    {
        ...
        else
        {
            ...
            if (ErrorCode.failed(lvt_1_1_))
            {
                ...
                this.func_152995_h(String.format("Error initializing Twitch sdk: %s", new Object[] {lvt_2_1_}));
                return false;
            }
            else
            {
                ...
                if (ErrorCode.failed(lvt_1_1_))
                {
                    ...
                    this.func_152995_h(String.format("Error initializing Twitch chat: %s", new Object[] {lvt_3_1_}));
                    return false;
                }
                else
                {
    ...
    public boolean func_152993_m()
    {
        ...
        else
        {
            ...
            {
                String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                this.func_152995_h(String.format("Error shutting down chat: %s", new Object[] {lvt_2_1_}));
                return false;
            }
            else
            {
    ...
    public void func_152997_n()
    {
        if (this.field_153011_i != ChatController.ChatState.Uninitialized)
        {
            ...
            {
                String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                this.func_152995_h(String.format("Error flushing chat events: %s", new Object[] {lvt_2_1_}));
            }
        }
    }
    ...
    protected void func_153001_r()
    {
        if (this.field_175995_l != ChatController.EnumEmoticonMode.None)
        {
            if (this.field_175996_m == null)
            {
                ...
                {
                    String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                    this.func_152995_h(String.format("Error trying to download emoticon data: %s", new Object[] {lvt_2_1_}));
                }
            }
        }
    }
    ...
    public class ChatChannelListener implements IChatChannelListener
    {
        ...
        public boolean func_176038_a(boolean p_176038_1_)
        {
            ...
            {
                String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
                ChatController.this.func_152995_h(String.format("Error connecting: %s", new Object[] {lvt_3_1_}));
        ...
        public boolean func_176034_g()
        {
            switch (this.field_176047_c)
            {
                ...
                case Connecting:
                    ...
                    {
                        String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                        ChatController.this.func_152995_h(String.format("Error disconnecting: %s", new Object[] {lvt_2_1_}));
                        return false;
                    }
        ...
        public void func_176032_a(String p_176032_1_)
        {
            ...
            else
            {
                ...
                {
                    ListIterator<ChatRawMessage> lvt_2_1_ = this.field_176045_e.listIterator();

                    while (lvt_2_1_.hasNext())
                    {
                        ChatRawMessage lvt_3_1_ = (ChatRawMessage)lvt_2_1_.next();
                ...
                {
                    ListIterator<ChatTokenizedMessage> lvt_2_2_ = this.field_176042_f.listIterator();
        ...
        public boolean func_176037_b(String p_176037_1_)
        {
            ...
            else
            {
                ...
                {
                    String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
                    ChatController.this.func_152995_h(String.format("Error sending chat message: %s", new Object[] {lvt_3_1_}));
                    return false;
                }
                else
                {
        ...
        protected void func_176041_h()
        {
            if (ChatController.this.field_175995_l != ChatController.EnumEmoticonMode.None)
            {
                if (this.field_176043_g == null)
                {
                    ...
                    {
                        String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                        ChatController.this.func_152995_h(String.format("Error trying to download badge data: %s", new Object[] {lvt_2_1_}));
                    }
                }
            }
        }
        ...
        {
            for (int lvt_5_1_ = 0; lvt_5_1_ < p_chatChannelUserChangeCallback_3_.length; ++lvt_5_1_)
            {
                int lvt_6_1_ = this.field_176044_d.indexOf(p_chatChannelUserChangeCallback_3_[lvt_5_1_]);

                if (lvt_6_1_ >= 0)
                {
                    this.field_176044_d.remove(lvt_6_1_);
                }
            }

            for (int lvt_5_2_ = 0; lvt_5_2_ < p_chatChannelUserChangeCallback_4_.length; ++lvt_5_2_)
            {
                int lvt_6_2_ = this.field_176044_d.indexOf(p_chatChannelUserChangeCallback_4_[lvt_5_2_]);
                ...
                this.field_176044_d.add(p_chatChannelUserChangeCallback_4_[lvt_5_2_]);
            }

            for (int lvt_5_3_ = 0; lvt_5_3_ < p_chatChannelUserChangeCallback_2_.length; ++lvt_5_3_)
            {
