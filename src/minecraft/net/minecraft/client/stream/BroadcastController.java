...
public class BroadcastController
{
    ...
    protected IStreamCallbacks streamCallback = new IStreamCallbacks()
    {
        public void requestAuthTokenCallback(ErrorCode p_requestAuthTokenCallback_1_, AuthToken p_requestAuthTokenCallback_2_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logError(String.format("RequestAuthTokenDoneCallback got failure: %s", new Object[] {lvt_3_1_}));
            }
        ...
        public void loginCallback(ErrorCode p_loginCallback_1_, ChannelInfo p_loginCallback_2_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logError(String.format("LoginCallback got failure: %s", new Object[] {lvt_3_1_}));
            }
        ...
        public void getIngestServersCallback(ErrorCode p_getIngestServersCallback_1_, IngestList p_getIngestServersCallback_2_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logError(String.format("IngestListCallback got failure: %s", new Object[] {lvt_3_2_}));
        ...
        public void getUserInfoCallback(ErrorCode p_getUserInfoCallback_1_, UserInfo p_getUserInfoCallback_2_)
        {
            ...
            if (ErrorCode.failed(p_getUserInfoCallback_1_))
            {
                ...
                BroadcastController.this.logError(String.format("UserInfoDoneCallback got failure: %s", new Object[] {lvt_3_1_}));
            }
        }
        public void getStreamInfoCallback(ErrorCode p_getStreamInfoCallback_1_, StreamInfo p_getStreamInfoCallback_2_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logWarning(String.format("StreamInfoDoneCallback got failure: %s", new Object[] {lvt_3_2_}));
            }
        }
        ...
        public void runCommercialCallback(ErrorCode p_runCommercialCallback_1_)
        {
            if (ErrorCode.failed(p_runCommercialCallback_1_))
            {
                ...
                BroadcastController.this.logWarning(String.format("RunCommercialCallback got failure: %s", new Object[] {lvt_2_1_}));
            }
        }
        public void setStreamInfoCallback(ErrorCode p_setStreamInfoCallback_1_)
        {
            if (ErrorCode.failed(p_setStreamInfoCallback_1_))
            {
                ...
                BroadcastController.this.logWarning(String.format("SetStreamInfoCallback got failure: %s", new Object[] {lvt_2_1_}));
            }
        }
        public void getGameNameListCallback(ErrorCode p_getGameNameListCallback_1_, GameInfoList p_getGameNameListCallback_2_)
        {
            if (ErrorCode.failed(p_getGameNameListCallback_1_))
            {
                ...
                BroadcastController.this.logError(String.format("GameNameListCallback got failure: %s", new Object[] {lvt_3_1_}));
            }
        ...
        public void startCallback(ErrorCode p_startCallback_1_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logError(String.format("startCallback got failure: %s", new Object[] {lvt_2_3_}));
            }
        }
        public void stopCallback(ErrorCode p_stopCallback_1_)
        {
            ...
            else
            {
                ...
                BroadcastController.this.logError(String.format("stopCallback got failure: %s", new Object[] {lvt_2_2_}));
            }
        }
        public void sendActionMetaDataCallback(ErrorCode p_sendActionMetaDataCallback_1_)
        {
            if (ErrorCode.failed(p_sendActionMetaDataCallback_1_))
            {
                ...
                BroadcastController.this.logError(String.format("sendActionMetaDataCallback got failure: %s", new Object[] {lvt_2_1_}));
            }
        }
        public void sendStartSpanMetaDataCallback(ErrorCode p_sendStartSpanMetaDataCallback_1_)
        {
            if (ErrorCode.failed(p_sendStartSpanMetaDataCallback_1_))
            {
                ...
                BroadcastController.this.logError(String.format("sendStartSpanMetaDataCallback got failure: %s", new Object[] {lvt_2_1_}));
            }
        }
        public void sendEndSpanMetaDataCallback(ErrorCode p_sendEndSpanMetaDataCallback_1_)
        {
            if (ErrorCode.failed(p_sendEndSpanMetaDataCallback_1_))
            {
                ...
                BroadcastController.this.logError(String.format("sendEndSpanMetaDataCallback got failure: %s", new Object[] {lvt_2_1_}));
            }
        }
    };
    ...
    public boolean func_152817_A()
    {
        ...
        else
        {
            ...
            ErrorCode lvt_1_1_ = this.streamCore.initialize(this.field_152868_d, System.getProperty("java.library.path"));

            if (!this.func_152853_a(lvt_1_1_))
            {
                this.theStream.setStreamCallbacks((IStreamCallbacks)null);
                this.errorCode = lvt_1_1_;
                return false;
            }
            else
            {
                lvt_1_1_ = this.streamCore.setTraceLevel(MessageLevel.TTV_ML_ERROR);
    ...
    public boolean func_152851_B()
    {
        ...
        else
        {
            ...
            ErrorCode lvt_1_1_ = this.streamCore.shutdown();
    ...
    public boolean func_152828_a(String p_152828_1_, String p_152828_2_, String p_152828_3_)
    {
        ...
        else
        {
            ...
            ErrorCode lvt_5_1_ = this.theStream.setStreamInfo(this.authenticationToken, p_152828_1_, lvt_4_1_);
    ...
    public boolean requestCommercial()
    {
        ...
        {
            ErrorCode lvt_1_1_ = this.theStream.runCommercial(this.authenticationToken);
            this.func_152853_a(lvt_1_1_);
    ...
    {
        int[] lvt_5_1_ = this.theStream.getMaxResolution(maxKbps, p_152834_2_, p_152834_3_, p_152834_4_);
        VideoParams lvt_6_1_ = new VideoParams();
        lvt_6_1_.maxKbps = maxKbps;
        lvt_6_1_.encodingCpuUsage = EncodingCpuUsage.TTV_ECU_HIGH;
        lvt_6_1_.pixelFormat = this.getPixelFormat();
    ...
    public boolean func_152836_a(VideoParams p_152836_1_)
    {
        if (p_152836_1_ != null && this.isReadyToBroadcast())
        {
            ...
            {
                ErrorCode lvt_2_1_ = this.theStream.start(p_152836_1_, this.audioParamaters, this.ingestServ, StartFlags.None, true);

                if (ErrorCode.failed(lvt_2_1_))
                {
                    this.func_152831_M();
                    String lvt_3_1_ = ErrorCode.getString(lvt_2_1_);
                    this.logError(String.format("Error while starting to broadcast: %s", new Object[] {lvt_3_1_}));
                    this.videoParamaters = null;
                    this.audioParamaters = null;
                    return false;
                }
    ...
    public boolean stopBroadcasting()
    {
        ...
        {
            ErrorCode lvt_1_1_ = this.theStream.stop(true);

            if (ErrorCode.failed(lvt_1_1_))
            {
                String lvt_2_1_ = ErrorCode.getString(lvt_1_1_);
                this.logError(String.format("Error while stopping the broadcast: %s", new Object[] {lvt_2_1_}));
                return false;
            }
            else
            {
    ...
    public boolean func_152847_F()
    {
        ...
        {
            ErrorCode lvt_1_1_ = this.theStream.pauseVideo();
    ...
    {
        ErrorCode lvt_6_1_ = this.theStream.sendActionMetaData(this.authenticationToken, p_152840_1_, p_152840_2_, p_152840_4_, p_152840_5_);
    ...
    {
        long lvt_6_1_ = this.theStream.sendStartSpanMetaData(this.authenticationToken, p_177946_1_, p_177946_2_, p_177946_4_, p_177946_5_);
    ...
    public boolean func_177947_a(String p_177947_1_, long p_177947_2_, long p_177947_4_, String p_177947_6_, String p_177947_7_)
    {
        ...
        {
            ErrorCode lvt_8_1_ = this.theStream.sendEndSpanMetaData(this.authenticationToken, p_177947_1_, p_177947_2_, p_177947_4_, p_177947_6_, p_177947_7_);
    ...
    public void func_152821_H()
    {
        ...
        {
            ErrorCode lvt_1_1_ = this.theStream.pollTasks();
            this.func_152853_a(lvt_1_1_);
            ...
            switch (this.broadcastState)
            {
                case Authenticated:
                    ...
                    lvt_1_1_ = this.theStream.login(this.authenticationToken);
                ...
                case LoggedIn:
                    ...
                    lvt_1_1_ = this.theStream.getIngestServers(this.authenticationToken);
                ...
                case ReceivedIngestServers:
                    this.func_152827_a(BroadcastController.BroadcastState.ReadyToBroadcast);
                    lvt_1_1_ = this.theStream.getUserInfo(this.authenticationToken);
                    ...
                    this.func_152835_I();
                    lvt_1_1_ = this.theStream.getArchivingState(this.authenticationToken);
    ...
    protected void func_152835_I()
    {
        ...
        if (lvt_3_1_ >= 30L)
        {
            ...
            ErrorCode lvt_5_1_ = this.theStream.getStreamInfo(this.authenticationToken, this.field_152880_p);

            if (ErrorCode.failed(lvt_5_1_))
            {
                String lvt_6_1_ = ErrorCode.getString(lvt_5_1_);
                this.logError(String.format("Error in TTV_GetStreamInfo: %s", new Object[] {lvt_6_1_}));
            }
        }
    }
    ...
    protected boolean func_152823_L()
    {
        ...
        {
            FrameBuffer lvt_2_1_ = this.theStream.allocateFrameBuffer(this.videoParamaters.outputWidth * this.videoParamaters.outputHeight * 4);
    ...
    public void captureFramebuffer(FrameBuffer p_152846_1_)
    {
        ...
        {
            CrashReport lvt_3_1_ = CrashReport.makeCrashReport(var5, "Trying to submit a frame to Twitch");
            CrashReportCategory lvt_4_1_ = lvt_3_1_.makeCategory("Broadcast State");
            lvt_4_1_.addCrashSection("Last reported errors", Arrays.toString(field_152862_C.func_152756_c()));
            lvt_4_1_.addCrashSection("Buffer", p_152846_1_);
            lvt_4_1_.addCrashSection("Free buffer count", Integer.valueOf(this.field_152875_k.size()));
            lvt_4_1_.addCrashSection("Capture buffer count", Integer.valueOf(this.field_152874_j.size()));
    ...
    public ErrorCode submitStreamFrame(FrameBuffer frame)
    {
        ...
        ErrorCode lvt_2_1_ = this.theStream.submitVideoFrame(frame);
        ...
        if (lvt_2_1_ != ErrorCode.TTV_EC_SUCCESS)
        {
            ...
            if (this.broadcastListener != null)
            {
                this.broadcastListener.func_152893_b(lvt_2_1_);
            }
        }
