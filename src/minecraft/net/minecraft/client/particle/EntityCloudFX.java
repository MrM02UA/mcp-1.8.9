...
public class EntityCloudFX extends EntityFX
{
    ...
    protected EntityCloudFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double p_i1221_8_, double p_i1221_10_, double p_i1221_12_)
    {
        ...
        this.particleScale *= lvt_14_1_;
        this.field_70569_a = this.particleScale;
        this.particleMaxAge = (int)(8.0D / (Math.random() * 0.8D + 0.3D));
        this.particleMaxAge = (int)((float)this.particleMaxAge * lvt_14_1_);
        this.noClip = false;
    }
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        this.particleScale = this.field_70569_a * lvt_9_1_;
    ...
    public void onUpdate()
    {
        ...
        EntityPlayer lvt_1_1_ = this.worldObj.getClosestPlayerToEntity(this, 2.0D);

        if (lvt_1_1_ != null && this.posY > lvt_1_1_.getEntityBoundingBox().minY)
        {
            this.posY += (lvt_1_1_.getEntityBoundingBox().minY - this.posY) * 0.2D;
            this.motionY += (lvt_1_1_.motionY - this.motionY) * 0.2D;
