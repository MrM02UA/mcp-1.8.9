...
public class EntitySpellParticleFX extends EntityFX
{
    ...
    public static class AmbientMobFactory implements IParticleFactory
    {
        ...
        {
            EntityFX lvt_16_1_ = new EntitySpellParticleFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            lvt_16_1_.setAlphaF(0.15F);
            lvt_16_1_.setRBGColorF((float)xSpeedIn, (float)ySpeedIn, (float)zSpeedIn);
            return lvt_16_1_;
        }
    }
    ...
    public static class InstantFactory implements IParticleFactory
    {
        ...
        {
            EntityFX lvt_16_1_ = new EntitySpellParticleFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            ((EntitySpellParticleFX)lvt_16_1_).setBaseSpellTextureIndex(144);
            return lvt_16_1_;
        }
    }
    ...
    public static class WitchFactory implements IParticleFactory
    {
        public EntityFX getEntityFX(int particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int... p_178902_15_)
        {
            EntityFX lvt_16_1_ = new EntitySpellParticleFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            ((EntitySpellParticleFX)lvt_16_1_).setBaseSpellTextureIndex(144);
            float lvt_17_1_ = worldIn.rand.nextFloat() * 0.5F + 0.35F;
            lvt_16_1_.setRBGColorF(1.0F * lvt_17_1_, 0.0F * lvt_17_1_, 1.0F * lvt_17_1_);
            return lvt_16_1_;
        }
    }
}
