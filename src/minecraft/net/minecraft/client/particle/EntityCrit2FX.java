...
public class EntityCrit2FX extends EntityFX
{
    ...
    public void renderParticle(WorldRenderer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
        ...
        this.particleScale = this.field_174839_a * lvt_9_1_;
    ...
    public static class MagicFactory implements IParticleFactory
    {
        public EntityFX getEntityFX(int particleID, World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, int... p_178902_15_)
        {
            EntityFX lvt_16_1_ = new EntityCrit2FX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn);
            lvt_16_1_.setRBGColorF(lvt_16_1_.getRedColorF() * 0.3F, lvt_16_1_.getGreenColorF() * 0.8F, lvt_16_1_.getBlueColorF());
            lvt_16_1_.nextTextureIndexX();
            return lvt_16_1_;
        }
    }
}
