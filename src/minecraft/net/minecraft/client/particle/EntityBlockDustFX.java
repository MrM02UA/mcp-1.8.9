...
public class EntityBlockDustFX extends EntityDiggingFX
{
    ...
    public static class Factory implements IParticleFactory
    {
        ...
        {
            IBlockState lvt_16_1_ = Block.getStateById(p_178902_15_[0]);
            return lvt_16_1_.getBlock().getRenderType() == -1 ? null : (new EntityBlockDustFX(worldIn, xCoordIn, yCoordIn, zCoordIn, xSpeedIn, ySpeedIn, zSpeedIn, lvt_16_1_)).func_174845_l();
        }
    }
}
