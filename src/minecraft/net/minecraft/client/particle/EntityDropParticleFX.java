...
public class EntityDropParticleFX extends EntityFX
{
    ...
    public void onUpdate()
    {
        ...
        Material lvt_3_1_ = lvt_2_1_.getBlock().getMaterial();

        if (lvt_3_1_.isLiquid() || lvt_3_1_.isSolid())
        {
            double lvt_4_1_ = 0.0D;

            if (lvt_2_1_.getBlock() instanceof BlockLiquid)
            {
                lvt_4_1_ = (double)BlockLiquid.getLiquidHeightPercent(((Integer)lvt_2_1_.getValue(BlockLiquid.LEVEL)).intValue());
            }

            double lvt_6_1_ = (double)(MathHelper.floor_double(this.posY) + 1) - lvt_4_1_;
