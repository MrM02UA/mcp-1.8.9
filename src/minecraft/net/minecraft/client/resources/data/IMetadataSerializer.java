...
public class IMetadataSerializer
{
    ...
    public <T extends IMetadataSection> T parseMetadataSection(String sectionName, JsonObject json)
    {
        ...
        {
            IMetadataSerializer.Registration<?> lvt_3_1_ = (IMetadataSerializer.Registration)this.metadataSectionSerializerRegistry.getObject(sectionName);
            ...
            {
                return (T)((IMetadataSection)this.getGson().fromJson(json.getAsJsonObject(sectionName), lvt_3_1_.clazz));
            }
        }
    }
