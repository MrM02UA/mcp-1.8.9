...
public class WeightedBakedModel implements IBakedModel
{
    ...
    static class MyWeighedRandomItem extends WeightedRandom.Item implements Comparable<WeightedBakedModel.MyWeighedRandomItem>
    {
        ...
        {
            int lvt_1_1_ = this.model.getGeneralQuads().size();

            for (EnumFacing lvt_5_1_ : EnumFacing.values())
            {
                lvt_1_1_ += this.model.getFaceQuads(lvt_5_1_).size();
            }
        ...
        {
            return this.compareTo((WeightedBakedModel.MyWeighedRandomItem)p_compareTo_1_);
        }
    }
}
