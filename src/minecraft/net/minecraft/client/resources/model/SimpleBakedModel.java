...
public class SimpleBakedModel implements IBakedModel
{
    ...
    public static class Builder
    {
        ...
        public Builder(IBakedModel bakedModel, TextureAtlasSprite texture)
        {
            ...
            {
                this.addFaceBreakingFours(bakedModel, texture, lvt_6_1_);
            }
        ...
        {
            for (BakedQuad lvt_5_1_ : bakedModel.getFaceQuads(facing))
            {
                this.addFaceQuad(facing, new BreakingFour(lvt_5_1_, texture));
            }
        }

        private void addGeneralBreakingFours(IBakedModel p_177647_1_, TextureAtlasSprite texture)
        {
            for (BakedQuad lvt_4_1_ : p_177647_1_.getGeneralQuads())
            {
                this.addGeneralQuad(new BreakingFour(lvt_4_1_, texture));
            }
        }
