...
public abstract class AbstractResourcePack implements IResourcePack
{
    ...
    static <T extends IMetadataSection> T readMetadata(IMetadataSerializer p_110596_0_, InputStream p_110596_1_, String p_110596_2_)
    {
        ...
        try
        {
            lvt_4_1_ = new BufferedReader(new InputStreamReader(p_110596_1_, Charsets.UTF_8));
            lvt_3_1_ = (new JsonParser()).parse(lvt_4_1_).getAsJsonObject();
        }
        ...
        return p_110596_0_.parseMetadataSection(p_110596_2_, lvt_3_1_);
    }
