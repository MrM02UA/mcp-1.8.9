...
public class MovingSoundMinecartRiding extends MovingSound
{
    ...
    public void update()
    {
        ...
        {
            float lvt_1_1_ = MathHelper.sqrt_double(this.minecart.motionX * this.minecart.motionX + this.minecart.motionZ * this.minecart.motionZ);

            if ((double)lvt_1_1_ >= 0.01D)
            {
                this.volume = 0.0F + MathHelper.clamp_float(lvt_1_1_, 0.0F, 1.0F) * 0.75F;
            }
            else
            {
                this.volume = 0.0F;
