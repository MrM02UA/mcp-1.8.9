...
public class ModelBiped extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        {
            float lvt_8_1_ = this.swingProgress;
            this.bipedBody.rotateAngleY = MathHelper.sin(MathHelper.sqrt_float(lvt_8_1_) * (float)Math.PI * 2.0F) * 0.2F;
            ...
            lvt_8_1_ = 1.0F - this.swingProgress;
            lvt_8_1_ = lvt_8_1_ * lvt_8_1_;
            lvt_8_1_ = lvt_8_1_ * lvt_8_1_;
            lvt_8_1_ = 1.0F - lvt_8_1_;
            float lvt_9_1_ = MathHelper.sin(lvt_8_1_ * (float)Math.PI);
            float lvt_10_1_ = MathHelper.sin(this.swingProgress * (float)Math.PI) * -(this.bipedHead.rotateAngleX - 0.7F) * 0.75F;
            this.bipedRightArm.rotateAngleX = (float)((double)this.bipedRightArm.rotateAngleX - ((double)lvt_9_1_ * 1.2D + (double)lvt_10_1_));
        ...
        if (this.aimedBow)
        {
            ...
            this.bipedRightArm.rotateAngleX -= lvt_8_2_ * 1.2F - lvt_9_2_ * 0.4F;
            this.bipedLeftArm.rotateAngleX -= lvt_8_2_ * 1.2F - lvt_9_2_ * 0.4F;
            this.bipedRightArm.rotateAngleZ += MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F;
            this.bipedLeftArm.rotateAngleZ -= MathHelper.cos(ageInTicks * 0.09F) * 0.05F + 0.05F;
            this.bipedRightArm.rotateAngleX += MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
            this.bipedLeftArm.rotateAngleX -= MathHelper.sin(ageInTicks * 0.067F) * 0.05F;
    ...
    public void setModelAttributes(ModelBase model)
    {
        ...
        {
            ModelBiped lvt_2_1_ = (ModelBiped)model;
            this.heldItemLeft = lvt_2_1_.heldItemLeft;
            this.heldItemRight = lvt_2_1_.heldItemRight;
            this.isSneak = lvt_2_1_.isSneak;
            this.aimedBow = lvt_2_1_.aimedBow;
        }
    }
