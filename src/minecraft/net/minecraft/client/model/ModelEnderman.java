...
public class ModelEnderman extends ModelBiped
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.bipedBody.rotationPointY = lvt_8_1_;
        ...
        if (this.bipedRightArm.rotateAngleX > lvt_9_1_)
        {
            this.bipedRightArm.rotateAngleX = lvt_9_1_;
        }

        if (this.bipedLeftArm.rotateAngleX > lvt_9_1_)
        {
        ...
        if (this.bipedRightLeg.rotateAngleX > lvt_9_1_)
        {
            this.bipedRightLeg.rotateAngleX = lvt_9_1_;
        }

        if (this.bipedLeftLeg.rotateAngleX > lvt_9_1_)
        {
            this.bipedLeftLeg.rotateAngleX = lvt_9_1_;
        }
        ...
        this.bipedRightLeg.rotationPointY = 9.0F + lvt_8_1_;
        this.bipedLeftLeg.rotationPointY = 9.0F + lvt_8_1_;
        this.bipedHead.rotationPointZ = -0.0F;
        this.bipedHead.rotationPointY = lvt_8_1_ + 1.0F;
        ...
        if (this.isAttacking)
        {
            ...
            this.bipedHead.rotationPointY -= lvt_10_1_ * 5.0F;
        }
    }
}
