...
public class ModelWither extends ModelBase
{
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        for (ModelRenderer lvt_11_1_ : this.field_82904_b)
        {
            lvt_11_1_.render(scale);
        }

        for (ModelRenderer lvt_11_2_ : this.field_82905_a)
        {
            lvt_11_2_.render(scale);
        }
    }
    ...
    {
        float lvt_8_1_ = MathHelper.cos(ageInTicks * 0.1F);
        this.field_82905_a[1].rotateAngleX = (0.065F + 0.05F * lvt_8_1_) * (float)Math.PI;
        ...
        this.field_82905_a[2].rotateAngleX = (0.265F + 0.1F * lvt_8_1_) * (float)Math.PI;
    ...
    {
        EntityWither lvt_5_1_ = (EntityWither)entitylivingbaseIn;

        for (int lvt_6_1_ = 1; lvt_6_1_ < 3; ++lvt_6_1_)
        {
            this.field_82904_b[lvt_6_1_].rotateAngleY = (lvt_5_1_.func_82207_a(lvt_6_1_ - 1) - entitylivingbaseIn.renderYawOffset) / (180F / (float)Math.PI);
            this.field_82904_b[lvt_6_1_].rotateAngleX = lvt_5_1_.func_82210_r(lvt_6_1_ - 1) / (180F / (float)Math.PI);
        }
    }
}
