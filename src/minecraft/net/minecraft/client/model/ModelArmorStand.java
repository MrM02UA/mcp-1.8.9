...
public class ModelArmorStand extends ModelArmorStandArmor
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityArmorStand)
        {
            ...
            this.bipedLeftLeg.setRotationPoint(1.9F, 12.0F, 0.0F);
            this.bipedRightLeg.setRotationPoint(-1.9F, 12.0F, 0.0F);
            this.standRightSide.rotateAngleX = 0.017453292F * lvt_8_1_.getBodyRotation().getX();
            this.standRightSide.rotateAngleY = 0.017453292F * lvt_8_1_.getBodyRotation().getY();
            this.standRightSide.rotateAngleZ = 0.017453292F * lvt_8_1_.getBodyRotation().getZ();
            this.standLeftSide.rotateAngleX = 0.017453292F * lvt_8_1_.getBodyRotation().getX();
            this.standLeftSide.rotateAngleY = 0.017453292F * lvt_8_1_.getBodyRotation().getY();
            this.standLeftSide.rotateAngleZ = 0.017453292F * lvt_8_1_.getBodyRotation().getZ();
            this.standWaist.rotateAngleX = 0.017453292F * lvt_8_1_.getBodyRotation().getX();
            this.standWaist.rotateAngleY = 0.017453292F * lvt_8_1_.getBodyRotation().getY();
            this.standWaist.rotateAngleZ = 0.017453292F * lvt_8_1_.getBodyRotation().getZ();
            float lvt_9_1_ = (lvt_8_1_.getLeftLegRotation().getX() + lvt_8_1_.getRightLegRotation().getX()) / 2.0F;
            float lvt_10_1_ = (lvt_8_1_.getLeftLegRotation().getY() + lvt_8_1_.getRightLegRotation().getY()) / 2.0F;
            float lvt_11_1_ = (lvt_8_1_.getLeftLegRotation().getZ() + lvt_8_1_.getRightLegRotation().getZ()) / 2.0F;
    ...
    {
        boolean lvt_2_1_ = this.bipedRightArm.showModel;
        this.bipedRightArm.showModel = true;
        super.postRenderArm(scale);
        this.bipedRightArm.showModel = lvt_2_1_;
    }
}
