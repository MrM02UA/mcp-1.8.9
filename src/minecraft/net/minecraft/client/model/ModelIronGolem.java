...
public class ModelIronGolem extends ModelBase
{
    ...
    public ModelIronGolem(float p_i46362_1_, float p_i46362_2_)
    {
        int lvt_3_1_ = 128;
        int lvt_4_1_ = 128;
        this.ironGolemHead = (new ModelRenderer(this)).setTextureSize(lvt_3_1_, lvt_4_1_);
        ...
        this.ironGolemBody = (new ModelRenderer(this)).setTextureSize(lvt_3_1_, lvt_4_1_);
        ...
        this.ironGolemRightArm = (new ModelRenderer(this)).setTextureSize(lvt_3_1_, lvt_4_1_);
        this.ironGolemRightArm.setRotationPoint(0.0F, -7.0F, 0.0F);
        this.ironGolemRightArm.setTextureOffset(60, 21).addBox(-13.0F, -2.5F, -3.0F, 4, 30, 6, p_i46362_1_);
        this.ironGolemLeftArm = (new ModelRenderer(this)).setTextureSize(lvt_3_1_, lvt_4_1_);
        this.ironGolemLeftArm.setRotationPoint(0.0F, -7.0F, 0.0F);
        this.ironGolemLeftArm.setTextureOffset(60, 58).addBox(9.0F, -2.5F, -3.0F, 4, 30, 6, p_i46362_1_);
        this.ironGolemLeftLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(lvt_3_1_, lvt_4_1_);
        ...
        this.ironGolemRightLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(lvt_3_1_, lvt_4_1_);
    ...
    {
        EntityIronGolem lvt_5_1_ = (EntityIronGolem)entitylivingbaseIn;
        int lvt_6_1_ = lvt_5_1_.getAttackTimer();

        if (lvt_6_1_ > 0)
        {
            this.ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a((float)lvt_6_1_ - partialTickTime, 10.0F);
            this.ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * this.func_78172_a((float)lvt_6_1_ - partialTickTime, 10.0F);
        }
        else
        {
            ...
            if (lvt_7_1_ > 0)
            {
                this.ironGolemRightArm.rotateAngleX = -0.8F + 0.025F * this.func_78172_a((float)lvt_7_1_, 70.0F);
