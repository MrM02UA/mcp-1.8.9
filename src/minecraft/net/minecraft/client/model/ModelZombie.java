...
public class ModelZombie extends ModelBiped
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        float lvt_8_1_ = MathHelper.sin(this.swingProgress * (float)Math.PI);
        float lvt_9_1_ = MathHelper.sin((1.0F - (1.0F - this.swingProgress) * (1.0F - this.swingProgress)) * (float)Math.PI);
        ...
        this.bipedRightArm.rotateAngleX -= lvt_8_1_ * 1.2F - lvt_9_1_ * 0.4F;
        this.bipedLeftArm.rotateAngleX -= lvt_8_1_ * 1.2F - lvt_9_1_ * 0.4F;
