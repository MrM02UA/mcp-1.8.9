...
public class ModelRabbit extends ModelBase
{
    ...
    {
        float lvt_8_1_ = ageInTicks - (float)entityIn.ticksExisted;
        EntityRabbit lvt_9_1_ = (EntityRabbit)entityIn;
        ...
        this.field_178701_m = MathHelper.sin(lvt_9_1_.func_175521_o(lvt_8_1_) * (float)Math.PI);
