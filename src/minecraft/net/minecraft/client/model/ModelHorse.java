...
public class ModelHorse extends ModelBase
{
    ...
    {
        EntityHorse lvt_8_1_ = (EntityHorse)entityIn;
        int lvt_9_1_ = lvt_8_1_.getHorseType();
        float lvt_10_1_ = lvt_8_1_.getGrassEatingAmount(0.0F);
        boolean lvt_11_1_ = lvt_8_1_.isAdultHorse();
        boolean lvt_12_1_ = lvt_11_1_ && lvt_8_1_.isHorseSaddled();
        boolean lvt_13_1_ = lvt_11_1_ && lvt_8_1_.isChested();
        boolean lvt_14_1_ = lvt_9_1_ == 1 || lvt_9_1_ == 2;
        float lvt_15_1_ = lvt_8_1_.getHorseSize();
        boolean lvt_16_1_ = lvt_8_1_.riddenByEntity != null;
        ...
        if (!lvt_11_1_)
        {
            ...
            GlStateManager.scale(lvt_15_1_, 0.5F + lvt_15_1_ * 0.5F, lvt_15_1_);
            GlStateManager.translate(0.0F, 0.95F * (1.0F - lvt_15_1_), 0.0F);
        }
        ...
        if (!lvt_11_1_)
        {
            ...
            GlStateManager.translate(0.0F, 1.35F * (1.0F - lvt_15_1_), 0.0F);
        }
        ...
        if (!lvt_11_1_)
        {
            ...
            GlStateManager.scale(lvt_17_1_, lvt_17_1_, lvt_17_1_);
            ...
            {
                GlStateManager.translate(0.0F, 0.9F * (1.0F - lvt_15_1_) * lvt_10_1_ + 1.35F * (1.0F - lvt_15_1_) * (1.0F - lvt_10_1_), 0.15F * (1.0F - lvt_15_1_) * lvt_10_1_);
            }
        }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        float lvt_5_1_ = this.updateHorseRotation(entitylivingbaseIn.prevRenderYawOffset, entitylivingbaseIn.renderYawOffset, partialTickTime);
        float lvt_6_1_ = this.updateHorseRotation(entitylivingbaseIn.prevRotationYawHead, entitylivingbaseIn.rotationYawHead, partialTickTime);
        float lvt_7_1_ = entitylivingbaseIn.prevRotationPitch + (entitylivingbaseIn.rotationPitch - entitylivingbaseIn.prevRotationPitch) * partialTickTime;
        float lvt_8_1_ = lvt_6_1_ - lvt_5_1_;
        float lvt_9_1_ = lvt_7_1_ / (180F / (float)Math.PI);
        ...
        if (p_78086_3_ > 0.2F)
        {
            lvt_9_1_ += MathHelper.cos(p_78086_2_ * 0.4F) * 0.15F * p_78086_3_;
        }

        EntityHorse lvt_10_1_ = (EntityHorse)entitylivingbaseIn;
        float lvt_11_1_ = lvt_10_1_.getGrassEatingAmount(partialTickTime);
        float lvt_12_1_ = lvt_10_1_.getRearingAmount(partialTickTime);
        float lvt_13_1_ = 1.0F - lvt_12_1_;
        float lvt_14_1_ = lvt_10_1_.getMouthOpennessAngle(partialTickTime);
        boolean lvt_15_1_ = lvt_10_1_.field_110278_bp != 0;
        boolean lvt_16_1_ = lvt_10_1_.isHorseSaddled();
        boolean lvt_17_1_ = lvt_10_1_.riddenByEntity != null;
        float lvt_18_1_ = (float)entitylivingbaseIn.ticksExisted + partialTickTime;
        float lvt_19_1_ = MathHelper.cos(p_78086_2_ * 0.6662F + (float)Math.PI);
        ...
        this.head.rotateAngleY = lvt_8_1_ / (180F / (float)Math.PI);
        this.head.rotateAngleX = lvt_12_1_ * (0.2617994F + lvt_9_1_) + lvt_11_1_ * 2.18166F + (1.0F - Math.max(lvt_12_1_, lvt_11_1_)) * this.head.rotateAngleX;
        this.head.rotateAngleY = lvt_12_1_ * lvt_8_1_ / (180F / (float)Math.PI) + (1.0F - Math.max(lvt_12_1_, lvt_11_1_)) * this.head.rotateAngleY;
        ...
        this.body.rotateAngleX = lvt_12_1_ * -45.0F / (180F / (float)Math.PI) + lvt_13_1_ * this.body.rotateAngleX;
        ...
        this.field_178711_b.rotationPointZ = 0.02F - lvt_14_1_ * 1.0F;
        this.field_178712_c.rotationPointZ = 0.0F + lvt_14_1_ * 1.0F;
        ...
        this.field_178711_b.rotateAngleX = 0.0F - 0.09424778F * lvt_14_1_;
        this.field_178712_c.rotateAngleX = 0.0F + 0.15707964F * lvt_14_1_;
        ...
        float lvt_21_1_ = ((float)Math.PI / 2F);
        float lvt_22_1_ = ((float)Math.PI * 3F / 2F);
        float lvt_23_1_ = -1.0471976F;
        float lvt_24_1_ = 0.2617994F * lvt_12_1_;
        float lvt_25_1_ = MathHelper.cos(lvt_18_1_ * 0.6F + (float)Math.PI);
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + MathHelper.sin(((float)Math.PI / 2F) + lvt_24_1_ + lvt_13_1_ * -lvt_19_1_ * 0.5F * p_78086_3_) * 7.0F;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + MathHelper.cos(((float)Math.PI * 3F / 2F) + lvt_24_1_ + lvt_13_1_ * -lvt_19_1_ * 0.5F * p_78086_3_) * 7.0F;
        this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + MathHelper.sin(((float)Math.PI / 2F) + lvt_24_1_ + lvt_13_1_ * lvt_19_1_ * 0.5F * p_78086_3_) * 7.0F;
        this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + MathHelper.cos(((float)Math.PI * 3F / 2F) + lvt_24_1_ + lvt_13_1_ * lvt_19_1_ * 0.5F * p_78086_3_) * 7.0F;
        ...
        this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + MathHelper.sin(((float)Math.PI / 2F) + lvt_26_1_) * 7.0F;
        this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + MathHelper.cos(((float)Math.PI * 3F / 2F) + lvt_26_1_) * 7.0F;
        this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + MathHelper.sin(((float)Math.PI / 2F) + lvt_27_1_) * 7.0F;
        this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + MathHelper.cos(((float)Math.PI * 3F / 2F) + lvt_27_1_) * 7.0F;
        this.backLeftLeg.rotateAngleX = lvt_24_1_ + -lvt_19_1_ * 0.5F * p_78086_3_ * lvt_13_1_;
        this.backLeftShin.rotateAngleX = -0.08726646F * lvt_12_1_ + (-lvt_19_1_ * 0.5F * p_78086_3_ - Math.max(0.0F, lvt_19_1_ * 0.5F * p_78086_3_)) * lvt_13_1_;
        this.backLeftHoof.rotateAngleX = this.backLeftShin.rotateAngleX;
        this.backRightLeg.rotateAngleX = lvt_24_1_ + lvt_19_1_ * 0.5F * p_78086_3_ * lvt_13_1_;
        this.backRightShin.rotateAngleX = -0.08726646F * lvt_12_1_ + (lvt_19_1_ * 0.5F * p_78086_3_ - Math.max(0.0F, -lvt_19_1_ * 0.5F * p_78086_3_)) * lvt_13_1_;
        this.backRightHoof.rotateAngleX = this.backRightShin.rotateAngleX;
        this.frontLeftLeg.rotateAngleX = lvt_26_1_;
        this.frontLeftShin.rotateAngleX = (this.frontLeftLeg.rotateAngleX + (float)Math.PI * Math.max(0.0F, 0.2F + lvt_25_1_ * 0.2F)) * lvt_12_1_ + (lvt_20_1_ + Math.max(0.0F, lvt_19_1_ * 0.5F * p_78086_3_)) * lvt_13_1_;
        this.frontLeftHoof.rotateAngleX = this.frontLeftShin.rotateAngleX;
        this.frontRightLeg.rotateAngleX = lvt_27_1_;
        this.frontRightShin.rotateAngleX = (this.frontRightLeg.rotateAngleX + (float)Math.PI * Math.max(0.0F, 0.2F - lvt_25_1_ * 0.2F)) * lvt_12_1_ + (-lvt_20_1_ + Math.max(0.0F, -lvt_19_1_ * 0.5F * p_78086_3_)) * lvt_13_1_;
        ...
        this.tailBase.rotateAngleX = lvt_21_1_;
        this.tailMiddle.rotateAngleX = lvt_21_1_;
        this.tailTip.rotateAngleX = -0.2618F + lvt_21_1_;
    }
}
