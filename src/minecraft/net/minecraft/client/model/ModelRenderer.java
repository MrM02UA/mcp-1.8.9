...
public class ModelRenderer
{
    ...
    public ModelRenderer addBox(String partName, float offX, float offY, float offZ, int width, int height, int depth)
    {
        ...
        TextureOffset lvt_8_1_ = this.baseModel.getTextureOffset(partName);
        this.setTextureOffset(lvt_8_1_.textureOffsetX, lvt_8_1_.textureOffsetY);
            ...
            if (this.showModel)
            {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
                {
                    if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F)
                    {
                        ...
                        if (this.childModels != null)
                        {
                            for (int lvt_2_3_ = 0; lvt_2_3_ < this.childModels.size(); ++lvt_2_3_)
                            {
                                ((ModelRenderer)this.childModels.get(lvt_2_3_)).render(p_78785_1_);
                            }
                        }
                    }
                    else
                    {
                        ...
                        if (this.childModels != null)
                        {
                            for (int lvt_2_2_ = 0; lvt_2_2_ < this.childModels.size(); ++lvt_2_2_)
                            {
                                ((ModelRenderer)this.childModels.get(lvt_2_2_)).render(p_78785_1_);
                            }
                        }
                ...
                else
                {
                    ...
                    if (this.childModels != null)
                    {
                        for (int lvt_2_1_ = 0; lvt_2_1_ < this.childModels.size(); ++lvt_2_1_)
                        {
                            ((ModelRenderer)this.childModels.get(lvt_2_1_)).render(p_78785_1_);
                        }
                    }
    ...
    private void compileDisplayList(float scale)
    {
        ...
        WorldRenderer lvt_2_1_ = Tessellator.getInstance().getWorldRenderer();

        for (int lvt_3_1_ = 0; lvt_3_1_ < this.cubeList.size(); ++lvt_3_1_)
        {
            ((ModelBox)this.cubeList.get(lvt_3_1_)).render(lvt_2_1_, scale);
        }
