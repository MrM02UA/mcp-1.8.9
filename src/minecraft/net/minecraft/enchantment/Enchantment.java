...
public abstract class Enchantment
{
    ...
    {
        String lvt_2_1_ = StatCollector.translateToLocal(this.getName());
        return lvt_2_1_ + " " + StatCollector.translateToLocal("enchantment.level." + level);
    }
    ...
    static
    {
        ...
        for (Enchantment lvt_4_1_ : enchantmentsList)
        {
            if (lvt_4_1_ != null)
            {
        ...
        enchantmentsBookList = (Enchantment[])lvt_0_1_.toArray(new Enchantment[lvt_0_1_.size()]);
    }
}
