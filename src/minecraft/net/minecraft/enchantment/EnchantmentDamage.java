...
public class EnchantmentDamage extends Enchantment
{
    ...
    public void onEntityDamaged(EntityLivingBase user, Entity target, int level)
    {
        ...
        {
            EntityLivingBase lvt_4_1_ = (EntityLivingBase)target;

            if (this.damageType == 2 && lvt_4_1_.getCreatureAttribute() == EnumCreatureAttribute.ARTHROPOD)
            {
                int lvt_5_1_ = 20 + user.getRNG().nextInt(10 * level);
                lvt_4_1_.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, lvt_5_1_, 3));
            }
        }
    }
}
