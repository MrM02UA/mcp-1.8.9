...
public class NibbleArray
{
    ...
    {
        int lvt_2_1_ = this.getNibbleIndex(index);
        return this.isLowerNibble(index) ? this.data[lvt_2_1_] & 15 : this.data[lvt_2_1_] >> 4 & 15;
    }

    public void setIndex(int index, int value)
    {
        int lvt_3_1_ = this.getNibbleIndex(index);

        if (this.isLowerNibble(index))
        {
            this.data[lvt_3_1_] = (byte)(this.data[lvt_3_1_] & 240 | value & 15);
        }
        else
        {
            this.data[lvt_3_1_] = (byte)(this.data[lvt_3_1_] & 15 | (value & 15) << 4);
        }
    }
