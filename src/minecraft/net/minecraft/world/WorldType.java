...
public class WorldType
{
    ...
    {
        for (int lvt_1_1_ = 0; lvt_1_1_ < worldTypes.length; ++lvt_1_1_)
        {
            if (worldTypes[lvt_1_1_] != null && worldTypes[lvt_1_1_].worldType.equalsIgnoreCase(type))
            {
                return worldTypes[lvt_1_1_];
            }
        }
