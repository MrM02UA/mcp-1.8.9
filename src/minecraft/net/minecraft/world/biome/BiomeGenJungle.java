...
public class BiomeGenJungle extends BiomeGenBase
{
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos)
    {
        ...
        int lvt_6_1_ = rand.nextInt(worldIn.getHeight(pos.add(lvt_4_1_, 0, lvt_5_1_)).getY() * 2);
        (new WorldGenMelon()).generate(worldIn, rand, pos.add(lvt_4_1_, lvt_6_1_, lvt_5_1_));
        WorldGenVines lvt_4_2_ = new WorldGenVines();

        for (lvt_5_1_ = 0; lvt_5_1_ < 50; ++lvt_5_1_)
        {
            lvt_6_1_ = rand.nextInt(16) + 8;
            int lvt_7_1_ = 128;
            int lvt_8_1_ = rand.nextInt(16) + 8;
            lvt_4_2_.generate(worldIn, rand, pos.add(lvt_6_1_, 128, lvt_8_1_));
        }
    }
}
