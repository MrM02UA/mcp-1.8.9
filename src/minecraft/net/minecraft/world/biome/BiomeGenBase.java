...
public abstract class BiomeGenBase
{
    ...
    public final float getFloatTemperature(BlockPos pos)
    {
        if (pos.getY() > 64)
        {
            float lvt_2_1_ = (float)(temperatureNoise.func_151601_a((double)pos.getX() * 1.0D / 8.0D, (double)pos.getZ() * 1.0D / 8.0D) * 4.0D);
            return this.temperature - (lvt_2_1_ + (float)pos.getY() - 64.0F) * 0.05F / 30.0F;
        }
        else
        {
    ...
    {
        double lvt_2_1_ = (double)MathHelper.clamp_float(this.getFloatTemperature(pos), 0.0F, 1.0F);
        double lvt_4_1_ = (double)MathHelper.clamp_float(this.getFloatRainfall(), 0.0F, 1.0F);
        return ColorizerGrass.getGrassColor(lvt_2_1_, lvt_4_1_);
    }
    ...
    public int getFoliageColorAtPos(BlockPos pos)
    {
        double lvt_2_1_ = (double)MathHelper.clamp_float(this.getFloatTemperature(pos), 0.0F, 1.0F);
        double lvt_4_1_ = (double)MathHelper.clamp_float(this.getFloatRainfall(), 0.0F, 1.0F);
        return ColorizerFoliage.getFoliageColor(lvt_2_1_, lvt_4_1_);
    }
    ...
    {
        int lvt_8_1_ = worldIn.getSeaLevel();
        IBlockState lvt_9_1_ = this.topBlock;
        IBlockState lvt_10_1_ = this.fillerBlock;
        int lvt_11_1_ = -1;
        int lvt_12_1_ = (int)(noiseVal / 3.0D + 3.0D + rand.nextDouble() * 0.25D);
        int lvt_13_1_ = x & 15;
        int lvt_14_1_ = z & 15;
        ...
        {
            if (lvt_16_1_ <= rand.nextInt(5))
            {
                chunkPrimerIn.setBlockState(lvt_14_1_, lvt_16_1_, lvt_13_1_, Blocks.bedrock.getDefaultState());
            }
            else
            {
                IBlockState lvt_17_1_ = chunkPrimerIn.getBlockState(lvt_14_1_, lvt_16_1_, lvt_13_1_);

                if (lvt_17_1_.getBlock().getMaterial() == Material.air)
                {
                    lvt_11_1_ = -1;
                }
                else if (lvt_17_1_.getBlock() == Blocks.stone)
                {
                    if (lvt_11_1_ == -1)
                    {
                        if (lvt_12_1_ <= 0)
                        {
                            lvt_9_1_ = null;
                            lvt_10_1_ = Blocks.stone.getDefaultState();
                        }
                        else if (lvt_16_1_ >= lvt_8_1_ - 4 && lvt_16_1_ <= lvt_8_1_ + 1)
                        {
                            lvt_9_1_ = this.topBlock;
                            lvt_10_1_ = this.fillerBlock;
                        }

                        if (lvt_16_1_ < lvt_8_1_ && (lvt_9_1_ == null || lvt_9_1_.getBlock().getMaterial() == Material.air))
                        {
                            if (this.getFloatTemperature(lvt_15_1_.set(x, lvt_16_1_, z)) < 0.15F)
                            {
                                lvt_9_1_ = Blocks.ice.getDefaultState();
                            }
                            else
                            {
                                lvt_9_1_ = Blocks.water.getDefaultState();
                            }
                        }
                        ...
                        {
                            chunkPrimerIn.setBlockState(lvt_14_1_, lvt_16_1_, lvt_13_1_, lvt_9_1_);
                        }
                        else if (lvt_16_1_ < lvt_8_1_ - 7 - lvt_12_1_)
                        {
                            lvt_9_1_ = null;
                            lvt_10_1_ = Blocks.stone.getDefaultState();
                            chunkPrimerIn.setBlockState(lvt_14_1_, lvt_16_1_, lvt_13_1_, Blocks.gravel.getDefaultState());
                        }
                        else
                        {
                            chunkPrimerIn.setBlockState(lvt_14_1_, lvt_16_1_, lvt_13_1_, lvt_10_1_);
                        }
                    }
                    else if (lvt_11_1_ > 0)
                    {
                        ...
                        if (lvt_11_1_ == 0 && lvt_10_1_.getBlock() == Blocks.sand)
                        {
                            lvt_11_1_ = rand.nextInt(4) + Math.max(0, lvt_16_1_ - 63);
                            lvt_10_1_ = lvt_10_1_.getValue(BlockSand.VARIANT) == BlockSand.EnumType.RED_SAND ? Blocks.red_sandstone.getDefaultState() : Blocks.sandstone.getDefaultState();
                        }
                    }
                }
            }
    ...
    public static BiomeGenBase getBiomeFromBiomeList(int biomeId, BiomeGenBase biome)
    {
        ...
        {
            BiomeGenBase lvt_2_1_ = biomeList[biomeId];
            return lvt_2_1_ == null ? biome : lvt_2_1_;
        }
        else
        {
    ...
    static
    {
        ...
        for (BiomeGenBase lvt_3_1_ : biomeList)
        {
            if (lvt_3_1_ != null)
            {
                if (BIOME_ID_MAP.containsKey(lvt_3_1_.biomeName))
                {
                    throw new Error("Biome \"" + lvt_3_1_.biomeName + "\" is defined as both ID " + ((BiomeGenBase)BIOME_ID_MAP.get(lvt_3_1_.biomeName)).biomeID + " and " + lvt_3_1_.biomeID);
                }

                BIOME_ID_MAP.put(lvt_3_1_.biomeName, lvt_3_1_);

                if (lvt_3_1_.biomeID < 128)
                {
                    explorationBiomesList.add(lvt_3_1_);
                }
            }
        }
