    ...
    public void decorate(World worldIn, Random rand, BlockPos pos)
    {
        if (this.field_150644_aH == 1 || this.field_150644_aH == 2)
        {
            ...
            for (int lvt_5_1_ = 0; lvt_5_1_ < lvt_4_1_; ++lvt_5_1_)
            {
                ...
                field_150643_aG.generate(worldIn, rand, lvt_8_1_);
            }
        }
        ...
        for (int lvt_4_2_ = 0; lvt_4_2_ < 7; ++lvt_4_2_)
        {
            ...
            int lvt_7_2_ = rand.nextInt(worldIn.getHeight(pos.add(lvt_5_2_, 0, lvt_6_2_)).getY() + 32);
            DOUBLE_PLANT_GENERATOR.generate(worldIn, rand, pos.add(lvt_5_2_, lvt_7_2_, lvt_6_2_));
        }
