...
public class WorldInfo
{
    ...
    public WorldInfo(NBTTagCompound nbt)
    {
        ...
        {
            String lvt_2_1_ = nbt.getString("generatorName");
            this.terrainType = WorldType.parseWorldType(lvt_2_1_);
            ...
            else if (this.terrainType.isVersioned())
            {
                ...
                {
                    lvt_3_1_ = nbt.getInteger("generatorVersion");
                }

                this.terrainType = this.terrainType.getWorldTypeForGeneratorVersion(lvt_3_1_);
            }
    ...
    public NBTTagCompound getNBTTagCompound()
    {
        ...
        this.updateTagCompound(lvt_1_1_, this.playerTag);
        return lvt_1_1_;
    }
    ...
    public NBTTagCompound cloneNBTCompound(NBTTagCompound nbt)
    {
        ...
        this.updateTagCompound(lvt_2_1_, nbt);
        return lvt_2_1_;
    }
    ...
    public void addToCrashReport(CrashReportCategory category)
    {
        ...
        category.addCrashSectionCallable("Level storage version", new Callable<String>()
        {
            public String call() throws Exception
            {
                ...
                return String.format("0x%05X - %s", new Object[] {Integer.valueOf(WorldInfo.this.saveVersion), lvt_1_1_});
            }
            public Object call() throws Exception
            {
                return this.call();
