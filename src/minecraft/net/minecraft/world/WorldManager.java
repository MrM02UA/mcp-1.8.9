...
public class WorldManager implements IWorldAccess
{
    ...
    {
        for (EntityPlayerMP lvt_5_1_ : this.mcServer.getConfigurationManager().getPlayerList())
        {
            if (lvt_5_1_ != null && lvt_5_1_.worldObj == this.theWorldServer && lvt_5_1_.getEntityId() != breakerId)
            {
                double lvt_6_1_ = (double)pos.getX() - lvt_5_1_.posX;
                double lvt_8_1_ = (double)pos.getY() - lvt_5_1_.posY;
                double lvt_10_1_ = (double)pos.getZ() - lvt_5_1_.posZ;

                if (lvt_6_1_ * lvt_6_1_ + lvt_8_1_ * lvt_8_1_ + lvt_10_1_ * lvt_10_1_ < 1024.0D)
                {
                    lvt_5_1_.playerNetServerHandler.sendPacket(new S25PacketBlockBreakAnim(breakerId, pos, progress));
                }
            }
        }
    }
