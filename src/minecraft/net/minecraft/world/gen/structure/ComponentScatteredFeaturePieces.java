...
public class ComponentScatteredFeaturePieces
{
    ...
    public static class DesertPyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_1_, lvt_4_1_, lvt_4_1_, this.scatteredFeatureSizeX - 1 - lvt_4_1_, lvt_4_1_, this.scatteredFeatureSizeZ - 1 - lvt_4_1_, Blocks.sandstone.getDefaultState(), Blocks.sandstone.getDefaultState(), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_1_ + 1, lvt_4_1_, lvt_4_1_ + 1, this.scatteredFeatureSizeX - 2 - lvt_4_1_, lvt_4_1_, this.scatteredFeatureSizeZ - 2 - lvt_4_1_, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            }
            ...
            for (int lvt_4_2_ = 0; lvt_4_2_ < this.scatteredFeatureSizeX; ++lvt_4_2_)
            {
                ...
                {
                    int lvt_6_1_ = -5;
                    this.replaceAirAndLiquidDownwards(worldIn, Blocks.sandstone.getDefaultState(), lvt_4_2_, lvt_6_1_, lvt_5_1_, structureBoundingBoxIn);
                }
            }

            int lvt_4_3_ = this.getMetadataWithOffset(Blocks.sandstone_stairs, 3);
            int lvt_5_2_ = this.getMetadataWithOffset(Blocks.sandstone_stairs, 2);
            int lvt_6_2_ = this.getMetadataWithOffset(Blocks.sandstone_stairs, 0);
            int lvt_7_1_ = this.getMetadataWithOffset(Blocks.sandstone_stairs, 1);
            int lvt_8_1_ = ~EnumDyeColor.ORANGE.getDyeDamage() & 15;
            int lvt_9_1_ = ~EnumDyeColor.BLUE.getDyeDamage() & 15;
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), 2, 10, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_5_2_), 2, 10, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_6_2_), 0, 10, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_7_1_), 4, 10, 2, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), this.scatteredFeatureSizeX - 3, 10, 0, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_5_2_), this.scatteredFeatureSizeX - 3, 10, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_6_2_), this.scatteredFeatureSizeX - 5, 10, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_7_1_), this.scatteredFeatureSizeX - 1, 10, 2, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), 2, 4, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), 2, 3, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), this.scatteredFeatureSizeX - 3, 4, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_4_3_), this.scatteredFeatureSizeX - 3, 3, 4, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_7_1_), 2, 1, 2, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.sandstone_stairs.getStateFromMeta(lvt_6_2_), this.scatteredFeatureSizeX - 3, 1, 2, structureBoundingBoxIn);
            ...
            {
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), 4, 1, lvt_10_1_, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), 4, 2, lvt_10_1_, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), this.scatteredFeatureSizeX - 5, 1, lvt_10_1_, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), this.scatteredFeatureSizeX - 5, 2, lvt_10_1_, structureBoundingBoxIn);
            }

            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 10, 0, 7, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 10, 0, 8, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 9, 0, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 11, 0, 9, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 8, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 12, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 7, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 13, 0, 10, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 9, 0, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 11, 0, 11, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 10, 0, 12, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 10, 0, 13, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_9_1_), 10, 0, 10, structureBoundingBoxIn);

            for (int lvt_10_2_ = 0; lvt_10_2_ <= this.scatteredFeatureSizeX - 1; lvt_10_2_ += this.scatteredFeatureSizeX - 1)
            {
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 2, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 2, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 2, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 3, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 3, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 3, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 4, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), lvt_10_2_, 4, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 4, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 5, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 5, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 5, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 6, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), lvt_10_2_, 6, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 6, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 7, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 7, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_2_, 7, 3, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 8, 1, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 8, 2, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_2_, 8, 3, structureBoundingBoxIn);
            }

            for (int lvt_10_3_ = 2; lvt_10_3_ <= this.scatteredFeatureSizeX - 3; lvt_10_3_ += this.scatteredFeatureSizeX - 3 - 2)
            {
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ - 1, 2, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_, 2, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ + 1, 2, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ - 1, 3, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_, 3, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ + 1, 3, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ - 1, 4, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), lvt_10_3_, 4, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ + 1, 4, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ - 1, 5, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_, 5, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ + 1, 5, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ - 1, 6, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.CHISELED.getMetadata()), lvt_10_3_, 6, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ + 1, 6, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ - 1, 7, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_, 7, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), lvt_10_3_ + 1, 7, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ - 1, 8, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_, 8, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), lvt_10_3_ + 1, 8, 0, structureBoundingBoxIn);
            }
            ...
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 9, 5, 0, structureBoundingBoxIn);
            ...
            this.setBlockState(worldIn, Blocks.stained_hardened_clay.getStateFromMeta(lvt_8_1_), 11, 5, 0, structureBoundingBoxIn);
            ...
            for (EnumFacing lvt_11_1_ : EnumFacing.Plane.HORIZONTAL)
            {
                if (!this.hasPlacedChest[lvt_11_1_.getHorizontalIndex()])
                {
                    ...
                    this.hasPlacedChest[lvt_11_1_.getHorizontalIndex()] = this.generateChestContents(worldIn, structureBoundingBoxIn, randomIn, 10 + lvt_12_1_, -11, 10 + lvt_13_1_, WeightedRandomChestContent.func_177629_a(itemsToGenerateInTemple, new WeightedRandomChestContent[] {Items.enchanted_book.getRandom(randomIn)}), 2 + randomIn.nextInt(5));
                }
            }
        ...
        protected boolean func_74935_a(World worldIn, StructureBoundingBox p_74935_2_, int p_74935_3_)
        {
            ...
            else
            {
                ...
                for (int lvt_7_1_ = this.boundingBox.minZ; lvt_7_1_ <= this.boundingBox.maxZ; ++lvt_7_1_)
                {
                    ...
                    {
                        lvt_6_1_.set(lvt_8_1_, 64, lvt_7_1_);

                        if (p_74935_2_.isVecInside(lvt_6_1_))
                        {
                            lvt_4_1_ += Math.max(worldIn.getTopSolidOrLiquidBlock(lvt_6_1_).getY(), worldIn.provider.getAverageGroundLevel());
                            ++lvt_5_1_;
                        }
                    }
                }
    ...
    public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                int lvt_4_1_ = this.getMetadataWithOffset(Blocks.stone_stairs, 3);
                int lvt_5_1_ = this.getMetadataWithOffset(Blocks.stone_stairs, 2);
                int lvt_6_1_ = this.getMetadataWithOffset(Blocks.stone_stairs, 0);
                int lvt_7_1_ = this.getMetadataWithOffset(Blocks.stone_stairs, 1);
                ...
                {
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 4, lvt_8_1_, 2, 5, lvt_8_1_, false, randomIn, junglePyramidsRandomScatteredStones);
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 4, lvt_8_1_, 4, 5, lvt_8_1_, false, randomIn, junglePyramidsRandomScatteredStones);
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 7, 4, lvt_8_1_, 7, 5, lvt_8_1_, false, randomIn, junglePyramidsRandomScatteredStones);
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 9, 4, lvt_8_1_, 9, 5, lvt_8_1_, false, randomIn, junglePyramidsRandomScatteredStones);
                }
                ...
                for (int lvt_8_2_ = 0; lvt_8_2_ <= 11; lvt_8_2_ += 11)
                {
                    ...
                    {
                        this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, lvt_8_2_, 4, lvt_9_1_, lvt_8_2_, 5, lvt_9_1_, false, randomIn, junglePyramidsRandomScatteredStones);
                    }

                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, lvt_8_2_, 6, 5, lvt_8_2_, 6, 5, false, randomIn, junglePyramidsRandomScatteredStones);
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, lvt_8_2_, 6, 9, lvt_8_2_, 6, 9, false, randomIn, junglePyramidsRandomScatteredStones);
                }
                ...
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 5, 9, 6, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 6, 9, 6, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_5_1_), 5, 9, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_5_1_), 6, 9, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 4, 0, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 5, 0, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 6, 0, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 7, 0, 0, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 4, 1, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 4, 2, 9, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 4, 3, 10, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 7, 1, 8, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 7, 2, 9, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_4_1_), 7, 3, 10, structureBoundingBoxIn);
                ...
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_6_1_), 4, 4, 5, structureBoundingBoxIn);
                this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_7_1_), 7, 4, 5, structureBoundingBoxIn);

                for (int lvt_8_3_ = 0; lvt_8_3_ < 4; ++lvt_8_3_)
                {
                    this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_5_1_), 5, 0 - lvt_8_3_, 6 + lvt_8_3_, structureBoundingBoxIn);
                    this.setBlockState(worldIn, Blocks.stone_stairs.getStateFromMeta(lvt_5_1_), 6, 0 - lvt_8_3_, 6 + lvt_8_3_, structureBoundingBoxIn);
                    this.fillWithAir(worldIn, structureBoundingBoxIn, 5, 0 - lvt_8_3_, 7 + lvt_8_3_, 6, 0 - lvt_8_3_, 9 + lvt_8_3_);
                }
                ...
                {
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -3, lvt_8_4_, 1, -2, lvt_8_4_, false, randomIn, junglePyramidsRandomScatteredStones);
                }

                for (int lvt_8_5_ = 2; lvt_8_5_ <= 12; lvt_8_5_ += 2)
                {
                    this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, -1, lvt_8_5_, 3, -1, lvt_8_5_, false, randomIn, junglePyramidsRandomScatteredStones);
                }
    ...
    public static class SwampHut extends ComponentScatteredFeaturePieces.Feature
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            else
            {
                ...
                int lvt_5_1_ = this.getMetadataWithOffset(Blocks.oak_stairs, 1);
                int lvt_6_1_ = this.getMetadataWithOffset(Blocks.oak_stairs, 0);
                int lvt_7_1_ = this.getMetadataWithOffset(Blocks.oak_stairs, 2);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 1, 6, 4, 1, Blocks.spruce_stairs.getStateFromMeta(lvt_4_1_), Blocks.spruce_stairs.getStateFromMeta(lvt_4_1_), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 2, 0, 4, 7, Blocks.spruce_stairs.getStateFromMeta(lvt_6_1_), Blocks.spruce_stairs.getStateFromMeta(lvt_6_1_), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, 4, 2, 6, 4, 7, Blocks.spruce_stairs.getStateFromMeta(lvt_5_1_), Blocks.spruce_stairs.getStateFromMeta(lvt_5_1_), false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 8, 6, 4, 8, Blocks.spruce_stairs.getStateFromMeta(lvt_7_1_), Blocks.spruce_stairs.getStateFromMeta(lvt_7_1_), false);

                for (int lvt_8_1_ = 2; lvt_8_1_ <= 7; lvt_8_1_ += 5)
                {
                    for (int lvt_9_1_ = 1; lvt_9_1_ <= 5; lvt_9_1_ += 4)
                    {
                        this.replaceAirAndLiquidDownwards(worldIn, Blocks.log.getDefaultState(), lvt_9_1_, -1, lvt_8_1_, structureBoundingBoxIn);
                    }
                }

                if (!this.hasWitch)
                {
                    int lvt_8_2_ = this.getXWithOffset(2, 5);
                    int lvt_9_2_ = this.getYWithOffset(2);
                    int lvt_10_1_ = this.getZWithOffset(2, 5);

                    if (structureBoundingBoxIn.isVecInside(new BlockPos(lvt_8_2_, lvt_9_2_, lvt_10_1_)))
                    {
                        this.hasWitch = true;
                        EntityWitch lvt_11_1_ = new EntityWitch(worldIn);
                        lvt_11_1_.setLocationAndAngles((double)lvt_8_2_ + 0.5D, (double)lvt_9_2_, (double)lvt_10_1_ + 0.5D, 0.0F, 0.0F);
                        lvt_11_1_.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(lvt_8_2_, lvt_9_2_, lvt_10_1_)), (IEntityLivingData)null);
