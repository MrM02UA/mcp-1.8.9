...
public class StructureOceanMonumentPieces
{
    ...
    public static class DoubleXRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        {
            StructureOceanMonumentPieces.RoomDefinition lvt_4_1_ = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
            StructureOceanMonumentPieces.RoomDefinition lvt_5_1_ = this.field_175830_k;

            if (this.field_175830_k.field_175967_a / 25 > 0)
            {
                this.func_175821_a(worldIn, structureBoundingBoxIn, 8, 0, lvt_4_1_.field_175966_c[EnumFacing.DOWN.getIndex()]);
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 0, lvt_5_1_.field_175966_c[EnumFacing.DOWN.getIndex()]);
            }

            if (lvt_5_1_.field_175965_b[EnumFacing.UP.getIndex()] == null)
            {
                this.func_175819_a(worldIn, structureBoundingBoxIn, 1, 4, 1, 7, 4, 6, field_175828_a);
            }

            if (lvt_4_1_.field_175965_b[EnumFacing.UP.getIndex()] == null)
            {
    ...
    public static class DoubleXYRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            StructureOceanMonumentPieces.RoomDefinition lvt_4_1_ = this.field_175830_k.field_175965_b[EnumFacing.EAST.getIndex()];
            StructureOceanMonumentPieces.RoomDefinition lvt_5_1_ = this.field_175830_k;
            StructureOceanMonumentPieces.RoomDefinition lvt_6_1_ = lvt_5_1_.field_175965_b[EnumFacing.UP.getIndex()];
            StructureOceanMonumentPieces.RoomDefinition lvt_7_1_ = lvt_4_1_.field_175965_b[EnumFacing.UP.getIndex()];
            ...
            if (lvt_6_1_.field_175965_b[EnumFacing.UP.getIndex()] == null)
            {
                this.func_175819_a(worldIn, structureBoundingBoxIn, 1, 8, 1, 7, 8, 6, field_175828_a);
            }

            if (lvt_7_1_.field_175965_b[EnumFacing.UP.getIndex()] == null)
            {
            ...
            for (int lvt_8_1_ = 1; lvt_8_1_ <= 7; ++lvt_8_1_)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, lvt_8_1_, 0, 0, lvt_8_1_, 7, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, lvt_8_1_, 0, 15, lvt_8_1_, 7, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_8_1_, 0, 15, lvt_8_1_, 0, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_8_1_, 7, 14, lvt_8_1_, 7, lvt_9_1_, lvt_9_1_, false);
            }
    ...
    public static class DoubleYRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            StructureOceanMonumentPieces.RoomDefinition lvt_4_1_ = this.field_175830_k.field_175965_b[EnumFacing.UP.getIndex()];
            ...
            for (int lvt_6_1_ = 1; lvt_6_1_ <= 5; lvt_6_1_ += 4)
            {
                ...
                if (lvt_5_1_.field_175966_c[EnumFacing.SOUTH.getIndex()])
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 2, lvt_6_1_, lvt_7_1_, 2, lvt_6_1_ + 2, lvt_7_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, lvt_6_1_, lvt_7_1_, 5, lvt_6_1_ + 2, lvt_7_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, lvt_6_1_ + 2, lvt_7_1_, 4, lvt_6_1_ + 2, lvt_7_1_, field_175826_b, field_175826_b, false);
                }
                else
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, lvt_6_1_, lvt_7_1_, 7, lvt_6_1_ + 2, lvt_7_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, lvt_6_1_ + 1, lvt_7_1_, 7, lvt_6_1_ + 1, lvt_7_1_, field_175828_a, field_175828_a, false);
                }
                ...
                if (lvt_5_1_.field_175966_c[EnumFacing.WEST.getIndex()])
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_, 2, lvt_8_1_, lvt_6_1_ + 2, 2, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_, 5, lvt_8_1_, lvt_6_1_ + 2, 5, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_ + 2, 3, lvt_8_1_, lvt_6_1_ + 2, 4, field_175826_b, field_175826_b, false);
                }
                else
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_, 0, lvt_8_1_, lvt_6_1_ + 2, 7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_ + 1, 0, lvt_8_1_, lvt_6_1_ + 1, 7, field_175828_a, field_175828_a, false);
                }

                lvt_8_1_ = 7;

                if (lvt_5_1_.field_175966_c[EnumFacing.EAST.getIndex()])
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_, 2, lvt_8_1_, lvt_6_1_ + 2, 2, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_, 5, lvt_8_1_, lvt_6_1_ + 2, 5, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_8_1_, lvt_6_1_ + 2, 3, lvt_8_1_, lvt_6_1_ + 2, 4, field_175826_b, field_175826_b, false);
    ...
    public static class DoubleYZRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            StructureOceanMonumentPieces.RoomDefinition lvt_4_1_ = this.field_175830_k.field_175965_b[EnumFacing.NORTH.getIndex()];
            StructureOceanMonumentPieces.RoomDefinition lvt_5_1_ = this.field_175830_k;
            StructureOceanMonumentPieces.RoomDefinition lvt_6_1_ = lvt_4_1_.field_175965_b[EnumFacing.UP.getIndex()];
            StructureOceanMonumentPieces.RoomDefinition lvt_7_1_ = lvt_5_1_.field_175965_b[EnumFacing.UP.getIndex()];

            if (this.field_175830_k.field_175967_a / 25 > 0)
            {
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 8, lvt_4_1_.field_175966_c[EnumFacing.DOWN.getIndex()]);
                this.func_175821_a(worldIn, structureBoundingBoxIn, 0, 0, lvt_5_1_.field_175966_c[EnumFacing.DOWN.getIndex()]);
            }
            ...
            for (int lvt_8_1_ = 1; lvt_8_1_ <= 7; ++lvt_8_1_)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, lvt_8_1_, 0, 0, lvt_8_1_, 15, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 7, lvt_8_1_, 0, 7, lvt_8_1_, 15, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_8_1_, 0, 6, lvt_8_1_, 0, lvt_9_1_, lvt_9_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_8_1_, 15, 6, lvt_8_1_, 15, lvt_9_1_, lvt_9_1_, false);
            }
            ...
            for (int lvt_8_2_ = 1; lvt_8_2_ <= 7; ++lvt_8_2_)
            {
                ...
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 3, lvt_8_2_, 7, 4, lvt_8_2_, 8, lvt_9_2_, lvt_9_2_, false);
            }
            ...
            if (lvt_4_1_.field_175966_c[EnumFacing.WEST.getIndex()])
            {
            ...
            if (lvt_7_1_.field_175966_c[EnumFacing.WEST.getIndex()])
            {
                this.func_181655_a(worldIn, structureBoundingBoxIn, 0, 5, 3, 0, 6, 4, false);
            ...
            if (lvt_6_1_.field_175966_c[EnumFacing.EAST.getIndex()])
            {
    ...
    public static class MonumentBuilding extends StructureOceanMonumentPieces.Piece
    {
        ...
        public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_)
        {
            ...
            for (StructureOceanMonumentPieces.RoomDefinition lvt_8_1_ : lvt_5_1_)
            {
                if (!lvt_8_1_.field_175963_d && !lvt_8_1_.func_175961_b())
                {
                    ...
                    this.field_175843_q.add(lvt_10_1_.func_175968_a(this.coordBaseMode, lvt_8_1_, p_i45599_1_));
                }
            }

            int lvt_7_2_ = this.boundingBox.minY;
            int lvt_8_2_ = this.getXWithOffset(9, 22);
            int lvt_9_2_ = this.getZWithOffset(9, 22);

            for (StructureOceanMonumentPieces.Piece lvt_11_1_ : this.field_175843_q)
            {
                lvt_11_1_.getBoundingBox().offset(lvt_8_2_, lvt_7_2_, lvt_9_2_);
            }

            StructureBoundingBox lvt_10_3_ = StructureBoundingBox.func_175899_a(this.getXWithOffset(1, 1), this.getYWithOffset(1), this.getZWithOffset(1, 1), this.getXWithOffset(23, 21), this.getYWithOffset(8), this.getZWithOffset(23, 21));
            StructureBoundingBox lvt_11_2_ = StructureBoundingBox.func_175899_a(this.getXWithOffset(34, 1), this.getYWithOffset(1), this.getZWithOffset(34, 1), this.getXWithOffset(56, 21), this.getYWithOffset(8), this.getZWithOffset(56, 21));
            StructureBoundingBox lvt_12_1_ = StructureBoundingBox.func_175899_a(this.getXWithOffset(22, 22), this.getYWithOffset(13), this.getZWithOffset(22, 22), this.getXWithOffset(35, 35), this.getYWithOffset(17), this.getZWithOffset(35, 35));
            int lvt_13_1_ = p_i45599_1_.nextInt();
            this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.coordBaseMode, lvt_10_3_, lvt_13_1_++));
            this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.coordBaseMode, lvt_11_2_, lvt_13_1_++));
            this.field_175843_q.add(new StructureOceanMonumentPieces.Penthouse(this.coordBaseMode, lvt_12_1_));
        }
                            ...
                            for (EnumFacing lvt_10_1_ : EnumFacing.values())
                            {
                                ...
                                if (lvt_11_1_ >= 0 && lvt_11_1_ < 5 && lvt_13_1_ >= 0 && lvt_13_1_ < 5 && lvt_12_1_ >= 0 && lvt_12_1_ < 3)
                                {
                                    ...
                                    if (lvt_2_1_[lvt_14_1_] != null)
                                    {
                                        ...
                                        {
                                            lvt_2_1_[lvt_6_4_].func_175957_a(lvt_10_1_.getOpposite(), lvt_2_1_[lvt_14_1_]);
                                        }
                                        else
                                        {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            int lvt_4_1_ = Math.max(worldIn.getSeaLevel(), 64) - this.boundingBox.minY;
            this.func_181655_a(worldIn, structureBoundingBoxIn, 0, 0, 0, 58, lvt_4_1_, 58, false);
            ...
            for (int lvt_5_1_ = 0; lvt_5_1_ < 7; ++lvt_5_1_)
            {
                ...
                while (lvt_6_1_ < 7)
                {
                    ...
                    for (int lvt_9_1_ = 0; lvt_9_1_ < 4; ++lvt_9_1_)
                    {
                        ...
                        {
                            this.setBlockState(worldIn, field_175826_b, lvt_7_1_ + lvt_9_1_, 0, lvt_8_1_ + lvt_10_1_, structureBoundingBoxIn);
                            this.replaceAirAndLiquidDownwards(worldIn, field_175826_b, lvt_7_1_ + lvt_9_1_, -1, lvt_8_1_ + lvt_10_1_, structureBoundingBoxIn);
                        }
                    }
            ...
            {
                this.func_181655_a(worldIn, structureBoundingBoxIn, -1 - lvt_5_2_, 0 + lvt_5_2_ * 2, -1 - lvt_5_2_, -1 - lvt_5_2_, 23, 58 + lvt_5_2_, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, 58 + lvt_5_2_, 0 + lvt_5_2_ * 2, -1 - lvt_5_2_, 58 + lvt_5_2_, 23, 58 + lvt_5_2_, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - lvt_5_2_, 0 + lvt_5_2_ * 2, -1 - lvt_5_2_, 57 + lvt_5_2_, 23, -1 - lvt_5_2_, false);
                this.func_181655_a(worldIn, structureBoundingBoxIn, 0 - lvt_5_2_, 0 + lvt_5_2_ * 2, 58 + lvt_5_2_, 57 + lvt_5_2_, 23, 58 + lvt_5_2_, false);
            }

            for (StructureOceanMonumentPieces.Piece lvt_6_2_ : this.field_175843_q)
            {
                if (lvt_6_2_.getBoundingBox().intersectsWith(structureBoundingBoxIn))
                {
                    lvt_6_2_.addComponentParts(worldIn, randomIn, structureBoundingBoxIn);
                }
            }
        ...
        private void func_175840_a(boolean p_175840_1_, int p_175840_2_, World worldIn, Random p_175840_4_, StructureBoundingBox p_175840_5_)
        {
            ...
            if (this.func_175818_a(p_175840_5_, p_175840_2_, 0, p_175840_2_ + 23, 20))
            {
                ...
                {
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + lvt_7_1_, lvt_7_1_ + 1, lvt_7_1_, p_175840_2_ + lvt_7_1_, lvt_7_1_ + 1, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + lvt_7_1_ + 7, lvt_7_1_ + 5, lvt_7_1_ + 7, p_175840_2_ + lvt_7_1_ + 7, lvt_7_1_ + 5, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 17 - lvt_7_1_, lvt_7_1_ + 5, lvt_7_1_ + 7, p_175840_2_ + 17 - lvt_7_1_, lvt_7_1_ + 5, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + 24 - lvt_7_1_, lvt_7_1_ + 1, lvt_7_1_, p_175840_2_ + 24 - lvt_7_1_, lvt_7_1_ + 1, 20, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + lvt_7_1_ + 1, lvt_7_1_ + 1, lvt_7_1_, p_175840_2_ + 23 - lvt_7_1_, lvt_7_1_ + 1, lvt_7_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175840_5_, p_175840_2_ + lvt_7_1_ + 8, lvt_7_1_ + 5, lvt_7_1_ + 7, p_175840_2_ + 16 - lvt_7_1_, lvt_7_1_ + 5, lvt_7_1_ + 7, field_175826_b, field_175826_b, false);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175824_d, lvt_7_2_, 5, lvt_9_1_, p_175840_5_);
                }

                for (int lvt_9_2_ = 19; lvt_9_2_ >= 7; lvt_9_2_ -= 3)
                {
                    this.setBlockState(worldIn, field_175824_d, lvt_8_1_, 5, lvt_9_2_, p_175840_5_);
                }

                for (int lvt_9_3_ = 0; lvt_9_3_ < 4; ++lvt_9_3_)
                {
                    int lvt_10_1_ = p_175840_1_ ? p_175840_2_ + (24 - (17 - lvt_9_3_ * 3)) : p_175840_2_ + 17 - lvt_9_3_ * 3;
                    this.setBlockState(worldIn, field_175824_d, lvt_10_1_, 5, 5, p_175840_5_);
                }

                this.setBlockState(worldIn, field_175824_d, lvt_8_1_, 5, 5, p_175840_5_);
        ...
        private void func_175839_b(World worldIn, Random p_175839_2_, StructureBoundingBox p_175839_3_)
        {
            if (this.func_175818_a(p_175839_3_, 22, 5, 35, 17))
            {
                ...
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, p_175839_3_, 24, 2, 5 + lvt_4_1_ * 4, 24, 4, 5 + lvt_4_1_ * 4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 22, 4, 5 + lvt_4_1_ * 4, 23, 4, 5 + lvt_4_1_ * 4, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 25, 5, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 26, 6, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 26, 5, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 33, 2, 5 + lvt_4_1_ * 4, 33, 4, 5 + lvt_4_1_ * 4, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175839_3_, 34, 4, 5 + lvt_4_1_ * 4, 35, 4, 5 + lvt_4_1_ * 4, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175826_b, 32, 5, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175826_b, 31, 6, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.setBlockState(worldIn, field_175825_e, 31, 5, 5 + lvt_4_1_ * 4, p_175839_3_);
                    this.fillWithBlocks(worldIn, p_175839_3_, 27, 6, 5 + lvt_4_1_ * 4, 30, 6, 5 + lvt_4_1_ * 4, field_175828_a, field_175828_a, false);
                }
            }
        }
        ...
        private void func_175837_c(World worldIn, Random p_175837_2_, StructureBoundingBox p_175837_3_)
        {
            if (this.func_175818_a(p_175837_3_, 15, 20, 42, 21))
            {
                ...
                {
                    this.setBlockState(worldIn, field_175827_c, 28 - lvt_4_1_, 6 + lvt_4_1_, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 29 + lvt_4_1_, 6 + lvt_4_1_, 21, p_175837_3_);
                }

                for (int lvt_4_2_ = 0; lvt_4_2_ < 4; ++lvt_4_2_)
                {
                    this.setBlockState(worldIn, field_175827_c, 28 - lvt_4_2_, 9 + lvt_4_2_, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 29 + lvt_4_2_, 9 + lvt_4_2_, 21, p_175837_3_);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175827_c, 22 - lvt_4_3_ * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 22 - lvt_4_3_ * 2, 9, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + lvt_4_3_ * 2, 8, 21, p_175837_3_);
                    this.setBlockState(worldIn, field_175827_c, 35 + lvt_4_3_ * 2, 9, 21, p_175837_3_);
                }
        ...
        private void func_175841_d(World worldIn, Random p_175841_2_, StructureBoundingBox p_175841_3_)
        {
            if (this.func_175818_a(p_175841_3_, 21, 21, 36, 36))
            {
                ...
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + lvt_4_1_, 13 + lvt_4_1_, 21 + lvt_4_1_, 36 - lvt_4_1_, 13 + lvt_4_1_, 21 + lvt_4_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + lvt_4_1_, 13 + lvt_4_1_, 36 - lvt_4_1_, 36 - lvt_4_1_, 13 + lvt_4_1_, 36 - lvt_4_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 21 + lvt_4_1_, 13 + lvt_4_1_, 22 + lvt_4_1_, 21 + lvt_4_1_, 13 + lvt_4_1_, 35 - lvt_4_1_, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, p_175841_3_, 36 - lvt_4_1_, 13 + lvt_4_1_, 22 + lvt_4_1_, 36 - lvt_4_1_, 13 + lvt_4_1_, 35 - lvt_4_1_, field_175826_b, field_175826_b, false);
                }
        ...
        private void func_175835_e(World worldIn, Random p_175835_2_, StructureBoundingBox p_175835_3_)
        {
            if (this.func_175818_a(p_175835_3_, 0, 21, 6, 58))
            {
                ...
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, lvt_4_1_, lvt_4_1_ + 1, 21, lvt_4_1_, lvt_4_1_ + 1, 57 - lvt_4_1_, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_2_ = 23; lvt_4_2_ < 53; lvt_4_2_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 5, 5, lvt_4_2_, p_175835_3_);
                }
                ...
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, lvt_4_3_, lvt_4_3_ + 1, 21, lvt_4_3_, lvt_4_3_ + 1, 57 - lvt_4_3_, field_175826_b, field_175826_b, false);
                }
            ...
            if (this.func_175818_a(p_175835_3_, 51, 21, 58, 58))
            {
                ...
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, 57 - lvt_4_4_, lvt_4_4_ + 1, 21, 57 - lvt_4_4_, lvt_4_4_ + 1, 57 - lvt_4_4_, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_5_ = 23; lvt_4_5_ < 53; lvt_4_5_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 52, 5, lvt_4_5_, p_175835_3_);
                }
            ...
            if (this.func_175818_a(p_175835_3_, 0, 51, 57, 57))
            {
                ...
                {
                    this.fillWithBlocks(worldIn, p_175835_3_, lvt_4_6_ + 1, lvt_4_6_ + 1, 57 - lvt_4_6_, 56 - lvt_4_6_, lvt_4_6_ + 1, 57 - lvt_4_6_, field_175826_b, field_175826_b, false);
                }
            }
        }
        ...
        private void func_175842_f(World worldIn, Random p_175842_2_, StructureBoundingBox p_175842_3_)
        {
            if (this.func_175818_a(p_175842_3_, 7, 21, 13, 50))
            {
                ...
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, lvt_4_1_ + 7, lvt_4_1_ + 5, 21, lvt_4_1_ + 7, lvt_4_1_ + 5, 54, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_2_ = 21; lvt_4_2_ <= 45; lvt_4_2_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 12, 9, lvt_4_2_, p_175842_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175842_3_, 44, 21, 50, 54))
            {
                ...
                for (int lvt_4_3_ = 0; lvt_4_3_ < 4; ++lvt_4_3_)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, 50 - lvt_4_3_, lvt_4_3_ + 5, 21, 50 - lvt_4_3_, lvt_4_3_ + 5, 54, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_4_ = 21; lvt_4_4_ <= 45; lvt_4_4_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 45, 9, lvt_4_4_, p_175842_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175842_3_, 8, 44, 49, 54))
            {
                ...
                {
                    this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 9, 45, p_175842_3_);
                    this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 9, 52, p_175842_3_);

                    if (lvt_4_5_ == 12 || lvt_4_5_ == 18 || lvt_4_5_ == 24 || lvt_4_5_ == 33 || lvt_4_5_ == 39 || lvt_4_5_ == 45)
                    {
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 9, 47, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 9, 50, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 10, 45, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 10, 46, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 10, 51, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 10, 52, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 11, 47, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 11, 50, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 12, 48, p_175842_3_);
                        this.setBlockState(worldIn, field_175824_d, lvt_4_5_, 12, 49, p_175842_3_);
                    }
                }

                for (int lvt_4_6_ = 0; lvt_4_6_ < 3; ++lvt_4_6_)
                {
                    this.fillWithBlocks(worldIn, p_175842_3_, 8 + lvt_4_6_, 5 + lvt_4_6_, 54, 49 - lvt_4_6_, 5 + lvt_4_6_, 54, field_175828_a, field_175828_a, false);
                }
        ...
        private void func_175838_g(World worldIn, Random p_175838_2_, StructureBoundingBox p_175838_3_)
        {
            if (this.func_175818_a(p_175838_3_, 14, 21, 20, 43))
            {
                ...
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, lvt_4_1_ + 14, lvt_4_1_ + 9, 21, lvt_4_1_ + 14, lvt_4_1_ + 9, 43 - lvt_4_1_, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_2_ = 23; lvt_4_2_ <= 39; lvt_4_2_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 19, 13, lvt_4_2_, p_175838_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175838_3_, 37, 21, 43, 43))
            {
                ...
                for (int lvt_4_3_ = 0; lvt_4_3_ < 4; ++lvt_4_3_)
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, 43 - lvt_4_3_, lvt_4_3_ + 9, 21, 43 - lvt_4_3_, lvt_4_3_ + 9, 43 - lvt_4_3_, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_4_ = 23; lvt_4_4_ <= 39; lvt_4_4_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, 38, 13, lvt_4_4_, p_175838_3_);
                }
            }
            ...
            if (this.func_175818_a(p_175838_3_, 15, 37, 42, 43))
            {
                ...
                {
                    this.fillWithBlocks(worldIn, p_175838_3_, 15 + lvt_4_5_, lvt_4_5_ + 9, 43 - lvt_4_5_, 42 - lvt_4_5_, lvt_4_5_ + 9, 43 - lvt_4_5_, field_175826_b, field_175826_b, false);
                }

                for (int lvt_4_6_ = 21; lvt_4_6_ <= 36; lvt_4_6_ += 3)
                {
                    this.setBlockState(worldIn, field_175824_d, lvt_4_6_, 13, 38, p_175838_3_);
                }
            }
        }
    }
    ...
    public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, lvt_4_1_, 0, 0, lvt_4_1_, 15, lvt_5_1_, lvt_5_1_, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 15, lvt_4_1_, 0, 15, lvt_4_1_, 15, lvt_5_1_, lvt_5_1_, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_4_1_, 0, 15, lvt_4_1_, 0, lvt_5_1_, lvt_5_1_, false);
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_4_1_, 15, 14, lvt_4_1_, 15, lvt_5_1_, lvt_5_1_, false);
            ...
            for (lvt_4_1_ = 1; lvt_4_1_ <= 6; ++lvt_4_1_)
            {
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_6_1_, lvt_4_1_, 0, lvt_6_1_, lvt_4_1_, 1, lvt_5_1_, lvt_5_1_, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_6_1_, lvt_4_1_, 6, lvt_6_1_, lvt_4_1_, 9, lvt_5_1_, lvt_5_1_, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_6_1_, lvt_4_1_, 14, lvt_6_1_, lvt_4_1_, 15, lvt_5_1_, lvt_5_1_, false);
                }

                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_4_1_, 0, 1, lvt_4_1_, 0, lvt_5_1_, lvt_5_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 6, lvt_4_1_, 0, 9, lvt_4_1_, 0, lvt_5_1_, lvt_5_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 14, lvt_4_1_, 0, 14, lvt_4_1_, 0, lvt_5_1_, lvt_5_1_, false);
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, lvt_4_1_, 15, 14, lvt_4_1_, 15, lvt_5_1_, lvt_5_1_, false);
            }
            ...
            for (lvt_4_1_ = 3; lvt_4_1_ <= 6; lvt_4_1_ += 3)
            {
                ...
                {
                    this.setBlockState(worldIn, field_175825_e, lvt_5_3_, lvt_4_1_, 6, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, lvt_5_3_, lvt_4_1_, 9, structureBoundingBoxIn);
                }
            }
    ...
    public static class Penthouse extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            {
                this.setBlockState(worldIn, field_175825_e, 0, 0, lvt_4_1_, structureBoundingBoxIn);
                this.setBlockState(worldIn, field_175825_e, 13, 0, lvt_4_1_, structureBoundingBoxIn);
                this.setBlockState(worldIn, field_175825_e, lvt_4_1_, 0, 0, structureBoundingBoxIn);
            }
            ...
            for (int lvt_5_1_ = 0; lvt_5_1_ < 2; ++lvt_5_1_)
            {
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_2_, 0, lvt_6_1_, lvt_4_2_, 2, lvt_6_1_, field_175826_b, field_175826_b, false);
                }
    ...
    public abstract static class Piece extends StructureComponent
    {
        ...
        protected void func_181655_a(World p_181655_1_, StructureBoundingBox p_181655_2_, int p_181655_3_, int p_181655_4_, int p_181655_5_, int p_181655_6_, int p_181655_7_, int p_181655_8_, boolean p_181655_9_)
        {
            for (int lvt_10_1_ = p_181655_4_; lvt_10_1_ <= p_181655_7_; ++lvt_10_1_)
            {
                for (int lvt_11_1_ = p_181655_3_; lvt_11_1_ <= p_181655_6_; ++lvt_11_1_)
                {
                    ...
                    {
                        if (!p_181655_9_ || this.getBlockStateFromPos(p_181655_1_, lvt_11_1_, lvt_10_1_, lvt_12_1_, p_181655_2_).getBlock().getMaterial() != Material.air)
                        {
                            if (this.getYWithOffset(lvt_10_1_) >= p_181655_1_.getSeaLevel())
                            {
                                this.setBlockState(p_181655_1_, Blocks.air.getDefaultState(), lvt_11_1_, lvt_10_1_, lvt_12_1_, p_181655_2_);
                            }
                            else
                            {
                                this.setBlockState(p_181655_1_, field_175822_f, lvt_11_1_, lvt_10_1_, lvt_12_1_, p_181655_2_);
                            }
                        }
                    }
                }
        ...
        protected void func_175819_a(World worldIn, StructureBoundingBox p_175819_2_, int p_175819_3_, int p_175819_4_, int p_175819_5_, int p_175819_6_, int p_175819_7_, int p_175819_8_, IBlockState p_175819_9_)
        {
            for (int lvt_10_1_ = p_175819_4_; lvt_10_1_ <= p_175819_7_; ++lvt_10_1_)
            {
                for (int lvt_11_1_ = p_175819_3_; lvt_11_1_ <= p_175819_6_; ++lvt_11_1_)
                {
                    ...
                    {
                        if (this.getBlockStateFromPos(worldIn, lvt_11_1_, lvt_10_1_, lvt_12_1_, p_175819_2_) == field_175822_f)
                        {
                            this.setBlockState(worldIn, p_175819_9_, lvt_11_1_, lvt_10_1_, lvt_12_1_, p_175819_2_);
                        }
                    }
                }
            }
        ...
        protected boolean func_175817_a(World worldIn, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_)
        {
            ...
            {
                EntityGuardian lvt_9_1_ = new EntityGuardian(worldIn);
                lvt_9_1_.setElder(true);
                ...
                lvt_9_1_.onInitialSpawn(worldIn.getDifficultyForLocation(new BlockPos(lvt_9_1_)), (IEntityLivingData)null);
    ...
    public static class SimpleRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            boolean lvt_4_1_ = this.field_175833_o != 0 && randomIn.nextBoolean() && !this.field_175830_k.field_175966_c[EnumFacing.DOWN.getIndex()] && !this.field_175830_k.field_175966_c[EnumFacing.UP.getIndex()] && this.field_175830_k.func_175960_c() > 1;
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            ...
            for (int lvt_4_1_ = 1; lvt_4_1_ <= 6; ++lvt_4_1_)
            {
                for (int lvt_5_1_ = 1; lvt_5_1_ <= 6; ++lvt_5_1_)
                {
                    ...
                    {
                        int lvt_6_1_ = 2 + (randomIn.nextInt(4) == 0 ? 0 : 1);
                        this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_1_, lvt_6_1_, lvt_5_1_, lvt_4_1_, 3, lvt_5_1_, Blocks.sponge.getStateFromMeta(1), Blocks.sponge.getStateFromMeta(1), false);
                    }
                }
            }
    ...
    public static class WingRoom extends StructureOceanMonumentPieces.Piece
    {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
        {
            if (this.field_175834_o == 0)
            {
                for (int lvt_4_1_ = 0; lvt_4_1_ < 4; ++lvt_4_1_)
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10 - lvt_4_1_, 3 - lvt_4_1_, 20 - lvt_4_1_, 12 + lvt_4_1_, 3 - lvt_4_1_, 20, field_175826_b, field_175826_b, false);
                }
                ...
                {
                    this.setBlockState(worldIn, field_175825_e, 6, 3, lvt_4_2_, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, 16, 3, lvt_4_2_, structureBoundingBoxIn);
                }
            ...
            else if (this.field_175834_o == 1)
            {
                ...
                {
                    this.setBlockState(worldIn, field_175826_b, lvt_4_3_, lvt_6_1_ + 1, lvt_5_1_, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, lvt_4_3_, lvt_6_1_, lvt_5_1_, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175826_b, lvt_4_3_, lvt_6_1_ - 1, lvt_5_1_, structureBoundingBoxIn);
                    lvt_4_3_ = 13;
                }
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_3_, 0, 10, lvt_4_3_, 6, 10, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_3_, 0, 12, lvt_4_3_, 6, 12, field_175826_b, field_175826_b, false);
                    this.setBlockState(worldIn, field_175825_e, lvt_4_3_, 0, 10, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, lvt_4_3_, 0, 12, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, lvt_4_3_, 4, 10, structureBoundingBoxIn);
                    this.setBlockState(worldIn, field_175825_e, lvt_4_3_, 4, 12, structureBoundingBoxIn);
                    lvt_4_3_ = 12;
                }
                ...
                {
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_3_, 0, 7, lvt_4_3_, 2, 7, field_175826_b, field_175826_b, false);
                    this.fillWithBlocks(worldIn, structureBoundingBoxIn, lvt_4_3_, 0, 14, lvt_4_3_, 2, 14, field_175826_b, field_175826_b, false);
                    lvt_4_3_ = 14;
                }
    ...
    static class XYDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
    {
        ...
        public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
        {
            ...
            {
                StructureOceanMonumentPieces.RoomDefinition lvt_2_1_ = p_175969_1_.field_175965_b[EnumFacing.EAST.getIndex()];
                return lvt_2_1_.field_175966_c[EnumFacing.UP.getIndex()] && !lvt_2_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
            }
            else
            {
                return false;
    ...
    static class YZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
    {
        ...
        public boolean func_175969_a(StructureOceanMonumentPieces.RoomDefinition p_175969_1_)
        {
            ...
            {
                StructureOceanMonumentPieces.RoomDefinition lvt_2_1_ = p_175969_1_.field_175965_b[EnumFacing.NORTH.getIndex()];
                return lvt_2_1_.field_175966_c[EnumFacing.UP.getIndex()] && !lvt_2_1_.field_175965_b[EnumFacing.UP.getIndex()].field_175963_d;
            }
            else
            {
    ...
    static class ZDoubleRoomFitHelper implements StructureOceanMonumentPieces.MonumentRoomFitHelper
    {
        ...
        public StructureOceanMonumentPieces.Piece func_175968_a(EnumFacing p_175968_1_, StructureOceanMonumentPieces.RoomDefinition p_175968_2_, Random p_175968_3_)
        {
            ...
            {
                lvt_4_1_ = p_175968_2_.field_175965_b[EnumFacing.SOUTH.getIndex()];
            }

            lvt_4_1_.field_175963_d = true;
            lvt_4_1_.field_175965_b[EnumFacing.NORTH.getIndex()].field_175963_d = true;
