    ...
    public int[] getInts(int areaX, int areaY, int areaWidth, int areaHeight)
    {
        ...
        for (int lvt_11_1_ = 0; lvt_11_1_ < areaHeight; ++lvt_11_1_)
        {
            for (int lvt_12_1_ = 0; lvt_12_1_ < areaWidth; ++lvt_12_1_)
            {
                ...
                if (lvt_17_1_ == 0 && lvt_13_1_ == 0 && lvt_14_1_ == 0 && lvt_15_1_ == 0 && lvt_16_1_ == 0 && this.nextInt(100) == 0)
                {
                    lvt_10_1_[lvt_12_1_ + lvt_11_1_ * areaWidth] = BiomeGenBase.mushroomIsland.biomeID;
                }
                else
                {
