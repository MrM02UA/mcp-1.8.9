...
public class MapGenCavesHell extends MapGenBase
{
    ...
    protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_)
    {
        ...
        {
            double lvt_29_1_ = 1.5D + (double)(MathHelper.sin((float)p_180704_15_ * (float)Math.PI / (float)p_180704_16_) * p_180704_12_ * 1.0F);
            double lvt_31_1_ = lvt_29_1_ * p_180704_17_;
            float lvt_33_1_ = MathHelper.cos(p_180704_14_);
            float lvt_34_1_ = MathHelper.sin(p_180704_14_);
            p_180704_6_ += (double)(MathHelper.cos(p_180704_13_) * lvt_33_1_);
            p_180704_8_ += (double)lvt_34_1_;
            p_180704_10_ += (double)(MathHelper.sin(p_180704_13_) * lvt_33_1_);
            ...
            {
                this.func_180704_a(lvt_25_1_.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, lvt_25_1_.nextFloat() * 0.5F + 0.5F, p_180704_13_ - ((float)Math.PI / 2F), p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
                this.func_180704_a(lvt_25_1_.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, lvt_25_1_.nextFloat() * 0.5F + 0.5F, p_180704_13_ + ((float)Math.PI / 2F), p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
                return;
            }
            ...
            if (lvt_26_2_ || lvt_25_1_.nextInt(4) != 0)
            {
                ...
                {
                    int lvt_35_2_ = MathHelper.floor_double(p_180704_6_ - lvt_29_1_) - p_180704_3_ * 16 - 1;
                    int lvt_36_1_ = MathHelper.floor_double(p_180704_6_ + lvt_29_1_) - p_180704_3_ * 16 + 1;
                    int lvt_37_2_ = MathHelper.floor_double(p_180704_8_ - lvt_31_1_) - 1;
                    int lvt_38_1_ = MathHelper.floor_double(p_180704_8_ + lvt_31_1_) + 1;
                    int lvt_39_2_ = MathHelper.floor_double(p_180704_10_ - lvt_29_1_) - p_180704_4_ * 16 - 1;
                    int lvt_40_1_ = MathHelper.floor_double(p_180704_10_ + lvt_29_1_) - p_180704_4_ * 16 + 1;
                    ...
                    for (int lvt_42_1_ = lvt_35_2_; !lvt_41_2_ && lvt_42_1_ < lvt_36_1_; ++lvt_42_1_)
                    {
                        for (int lvt_43_1_ = lvt_39_2_; !lvt_41_2_ && lvt_43_1_ < lvt_40_1_; ++lvt_43_1_)
                        {
                            for (int lvt_44_1_ = lvt_38_1_ + 1; !lvt_41_2_ && lvt_44_1_ >= lvt_37_2_ - 1; --lvt_44_1_)
                            {
                                ...
                                {
                                    IBlockState lvt_45_1_ = p_180704_5_.getBlockState(lvt_42_1_, lvt_44_1_, lvt_43_1_);

                                    if (lvt_45_1_.getBlock() == Blocks.flowing_lava || lvt_45_1_.getBlock() == Blocks.lava)
                                    {
                                        lvt_41_2_ = true;
                                    }
                        ...
                        for (int lvt_42_2_ = lvt_35_2_; lvt_42_2_ < lvt_36_1_; ++lvt_42_2_)
                        {
                            ...
                            for (int lvt_45_2_ = lvt_39_2_; lvt_45_2_ < lvt_40_1_; ++lvt_45_2_)
                            {
                                ...
                                for (int lvt_48_1_ = lvt_38_1_; lvt_48_1_ > lvt_37_2_; --lvt_48_1_)
                                {
                                    ...
                                    {
                                        IBlockState lvt_51_1_ = p_180704_5_.getBlockState(lvt_42_2_, lvt_48_1_, lvt_45_2_);

                                        if (lvt_51_1_.getBlock() == Blocks.netherrack || lvt_51_1_.getBlock() == Blocks.dirt || lvt_51_1_.getBlock() == Blocks.grass)
                                        {
                                            p_180704_5_.setBlockState(lvt_42_2_, lvt_48_1_, lvt_45_2_, Blocks.air.getDefaultState());
                                        }
                                    }
                                }
                            }
    ...
    {
        int lvt_7_1_ = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(10) + 1) + 1);
        ...
        for (int lvt_8_1_ = 0; lvt_8_1_ < lvt_7_1_; ++lvt_8_1_)
        {
            ...
            double lvt_11_1_ = (double)this.rand.nextInt(128);
            double lvt_13_1_ = (double)(chunkZ * 16 + this.rand.nextInt(16));
            int lvt_15_1_ = 1;

            if (this.rand.nextInt(4) == 0)
            {
                this.func_180705_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, lvt_9_1_, lvt_11_1_, lvt_13_1_);
            ...
            for (int lvt_16_1_ = 0; lvt_16_1_ < lvt_15_1_; ++lvt_16_1_)
            {
                ...
                this.func_180704_a(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, lvt_9_1_, lvt_11_1_, lvt_13_1_, lvt_19_1_ * 2.0F, lvt_17_1_, lvt_18_1_, 0, 0, 0.5D);
            }
        }
    }
}
